...
Il registro contiene il seguente messaggio quando JobGeneratorImpl.createJob viene chiamato per l’ `com/adobe/example/offloading` argomento e il `/content/geometrixx/de/services` payload:

...
Le definizioni dei tipi di nodo esistono nell’archivio come file CND. La notazione CND è definita nella documentazione JCR [qui](https://jackrabbit.apache.org/jcr/node-type-notation.html).

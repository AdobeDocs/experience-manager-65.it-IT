...
* **Tipi di risorse**
Un elenco di `sling:resourceTypes` può essere fornito per definire componenti utilizzati per il rendering dei frammenti di contenuto e a cui applicare l’elaborazione in background.

...
L’AEM consente di generare elementi grafici che incorporano testo ripreso dinamicamente dal contenuto.
...
1. Torna a CRXDE Lite. Ora dovresti vedere un `.fontlist` nella cartella contenente il nome dei caratteri importati.

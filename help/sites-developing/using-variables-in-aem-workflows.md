...
description: Create una variabile, impostate un valore per la variabile e utilizzatela nei passaggi del flusso di lavoro AEM divisione e Vai in OR.
seo-description: Create una variabile, impostate un valore per la variabile e utilizzatela nei passaggi del flusso di lavoro AEM divisione e Vai in OR.
...
* [Creare una ](/help/sites-developing/using-variables-in-aem-workflows.md#create-a-variable) variabile di un tipo di dati in base al tipo di informazioni che si desidera memorizzare al suo interno.
* [Impostate un valore per la ](/help/sites-developing/using-variables-in-aem-workflows.md#set-a-variable) variabile utilizzando il passaggio del flusso di lavoro Imposta variabile.
* [Utilizzate i passaggi del flusso di lavoro della ](/help/sites-developing/using-variables-in-aem-workflows.md#use-a-variable) variabile OR Split and Goto AEM per definire un&#39;espressione per l&#39;adozione di decisioni di routing. Potete inoltre utilizzare le variabili in tutti  passaggi del flusso di lavoro AEM Forms.
...
* **Tipi** di dati complessi:  [](https://docs.oracle.com/javase/8/docs/api/org/w3c/dom/Document.html) XML e  [JSON](https://static.javadoc.io/com.google.code.gson/gson/2.3/com/google/gson/JsonObject.html)

>[!NOTE]
>
>I flussi di lavoro supportano solo il formato ISO8601 per le variabili di tipo Data.

Per ulteriori tipi di dati complessi disponibili nei flussi di lavoro  AEM Forms, vedere [Variabili in  flussi di lavoro AEM Forms](/help/forms/using/variable-in-aem-workflows.md).  Utilizzate il tipo di dati ArrayList per creare raccolte di variabili. È possibile creare una variabile ArrayList per tutti i tipi di dati primitivi e complessi. Ad esempio, creare una variabile ArrayList e selezionare String come sottotipo per memorizzare più valori stringa utilizzando la variabile.
...
1. Trascinare il passaggio **Imposta variabile** nell&#39;editor del flusso di lavoro, toccare il passaggio e selezionare ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/configure_icon.png) (Configura).
...
Per ulteriori informazioni, vedere [editor di regole per moduli adattivi](/help/forms/using/rule-editor.md).
...
Per ulteriori esempi, vedere [Creare un modello di workflow](/help/forms/using/aem-forms-workflow.md#create-a-workflow-model).
...
Tutti  passaggi del flusso di lavoro AEM Forms supportano le variabili. Per ulteriori informazioni, consultate [Flusso di lavoro Forms-centric su OSGi](/help/forms/using/aem-forms-workflow-step-reference.md).
...
Per informazioni sulle API per ulteriori tipi di dati variabili complesse disponibili nei  flussi di lavoro AEM Forms, vedere [Variabili in  flussi di lavoro AEM Forms](/help/forms/using/variable-in-aem-workflows.md).
...
1. Modificate le informazioni sulla variabile e toccate ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png) per salvare le modifiche. Non è possibile modificare i campi **[!UICONTROL Name]** e **[!UICONTROL Type]** per una variabile.

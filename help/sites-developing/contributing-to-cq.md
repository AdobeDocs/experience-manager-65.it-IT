---
title: Contributo ad AEM
seo-title: Contributo ad AEM
description: AEM è sviluppato seguendo metodologie collaudate comunemente utilizzate nei grandi progetti open source
seo-description: AEM è sviluppato seguendo metodologie collaudate comunemente utilizzate nei grandi progetti open source
...
# Contributo ad AEM{#contributing-to-aem}
...
### L&#39;anomalo è il nuovo normale {#abnormal-is-the-new-normal}
...
### Preparati per il clustering elastico {#be-ready-for-elastic-clustering}
...
JavaDoc for JCR&#39;s Java API è [qui](http://jackrabbit.apache.org/jcr/jcr-api.html).

Prima di provare a leggere la specifica JavaDoc o JCR stessa, potresti voler vedere [questa spiegazione](/help/sites-developing/the-basics.md#java-content-repository) di alto livello di JCR implementata da Adobe Experience Services.

...
### Sviluppo Di Componenti Personali {#developing-your-own-components}
...
* **Proprietà** vitali:
   ...
   * Interfaccia touch
      ...
      * Per ulteriori informazioni, consulta la sezione Icona [componente nell’interfaccia](/help/sites-developing/components-basics.md#component-icon-in-touch-ui) touch.
...
1. `cq:icon` - Proprietà String che punta a un&#39;icona standard nella libreria [dell&#39;interfaccia utente](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) Coral da visualizzare nel browser dei componenti
...
Nella console [](/help/sites-authoring/default-components-console.md#component-details) dei componenti viene visualizzata la modalità di definizione dell’icona per un particolare componente.
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Gruppo in cui è possibile selezionare il componente nel browser Componenti (interfaccia touch) o nella barra laterale (interfaccia classica).<br /> Il valore di <code>.hidden</code> è utilizzato per i componenti che non sono disponibili per la selezione dall’interfaccia utente, ad esempio i sistemi paragrafo effettivi.</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td><code>String</code></td>
   <td>Se impostata, questa proprietà viene impostata come ID cella. Per ulteriori informazioni, fare riferimento all'articolo della Knowledge Base <a href="https://helpx.adobe.com/experience-manager/kb/DesigneCellId.html">How are Design Cell IDs build</a>.<br /> </td>
  </tr>
  <tr>
   <td><code>cq:childEditConfig</code></td>
   <td><code>cq:EditConfig</code></td>
   <td>Quando il componente è un contenitore, ad esempio un sistema paragrafo, questo determina la configurazione di modifica dei nodi secondari.<br /> </td>
  </tr>
  <tr>
   <td><code>cq:editConfig</code></td>
   <td><code>cq:EditConfig</code></td>
  ...
  <tr>
   ...
   <td><code>nt:file</code></td>
   <td>Miniatura opzionale visualizzata mentre il componente viene trascinato nella posizione desiderata dalla barra laterale.<br /> </td>
  </tr>
 </tbody>
</table>
...
1. Aprite la modalità [](/help/sites-authoring/default-components-designmode.md) Progettazione per una pagina e attivate il componente richiesto.
1. Aggiungete i componenti richiesti alla `components` proprietà della definizione del modello in:
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>Visualizza il valore del testo statico &lt;some text&gt;<br /> visibile solo nell'interfaccia classica. L’interfaccia touch non visualizza azioni in un menu contestuale, pertanto non è applicabile.</td>
  </tr>
  <tr>
   <td>-</td>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>(valore predefinito). La finestra di dialogo viene ancorata sul componente.<br /> </td>
  </tr>
  <tr>
   <td><code>auto</code></td>
...
>[!NOTE]
>
>Consultate [Aggiungere una nuova azione a una barra degli strumenti](/help/sites-developing/customizing-page-authoring-touch.md#add-new-action-to-a-component-toolbar) di un componente come esempio per l’interfaccia touch.

...
* La logica specifica è disponibile in un file .js separato ed è collegata al JSP. Questa configurazione consente di passare da una logica all’altra (statica/dinamica) commentando la &lt;script> tag.

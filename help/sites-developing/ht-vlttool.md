...
### Installazione di VLT Tool {#installing-the-vlt-tool}
...
1. Modificate il file `.vlt-sync-config.properties` nascosto e configurate la sincronizzazione per sincronizzare il contenuto del repository:

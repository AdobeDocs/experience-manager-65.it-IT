...
1. Fate clic sull’elemento Configurazione Day CQ Search&amp;Promote.
...
1. Dall&#39;icona **Strumenti** > **Distribuzione**, seleziona Servizi **** cloud.
...
1. Nella pagina Servizi cloud, fai clic sul collegamento Adobe Search&amp;Promote o sull’icona Search&amp;Promote.

1. Se è la prima volta che configurate Adobe Search&amp;Promote, fate clic su **Configura ora** per aprire il pannello Crea configurazione.

   Per ulteriori informazioni su Search&amp;Promote, fai clic su **Ulteriori** informazioni.

   ![](assets/chlimage_1-59.png)

1. Immettete un **Titolo** riconoscibile per gli autori delle pagine e immettete un **Nome** univoco, quindi fate clic su **Crea**.

   The **Edit Component** window opens.

   Inoltre, la configurazione appena creata viene visualizzata sotto Configurazioni **** disponibili nella voce di elenco Dashboard **di** Cloud Services di Adobe Search&amp;Promote.
...
1. Aggiungere quanto segue ai campi della finestra di dialogo **Modifica componente** .
   ...
   * **Numero account**
   >[!NOTE]
   >
   >Per ottenere queste informazioni da **soli,** devi prima effettuare l&#39;accesso
   >
   >[https://searchandpromote.omniture.com/center/](https://searchandpromote.omniture.com/center/)
   >
   >
   >utilizzando le credenziali Seach&amp;Promote valide (e-mail/password).
   >Quindi, devi guardare il tuo url nella barra degli indirizzi del tuo brouser che dovrebbe essere simile a questo:
...
1. Click **Connect To Search&amp;Promote**.
   ...
   Quando viene visualizzato il messaggio di riuscita della connessione, fate clic su **OK**.
...
1. Passate alla console Web in `https://localhost:4502/system/console/configMgr/com.day.cq.searchpromote.impl.SearchPromoteServiceImpl`
...
In modalità Progettazione, modificate un componente **par** per consentire ai componenti Search&amp;Promote nella barra laterale. (See the [Components](/help/sites-developing/components.md#addinganewcomponenttotheparagraphsystemdesignmode) documentation for more information.)

Per informazioni sull’utilizzo dei componenti, consultate [Aggiunta di funzioni Search&amp;Promote a una pagina](/help/sites-authoring/search-and-promote.md)Web.
...
>[!NOTE]
>
>La connessione del servizio deve essere già configurata. Consultate [Configurare la connessione a Search&amp;Promote](#connection).
...
1. Fate clic su **Aggiungi servizio**, selezionate **Adobe Search&amp;Promote** e fate clic su **OK**.
1. Selezionate la configurazione di connessione per l’account Search&amp;Promote, quindi fate clic su **OK**.

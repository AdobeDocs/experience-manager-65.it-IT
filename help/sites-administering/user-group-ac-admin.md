...
* **Archivio**
   ...
   Seleziona il controllo di accesso a livello di archivio. Ad esempio, quando si imposta il `jcr:namespaceManagement` privilegio, che è rilevante solo per l&#39;archivio, non un nodo.

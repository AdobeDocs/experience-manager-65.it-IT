...
1. [Utilizzare Admin Console per creare un caso di supporto](https://helpx.adobe.com/it/enterprise/using/support-for-experience-cloud.html) e richiedere il passaggio a HTTP/2. Questa operazione non viene eseguita automaticamente.
...
Le richieste vengono elaborate nell’ordine in cui vengono ricevute dall’Assistenza clienti di Adobe.

...
<table>
 <tbody>
  ...
  <tr>
   <td>catalogRolloutHooks</td>
   <td>Esegue gli hook di rollout specifici della generazione del catalogo. Chiama i metodi executePageRolloutHooks e executeProductRolloutHooks del di CatalogGenerator.<br /> Consulta com.adobe.cq.commerce.pim.api.CatalogGenerator nei documenti Java dell’AEM.</td>
   <td> </td>
  </tr>
  <tr>
   <td>productUpdate</td>
...
Ad esempio, una blueprint utilizza il sito di riferimento We.Retail come contenuto sorgente. Un sito viene creato dalla blueprint. Ogni elemento nel seguente elenco descrive uno scenario diverso relativo all’utilizzo delle configurazioni di rollout:

...
+ Operazioni {#operations}
   ...
   + [Risoluzione dei problemi relativi ad AEM](troubleshoot.md)
...
+ Sicurezza {#security}
   + [Amministrazione utenti e sicurezza](security.md)
   ...
   + [Visualizzazione entità per la gestione delle autorizzazioni](touch-ui-principal-view.md)
   ...
   + [Supporto per i cookie dello stesso sito](same-site-cookie-support.md)
...
+ Integrazione {#integration}
   ...
   + [Integrazione delle soluzioni](integration.md)
...
+ Best practice   {#bestpractices}
   ...
   + [Gestione delle richieste RGPD per la Fondazione AEM](https://experienceleague.adobe.com/docs/experience-manager-65/administering/security/handling-gdpr-requests-for-aem-platform.html)

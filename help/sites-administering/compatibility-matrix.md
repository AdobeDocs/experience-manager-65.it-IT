...
description: In questa pagina sono elencati i lettori AEM Screens con la rispettiva versione AEM Screens.
...
<table> 
 <tbody>
  ...
  <tr>
   <td><strong>FP1 di AEM 6.3+SP1+Screens (1.0.64_B002)</strong></td> 
...
Fai clic sul collegamento di download per iOS Player:
...
|---|---|
| **FP1 di AEM 6.3+SP1+Screens (1.0.64_B002)** | **3.2.68 -** (Disponibile sul sito Macromedia) e Google Play Store |
...
<table> 
 <tbody>
  ...
  <tr>
   <td><strong>FP1 di AEM 6.3+SP1+Screens (1.0.64_B002)</strong></td> 
   <td><p><strong>3.2.72 - </strong>Disponibile in Apple Store</p> <p><strong>3.3.0</strong> - Non funziona</p> <p> </p> </td> 

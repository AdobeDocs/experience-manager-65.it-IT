...
1. Salvare il documento XML restituito.
   ...
   * Accedere al campo dell&#39; `AssemblerResult` oggetto `documents` , ovvero un `Map` oggetto contenente i dati XML che specifica se il documento PDF di input è un documento PDF/A.
   * Eseguire un&#39;iterazione sull&#39; `Map` oggetto per ottenere ogni documento risultante. Quindi, inserire il valore del membro dell&#39;array in un `BLOB`.

...
[Quick Start (modalità SOAP): convalida dei documenti DDX tramite l’API Java](/help/forms/developing/assembler-service-java-api-quick.md#quick-start-soap-mode-validating-ddx-documents-using-the-java-api) (modalità SOAP)
...
1. Includi file di progetto.
   ...
   >[!NOTE]
   >
   >Sostituire localhost con l&#39;indirizzo IP del server Forms.

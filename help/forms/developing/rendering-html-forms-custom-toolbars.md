...
description: Utilizzare il servizio Forms per personalizzare una barra degli strumenti rappresentata con un modulo HTML. È possibile eseguire il rendering di un modulo HTML con una barra degli strumenti personalizzata utilizzando l'API Java e un'API di servizio Web.
seo-description: Utilizzare il servizio Forms per personalizzare una barra degli strumenti rappresentata con un modulo HTML. È possibile eseguire il rendering di un modulo HTML con una barra degli strumenti personalizzata utilizzando l'API Java e un'API di servizio Web.

...
Per richiamare i servizi AEM Forms a livello di programmazione, sono disponibili le seguenti opzioni di avvio rapido:
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-base64-encoding">Richiamo di moduli AEM con codifica</a> Base64 (proxy del servizio Web Java)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-base64-encoding">Richiamo di moduli AEM con codifica</a> Base64 (proxy del servizio Web .NET)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-mtom">Attivazione di moduli AEM tramite MTOM</a> (esempio di servizio Web .NET)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-swaref">Richiamo di moduli AEM tramite SwaRef</a> (esempio di servizio Web Java)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-blob-data-over-http">Richiamo di moduli AEM tramite dati BLOB su HTTP</a> (esempio di servizio Web Java)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-blob-data-over-http">Richiamo di AEM Forms tramite dati BLOB su HTTP</a> (esempio di servizio Web .NET)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-dime">Richiamo di moduli AEM tramite DIME</a> (esempio di servizio Web Java)</p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  ...
  <tr>
   ...
   <td><p><a href="/help/forms/developing/invoking-aem-forms-using-remoting.md#quick-start-invoking-a-short-lived-process-by-passing-a-secure-document-using-remoting">Avvio rapido: Richiamo di un processo di breve durata passando un documento protetto tramite (obsoleto per i moduli AEM) AEM Forms Remoting</a></p></td>
   <td><p>N/D</p></td>
   <td><p>N/D</p></td>
  </tr>
  <tr>
...
Nell&#39;esempio di codice Flex riportato di seguito viene richiamato un processo di breve durata denominato `MyApplication/EncryptDocument`. (consultate [Richiamo di moduli AEM con (obsoleto per i moduli AEM) AEM Forms Remoting](/help/forms/developing/invoking-aem-forms-using-remoting.md#invoking-aem-forms-using-remoting).)

>[!NOTE]
>
>Questo avvio rapido richiama un processo AEM Forms e carica un documento non sicuro. Per eseguire questo avvio rapido, AEM Forms deve essere configurato per caricare documenti non protetti. Per informazioni su come configurare AEM Forms per accettare documenti non protetti, consultate [Configurazione di AEM Forms per accettare documenti](/help/forms/developing/invoking-aem-forms-using-remoting.md#configuring-aem-forms-to-accept-secure-and-unsecure-documents)protetti e non protetti.
...
Nell&#39;esempio di codice C# riportato di seguito viene richiamato un processo denominato `MyApplication/EncryptDocument` da un progetto Microsoft .NET che utilizza i dati via HTTP. (consultate [Richiamo di moduli AEM con dati BLOB via HTTP](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-blob-data-over-http).)
...
Il seguente esempio di codice Java richiama un processo denominato `MyApplication/EncryptDocument` da un progetto Java. Questo progetto Java utilizza classi proxy create utilizzando JAX-WS e SwaRef come tipo di codifica. (consultate [Attivazione di moduli AEM con SwaRef](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-swaref)).

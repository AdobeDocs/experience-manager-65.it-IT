...
Nella tabella seguente vengono riepilogati alcuni dei valori chiave e dei tipi di oggetto che è possibile individuare nel restituito `java.util.Map` oggetto.

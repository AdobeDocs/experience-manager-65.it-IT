---
title: Servizio credenziali Java&trade; API QuickStart(SOAP)
description: Scopri come importare ed eliminare le credenziali in AEM Forms utilizzando Java&trade; API Quick Start (SOAP).
contentOwner: admin

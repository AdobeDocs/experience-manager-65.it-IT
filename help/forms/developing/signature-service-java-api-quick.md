...
Per il servizio di firma JEE di AEM Forms sono disponibili le seguenti funzioni di avvio rapido dell’API Java (SOAP):

[Guida rapida (modalità SOAP): aggiunta di un campo firma a un documento PDF utilizzando l’API Java](signature-service-java-api-quick.md#quick-start-soap-mode-adding-a-signature-field-to-a-pdf-document-using-the-java-api)

[Quick Start (modalità SOAP): recupero dei nomi dei campi della firma tramite l’API Java](signature-service-java-api-quick.md#quick-start-soap-mode-retrieving-signature-field-names-using-the-java-api)

[Guida rapida (modalità SOAP): modifica di un campo firma tramite API Java](signature-service-java-api-quick.md#quick-start-soap-mode-modifying-a-signature-field-using-the-java-api)
...
[Quick Start (modalità SOAP): firma digitale di un modulo basato su XFA tramite l’API Java](signature-service-java-api-quick.md#quick-start-soap-mode-digitally-signing-a-xfa-based-form-using-the-java-api)

[Quick Start (modalità SOAP): certificazione di un documento PDF tramite l’API Java](signature-service-java-api-quick.md#quick-start-soap-mode-certifying-a-pdf-document-using-the-java-api)
...
Nell&#39;esempio di codice Java seguente vengono recuperati i nomi dei campi firma in un documento di PDF denominato *LoanSig.pdf*. (Vedere [Recupero dei nomi dei campi di firma](/help/forms/developing/digitally-signing-certifying-documents.md#retrieving-signature-field-names).)
...
Nell&#39;esempio di codice Java riportato di seguito viene applicata una marca temporale a un documento PDF:

...
description: Aggiungi endpoint come EJB, SOAP, cartella controllata, endpoint e-mail, endpoint remoto e altro ancora. Inoltre, modifica, rimuovi e recupera un endpoint utilizzando l’API Java.

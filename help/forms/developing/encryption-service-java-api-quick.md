...
## Avvio rapido (modalità SOAP): Cifratura di un documento PDF con un certificato tramite l&#39;API Java {#quick-start-soap-mode-encrypting-a-pdf-document-with-a-certificate-using-the-java-api}

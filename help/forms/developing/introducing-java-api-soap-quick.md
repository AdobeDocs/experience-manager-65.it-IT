...
description: Le operazioni di AEM Forms possono essere eseguite utilizzando l’API Java di AEM Forms fortemente tipizzata abilitata con la connessione SOAP.

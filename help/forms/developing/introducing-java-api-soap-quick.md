...
description: Scopri come eseguire le operazioni di AEM Forms utilizzando l’API fortemente tipizzata di AEM Forms Java&trade con connessione SOAP.
contentOwner: admin
...
[Guida rapida (modalità SOAP): passaggio di documenti al servizio di output tramite l&#39;API Java™](/help/forms/developing/output-service-java-api-quick.md#quick-start-soap-mode-passing-documents-to-the-output-service-using-the-java-api) (richiamo del servizio di output e gestione dei documenti)

...
description: Utilizzate il servizio Assembler per modificare un documento PDF che contiene segnalibri per includere segnalibri tramite l'API Java e l'API del servizio Web.
seo-description: Utilizzate il servizio Assembler per modificare un documento PDF che contiene segnalibri per includere segnalibri tramite l'API Java e l'API del servizio Web.

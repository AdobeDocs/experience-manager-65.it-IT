...
description: Utilizzare il servizio Forms per recuperare i dati del modulo immessi dall’utente in un modulo interattivo. Trasmettere i dati del modulo a un’altra operazione del servizio AEM Forms e creare un documento PDF utilizzando i dati.
seo-description: Utilizzare il servizio Forms per recuperare i dati del modulo immessi dall’utente in un modulo interattivo. Trasmettere i dati del modulo a un’altra operazione del servizio AEM Forms e creare un documento PDF utilizzando i dati.

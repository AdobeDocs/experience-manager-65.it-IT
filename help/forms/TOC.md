...
+ [Guida utente di AEM 6.5 Forms](home.md)
...
+ Installare e configurare AEM Forms {#install-aem-forms}
   ...
   + Installare AEM Forms su OSGi {#osgi-installation}
      ...
      + [Installazione e configurazione del flusso di lavoro incentrato sui moduli in OSGi](using/installing-configuring-forms-centric-workflow-on-osgi.md)
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Installazione e implementazione di AEM Forms su JEE tramite chiavi in mano JBoss](http://www.adobe.com/go/learn_aemforms_installTurnkey_65)
...
+ Gestisci moduli AEM {#manage-administer-aem-forms}
   ...
   + Gestione dei dati utente {#handling-user-data}
      + [Flussi di lavoro incentrati sui moduli in OSGi](using/forms-workflow-osgi-handling-user-data.md)
...
+ Moduli adattivi - Authoring avanzato {#adaptive-forms-advanced-authoring}
   ...
   + [Utilizzo del flusso di lavoro di traduzione AEM per localizzare moduli adattivi e documenti di registrazione](using/using-aem-translation-workflow-to-localize-adaptive-forms.md)
...
+ Sicurezza dei documenti {#use-document-security}
   ...
   + [Abilitare AEM per la ricerca di documenti PDF protetti per la protezione dei documenti](using/enable-search-for-drm-protected-pdf-documents-in-aem.md)
   + [Reader che estende i documenti PDF protetti tramite criterio tramite la libreria Protezione portatile](using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
   + [Abilitare AEM per la ricerca di documenti PDF protetti per la protezione dei documenti e documenti Microsoft Office](using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
   + [Proteggere un documento per conto di un altro utente](using/protect-document-on-behalf-of-another-user.md)
...
+ Guida dell&#39;amministratore per AEM Forms su JEE {#administrator-help}
   ...
   + Configurazione della gestione utente {#configure-user-management}
      ...
      + [Configurare i moduli AEM per la preacquisizione delle informazioni di dominio](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
   ...
   + Gestione di moduli AEM {#maintain-aem-forms}
      ...
      + [Esecuzione di moduli AEM in modalità di manutenzione](/help/forms/using/admin-help/running-aem-forms-maintenance-mode.md)
   ...
   + Moduli AEM Backup e ripristino {#aem-forms-backup-recovery}
...
+ Riferimento per sviluppatori {#developer-reference}
   ...
   + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
      ...
      + Avvio rapido di Java API - Esempi di codice {#java-api-quick-start-code-examples}
         ...
         + [Java APIQuick Start(SOAP) del servizio Forms con codice a barre](developing/barcoded-forms-service-java-api.md)
         ...
         + [Avvio rapido API Java del servizio Distiller (SOAP)](developing/distiller-service-java-api-quick.md)
         ...
         + [Avvio rapido dell&#39;API di Forms Service](developing/forms-service-api-quick-starts.md)
      ...
      + Richiamo di moduli AEM su JEE tramite API {#invoking-aem-forms-jee-apis}
         ...
         + [Attivazione di moduli AEM tramite i servizi Web](developing/invoking-aem-forms-using-web.md)
      ...
      + Esecuzione di operazioni di servizio tramite API {#performing-service-operations-using-apis}
         ...
         + [Rendering dei moduli](developing/rendering-forms.md)

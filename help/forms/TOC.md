...
+ [Guida ai moduli di AEM 6.5](home.md)
...
+ Guida introduttiva {#getting-started}
   ...
   + Esercitazione: Crea la prima comunicazione interattiva {#create-first-interactive-communication}
   ...
   + Materiali di riferimento per AEM Forms {#aem-forms-reference-collaterals}
...
+ Installare e configurare AEM Forms {#install-aem-forms}
   ...
   + Installa AEM Forms su OSGi {#osgi-installation}
      + [Piattaforme supportate per AEM Forms su OSGi](https://docs.adobe.com/content/help/it-IT/experience-manager-65/deploying/introduction/technical-requirements.html)
      ...
      + [Installare e configurare il servizio di conversione automatica dei moduli](https://docs.adobe.com/content/help/en/aem-forms-automated-conversion-service/table-of-contents/configure-service.html)
   + Installare AEM Forms su JEE {#jee-installation}
      + [Piattaforme supportate per AEM Forms su JEE](using/aem-forms-jee-supported-platforms.md)
      + [Installazione e distribuzione di AEM Forms su JEE utilizzando JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_installTurnkey_65)
      + [Installazione e configurazione del server di sicurezza dei documenti di AEM Forms](using/installing-and-configuring-the-document-security-server.md)
      ...
      + [Installa Workbench di AEM Forms](using/install-workbench.md)
      + [Installare e configurare Designer](using/installing-configuring-designer.md)
      + [Preparazione all’installazione di AEM Forms (cluster di server)](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_65)
      + [Configurazione di Adobe Experience Manager Forms su JEE nel cluster JBoss](http://www.adobe.com/go/learn_aemforms_clusterJBoss_65)
      + [Configurazione di Adobe Experience Manager Forms su JEE nel cluster WebSphere](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_65)
      + [Configurazione dei moduli Adobe Experience Manager su JEE nel cluster WebLogic](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_65)
   + Configura Moduli AEM {#configure-aem-forms}
      ...
      + [Configurazione di AEM Forms per inviare i dati del modulo a un processo AEM Forms su JEE](using/submit-form-data-livecycle-process.md)
...
+ Aggiornare AEM Forms {#upgrade-aem-forms}
   ...
   + Aggiornare AEM Forms su OSGi {#aem-forms-osgi-upgrade}
      + [Aggiornamento ad AEM 6.5 Forms su OSGi](using/upgrade-forms-osgi.md)
      + [Installa il pacchetto di compatibilità](using/compatibility-package.md)
      + [Risorse e documenti relativi alla migrazione in AEM Forms](using/migration-utility.md)
   + Aggiornare AEM Forms su JEE {#aem-forms-jee-upgrade}
      ...
      + [Elenco di controllo e pianificazione dell’aggiornamento di Adobe Experience Manager Forms su JEE](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_65)
      + [Aggiornamento ad AEM 6.5 Forms su JEE](using/upgrade-forms-jee.md)
      + [Aggiornamento ad Adobe Experience Manager Forms su JEE per JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_65)
      + [Aggiornamento ad AEM Forms su JEE per JBoss Turnkey](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
      + [Aggiornamento ad Adobe Experience Manager Forms su JEE per WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_65)
      + [Aggiornamento ad Adobe Experience Manager Forms su JEE per WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_65)
+ Gestire i moduli AEM {#manage-administer-aem-forms}
   ...
   + Gestione dei dati utente {#handling-user-data}
      + [Flussi di lavoro incentrati sulle forme su OSGi](using/forms-workflow-osgi-handling-user-data.md)
      + [Gestione utente di Forms](using/user-management-handling-user-data.md)
      + [Flussi di lavoro JEE per Forms](using/forms-workflow-jee-handling-user-data.md)
      + [Portale moduli](using/forms-portal-handling-user-data.md)
   ...
   + Hardening dell&#39;ambiente di AEM Forms {#hardening-aem-forms-environment}
      ...
      + [Hardening dei moduli AEM in ambiente JEE](using/hardening-aem-forms-jee-environment.md)
...
+ Moduli adattivi - Authoring di base {#adaptive-forms-basic-authoring}
   ...
   + [Incorporare un modulo adattivo o una comunicazione interattiva nella pagina Siti AEM](using/embed-adaptive-form-aem-sites.md)
...
+ Moduli adattivi - Authoring avanzato {#adaptive-forms-advanced-authoring}
   ...
   + [Utilizzo del flusso di lavoro di traduzione AEM per localizzare i moduli adattivi e il documento di registrazione](using/using-aem-translation-workflow-to-localize-adaptive-forms.md)
   ...
   + [Sincronizzazione dei moduli adattivi con i modelli di moduli XFA](using/synchronizing-adaptive-forms-xfa.md)
   ...
   + [Messaggi di errore di convalida standard - Moduli adattivi](/help/forms/using/standard-validation-error-messages-adaptive-forms.md)
...
+ Flussi di lavoro {#workflows}
   + [Flusso di lavoro incentrato sulle forme su OSGi](using/aem-forms-workflow.md)
   + [Flusso di lavoro incentrato sulle forme su OSGi - Riferimento dettagliato](using/aem-forms-workflow-step-reference.md)
   ...
   + [Azioni e funzionalità dei flussi di lavoro AEM incentrati sui moduli sui flussi di lavoro JEE per OSGi e AEM Forms](using/capabilities-osgi-jee-workflows.md)
   + [Avvia API di Document Services dal flusso di lavoro AEM](using/initiating-document-services-apis-aem.md)
...
+ Area di lavoro di AEM Forms {#use-aem-forms-workspace}
   ...
   + [Caratteristiche dello spazio di lavoro AEM Forms non disponibile nello spazio di lavoro Flex](using/features-html-workspace-available-flex.md)
   + [Caratteristiche dello spazio di lavoro Flex non disponibile nello spazio di lavoro AEM Forms](using/features-flex-workspace-available-html.md)
   ...
   + [Descrizione dell’oggetto JSON dell’area di lavoro di AEM Forms](using/html-workspace-json-object-description.md)
   ...
   + [Modifica delle impostazioni internazionali dell’interfaccia utente dell’area di lavoro di AEM Forms](using/changing-locale-user-interface.md)
   ...
   + [Hosting di due istanze dell’area di lavoro di AEM Forms su un server](using/two-html-workspace-instances-one.md)
   ...
   + [Integrazione dell’area di lavoro di AEM forms con Microsoft Office SharePoint Server](using/integrating-aem-forms-workspace-with-microsoft-office-sharepoint-server.md)
   + [Utilizzo degli elenchi A-do](using/todo-lists.md)
   + [Linee guida per la risoluzione dei problemi per l’area di lavoro di AEM Forms](using/troubleshooting-guidelines-html-workspace.md)
+ App AEM Forms {#aem-forms-app}
   + [Introduzione all’app AEM Forms](using/aem-forms-app.md)
   + [Ambiente di configurazione per l’app AEM Forms](using/setup-environment-mobile-workspace.md)
   ...
   + [Distribuisci l’app AEM Forms](using/distribute-mobile-workspace-app.md)
...
+ Moduli HTML5 {#html5-forms}
   ...
   + [Differenziazione delle funzioni tra i moduli HTML5 e i moduli PDF](using/feature-differentiation-html5-forms-pdf-forms.md)
   + [Domande frequenti per i moduli HTML5](using/faq.md)
   ...
   + [Genera l’anteprima HTML5 di un modulo XDP](using/preview-xdp-forms-html.md)
   ...
   + [Creare un aspetto personalizzato nei moduli HTML5](using/custom-widgets.md)
   ...
   + [Debug dei moduli HTML5](using/debug.md)
...
+ Integrare AEM Forms con le soluzioni Experience Cloud {#integrate-aem-forms-with-experience-cloud-solutions}
   ...
   + [Visualizzare e comprendere i rapporti di analisi di AEM Forms](using/view-understand-aem-forms-analytics-reports.md)
...
+ Pubblicare ed elaborare AEM Forms {#publish-process-aem-forms}
   ...
   + [Gestione di applicazioni e attività Forms nella casella in entrata di AEM](using/manage-applications-inbox.md)
...
+ Document Services {#use-document-services}
   ...
   + [Servizio Moduli Barcoded](using/using-barcoded-forms-service.md)
...
+ Sicurezza dei documenti {#use-document-security}
   ...
   + [Abilita AEM per cercare documenti PDF protetti da protezione dei documenti](using/enable-search-for-drm-protected-pdf-documents-in-aem.md)
   + [Lettore che estende i documenti PDF protetti da policy utilizzando la Libreria di protezione portatile](using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
   + [Abilita AEM per cercare documenti PDF protetti da protezione dei documenti e documenti Microsoft Office](using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
   + [Protezione di un documento per conto di un altro utente](using/protect-document-on-behalf-of-another-user.md)
+ Forms Designer {#use-forms-designer}
   ...
   + [Uso della firma digitale nei moduli HTML5](using/scribble-signature.md)
+ Personalizzare AEM Forms {#customize-aem-forms}
   + [Struttura dell’aspetto per i moduli adattivi e HTML5](using/introduction-widgets.md)
...
+ Aiuto per l’amministratore di AEM Forms su JEE {#administrator-help}
   ...
   + Configurazione di User Management {#configure-user-management}
      ...
      + [Configurare AEM Forms per preacquisire informazioni sul dominio](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
   ...
   + Configurazione delle estensioni Acrobat Reader DC {#configure-acrobat-reader-dc-extensions}
      ...
      + [Riconoscimento dei certificati validi e scaduti nei documenti PDF](/help/forms/using/admin-help/recognizing-valid-expired-certificates-pdf.md)
      ...
      + [Abilitazione dei commenti online per il plug-in browser Web di Adobe Reader](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
   ...
   + Utilizzo di PDF Generator {#work-with-pdf-generator}
      ...
      + [Configurazione delle impostazioni Adobe PDF](/help/forms/using/admin-help/configuring-pdf-settings.md)
   ...
   + Configurazione dei moduli {#configure-forms}
   ...
   + Manutenzione di AEM Forms {#maintain-aem-forms}
      ...
      + [Monitoraggio delle implementazioni di AEM forms](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
      + [Work Manager e limitazione](/help/forms/using/admin-help/manager-throttling.md)
      + [Esecuzione di AEM forms in modalità di manutenzione](/help/forms/using/admin-help/running-aem-forms-maintenance-mode.md)
   ...
   + Backup e ripristino di AEM Forms {#aem-forms-backup-recovery}
      ...
      + [Ripristino dei dati di AEM forms](/help/forms/using/admin-help/recovering-aem-forms-data.md)
...
+ Guida di riferimento per sviluppatori {#developer-reference}
   ...
   + [API di Form Bridge per i moduli HTML5](using/form-bridge-apis.md)
   + [Riferimento API della libreria JavaScript per i moduli adattivi](https://helpx.adobe.com/experience-manager/6-5/forms/javascript-api/index.html)
   + [Servizio di assemblaggio e riferimento DDX](http://www.adobe.com/go/learn_aemforms_ddxRef_65)
   ...
   + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
      ...
      + Guida rapida all’API Java - Esempi di codice {#java-api-quick-start-code-examples}
         ...
         + [Guida rapida di Acrobat Reader DC extensions ServiceJava API (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
         + [Avvio di APIQuick del servizio di backup e ripristino](developing/backup-restore-service-api-quick.md)
         + [Avvio di APIQuick (SOAP) del servizio Forms con codice a barre](developing/barcoded-forms-service-java-api.md)
         + [Java APIQuick Start(SOAP) per componenti e servizi](developing/components-services-java-api-quick.md)
         + [Guida rapida per la conversione dell’API Java del servizio PDF (SOAP)](developing/convert-pdf-service-java-api.md)
         + [QuickStart(SOAP) API Java per servizi creativi](developing/credential-service-java-api-quick.md)
         + [Guida rapida API Java del servizio Distiller (SOAP)](developing/distiller-service-java-api-quick.md)
         ...
         + [Avvio rapido dell’API del servizio Forms](developing/forms-service-api-quick-starts.md)
         + [Guida rapida all’API Java del servizio PDF (SOAP)](developing/generate-pdf-service-java-api.md)
      ...
      + Richiamo di moduli AEM su JEE tramite API {#invoking-aem-forms-jee-apis}
         + [Richiamo di moduli AEM utilizzando le richieste REST](developing/invoking-aem-forms-using-rest.md)
         + [Richiamo di moduli AEM tramite i servizi web](developing/invoking-aem-forms-using-web.md)
         + [Richiamo di moduli AEM utilizzando la funzione REMOTO](developing/invoking-aem-forms-using-remoting.md)
      ...
      + Esecuzione di operazioni di servizio utilizzando le API {#performing-service-operations-using-apis}
         + [Esecuzione delle operazioni del servizio tramite API](developing/performing-service-operations-using-apis.md)
         + [Moduli di rendering](developing/rendering-forms.md)
         + [Assemblaggio di documenti PDF](developing/assembling-pdf-documents.md)
         + [Assemblaggio programmatico di documenti PDF](developing/programmatically-assembling-pdf-documents.md)
         ...
         + [Assemblaggio di portfolio PDF](developing/assembling-pdf-portfolios.md)
         + [Calcolo dei dati del modulo](developing/calculating-form-data.md)
         + [Creazione di applicazioni Web per il rendering di moduli](developing/creating-web-applications-renders-forms.md)
         ...
         + [Gestione dei moduli inviati](developing/handling-submitted-forms.md)
         ...
         + [Precompilazione dei moduli con layout scorrevoli](developing/prepopulating-forms-flowable-layouts.md)
         + [Rendering di moduli basati su frammenti](developing/rendering-forms-based-fragments.md)
         + [Rendering dei moduli per valore](developing/rendering-forms-value.md)
         + [Rendering dei moduli come HTML](developing/rendering-forms-html.md)
         + [Rendering dei moduli sul client](developing/rendering-forms-client.md)
         + [Rendering di moduli HTML utilizzando file CSS personalizzati](developing/rendering-html-forms-using-custom.md)
         ...
         + [Conversione di file PDF in file Postscript e di immagine](developing/converting-pdf-postscript-image-files.md)
         ...
         + [Crittografia e decrittografia di documenti PDF](developing/encrypting-decrypting-pdf-documents.md)

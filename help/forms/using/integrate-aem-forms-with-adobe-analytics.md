...
# Integrare con [!DNL Adobe Analytics] {#integrate-aem-forms-with-adobe-analytics}
...
![Panoramica di Analytics](/help/forms/using/assets/analytics-workflow.png)
...
>[!NOTE]
>Nel caso in cui [Analytics legacy](/help/forms/using/configure-analytics-forms-documents.md) e le funzioni di Launch Analytics sono abilitate simultaneamente, **Avvia Analytics** avrà la precedenza.
...
1. Tocca il campo e seleziona ![Editor regole](/help/forms/using/assets/edit-rules-icon.svg) per aprire la pagina editor di regole.

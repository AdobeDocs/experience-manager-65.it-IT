...
1. Apri le proprietà del **[!UICONTROL contenitore Modulo adattivo]**. Nel browser delle proprietà, passa a **[!UICONTROL Base]** > **[!UICONTROL Tema modulo adattivo]**. Il campo **[!UICONTROL Tema modulo adattivo]** elenca tutti i temi predefiniti e personalizzati. Per impostazione predefinita, viene applicato il tema Area di lavoro.
1. Seleziona un tema dal campo **[!UICONTROL Tema modulo adattivo]** . Ad esempio, **Tema sondaggio**. Tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) per applicare il tema selezionato.
...
1. Modifica il logo e il testo esistenti dell’intestazione. Per rimuovere il logo:
   ...
   1. Tocca l’immagine del logo nel componente [!UICONTROL header] e tocca ![cmppr](assets/cmppr.png) **[!UICONTROL properties]**. Nella proprietà [!UICONTROL image] , tocca X per rimuovere l’immagine del logo esistente.
   1. Tocca **[!UICONTROL carica]**, seleziona il logo.png e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) per salvare le modifiche. L&#39;immagine è stata scaricata nella sezione [Prima di iniziare](/help/forms/using/style-your-adaptive-form.md#before-you-start) .
   1. Tocca il testo dell’intestazione `We.Retail` e tocca ![aem_6_3_edit](assets/aem_6_3_edit.png) **[!UICONTROL edit]**. Cambia il testo dell’intestazione in `we retail`. Applica la formattazione in grassetto solo a `we`in `we retail`.
...
1. Rimuovere il titolo e aggiungere il testo segnaposto:
   ...
   1. Elimina il contenuto del campo **[!UICONTROL Titolo]** e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca **[!UICONTROL Crea]** e seleziona **[!UICONTROL Tema]**. Viene visualizzata la pagina [!UICONTROL Crea tema] con i campi necessari per creare un tema. I campi **[!UICONTROL Titolo]** e **[!UICONTROL Nome]** sono obbligatori:
...
1. Tocca **[!UICONTROL Opzioni tema]** ![opzioni tema](assets/theme-options.png) > **[!UICONTROL Configura]**. Nel campo **[!UICONTROL Anteprima modulo]** , seleziona il modulo adattivo **shipping-address-add-update-form** , tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png) e tocca **[!UICONTROL Salva]**. Ora, l’editor di temi è configurato per utilizzare il proprio modulo adattivo invece del modulo adattivo predefinito. Tocca **[!UICONTROL Annulla]** per tornare all’editor di temi.
...
1. Passa all’opzione **[!UICONTROL Intestazione]** > **[!UICONTROL Testo]** nel pannello Selettori. Il pannello Selettori si trova a sinistra dell’editor di temi. Se il pannello non è visibile, tocca ![interruttore-side-panel](assets/toggle-side-panel.png) Attiva/disattiva pannello laterale.

1. Imposta le seguenti proprietà nel pannello a soffietto **[!UICONTROL Testo]** e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca il widget [!UICONTROL header] e tocca **[!UICONTROL Header]**. Le opzioni di stile del widget Intestazione vengono visualizzate a sinistra. Espandi il pannello a soffietto **[!UICONTROL Dimension e posizione]**, imposta **[!UICONTROL Altezza]** su `120px` e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
1. Espandi il **[!UICONTROL Sfondo]** a soffietto del widget di intestazione, imposta il **[!UICONTROL Colore di sfondo]** su `F6921E.`

   Passa il puntatore del mouse su **[!UICONTROL Immagine e sfumatura]** > **[!UICONTROL + Aggiungi]**, tocca **[!UICONTROL Immagine]**. Imposta le seguenti proprietà e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca il widget piè di pagina e tocca **[!UICONTROL Piè di pagina]**. Espandi il pannello a soffietto **[!UICONTROL Sfondo]**, imposta il **[!UICONTROL Colore di sfondo]** su `F6921E` e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca il campo **[!UICONTROL ID cliente]** e tocca l’opzione **[!UICONTROL Widget del campo]** . Imposta le seguenti proprietà e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca l’area vuota sopra il campo **[!UICONTROL ID cliente]** e tocca **[!UICONTROL Contenitore pannello reattivo]**. Imposta **[!UICONTROL Sfondo]** > **[!UICONTROL Colore di sfondo]** su F1F2F2. Tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca il pulsante **[!UICONTROL Invia]** e tocca l’opzione **[!UICONTROL Pulsante]** . Imposta le seguenti proprietà e tocca ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
...
1. Tocca il pulsante **[!UICONTROL Allega]** e tocca l’icona ![aem_6_3_edit](assets/aem_6_3_edit.png). Imposta le seguenti proprietà nei Dimension **[!UICONTROL e nel pannello a soffietto]**:
...
1. Tocca l’opzione **[!UICONTROL bozza indirizzo approvata dal governo]** e tocca l’icona ![aem_6_3_edit](assets/aem_6_3_edit.png). Imposta le seguenti proprietà:
...
1. Tocca il pulsante **[!UICONTROL Invia]** e tocca l’icona ![aem_6_3_edit](assets/aem_6_3_edit.png) . Imposta le seguenti proprietà:
...
>[!NOTE]
>
>![typekit-to-adobe-](assets/typekit-to-adobe-fonts.png) [!DNL Typekit] fontsis ora chiamato Adobe Fonts ed è incluso con Creative Cloud e altri abbonamenti. [Per saperne di più](https://fonts.adobe.com/).

1. Crea un account [Adobe Fonts](https://typekit.com/), crea un kit, aggiungi il font Myriad Pro al kit, pubblica il kit e ottieni l&#39;ID kit. È necessario utilizzare [!DNL Adobe Fonts] (font Web) in un modulo adattivo.
1. Nel server AEM [!DNL Forms] , passa a ![adobeexperiencemanager](assets/adobeexperiencemanager.png) **[!UICONTROL Adobe Experience Manager]** > **[!UICONTROL Strumenti]** ![martello](assets/hammer.png) > **[!UICONTROL Adobe Fonts]**. Ora apri una cartella di configurazione. Se una configurazione è già disponibile, fai clic sul pulsante **[!UICONTROL Crea]** per creare una nuova istanza.

   Nella finestra di dialogo Crea configurazione, specifica un **Titolo** per la configurazione e fai clic su **[!UICONTROL Crea]**. Verrai reindirizzato alla pagina di configurazione. Nella finestra di dialogo [!UICONTROL Modifica componente] visualizzata, fornisci il tuo **ID kit** e fai clic su **[!UICONTROL OK]**.

1. Configura il tema per utilizzare la configurazione [!DNL Adobe Fonts]. Nell&#39;istanza dell&#39;autore, apri **[!UICONTROL Tema globale]** nell&#39;editor di temi. Nell&#39;editor dei temi, passa a **[!UICONTROL Opzioni tema]** ![opzioni tema](assets/theme-options.png) > **[!UICONTROL Configura]**. Nel campo **[!UICONTROL Configurazione Adobe Fonts]**, seleziona il kit e fai clic su **[!UICONTROL Salva]**.

   I font aggiunti a **[!UICONTROL Adobe Fonts]** sono disponibili per la selezione nel pannello **[!UICONTROL Testo]** di tutti i componenti.

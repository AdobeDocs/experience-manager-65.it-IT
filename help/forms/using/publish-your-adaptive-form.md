...
1. Aprire la scheda del browser contenente la pagina AEM [!DNL Sites] aperta al passaggio 1. Seleziona la casella **[!UICONTROL Trascina qui i componenti]** e seleziona **+.** Nella casella **[!UICONTROL Inserisci nuovo componente]** selezionare **[!UICONTROL AEM Form]**. Il componente **[!UICONTROL Contenitore AEM Forms]** è stato aggiunto alla pagina.

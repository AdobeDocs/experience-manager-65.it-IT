...
Se si creano filtri per rapporti predefiniti, si verificano i seguenti problemi in modo intermittente nell&#39;ambiente **Internet Explorer 9** per **Microsoft Windows 7**:

...
**Linguaggio OCRL primario:** Linguaggio utilizzato dal motore OCR per identificare i caratteri. Il valore predefinito è Inglese (Stati Uniti).
...
1. Se si desidera incorporare solo i sottoinsiemi in uso dei tipi di carattere incorporati, selezionare **Sottoimposta tutti i tipi di carattere incorporati**.
   ...
   >[!NOTE]
   >
   >*Se si utilizza questa opzione in combinazione con **Alcuni tipi di carattere non incorporati**, i tipi di carattere inclusi nell&#39;elenco di tipo **A**dd da non incorporare sono ancora completamente non incorporati.*

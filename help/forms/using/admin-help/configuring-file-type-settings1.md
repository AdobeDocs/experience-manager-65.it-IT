...
* Specificare le impostazioni del tipo di file da utilizzare per impostazione predefinita (vedere [Importazione ed esportazione di file di configurazione PDF Generator](https://helpx.adobe.com/aem-forms/6-2/admin-help/importing-exporting-pdf-generator-configuration.html))
...
**Lingua principale OCRL:** la lingua utilizzata dal motore OCR per identificare i caratteri. Il valore predefinito è Inglese (USA).
...
Queste opzioni determinano la modalità di conversione dei file Microsoft PowerPoint. Per istruzioni su come accedere a queste opzioni, vedere [Creare o modificare le impostazioni dei tipi di file](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
Queste opzioni determinano la modalità di conversione dei file AutoCAD. Per istruzioni su come accedere a queste opzioni, vedere [Creare o modificare le impostazioni dei tipi di file](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).
...
**[!UICONTROL Crea file]** conforme con PDF/E-1: Crea un file conforme allo standard PDF/E-1. PDF/E è uno standard ISO per lo scambio di documentazione tecnica e tecnica. Per ulteriori informazioni su PDF/E-1, vedere [ standard di Adobe e di settore](https://www.adobe.com/enterprise/standards/index.html).
...
Queste opzioni determinano la modalità di conversione dei file OpenOffice. Per istruzioni su come accedere a queste opzioni, vedere [Creare o modificare le impostazioni dei tipi di file](/help/forms/using/admin-help/configuring-file-type-settings1.md#create-or-edit-file-type-settings).

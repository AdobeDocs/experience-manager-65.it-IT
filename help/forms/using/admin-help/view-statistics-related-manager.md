...
description: La scheda Gestione lavoro visualizza le statistiche relative agli elementi di Gestione lavoro. Scoprite come visualizzare e filtrare gli elementi di lavoro.
seo-description: La scheda Gestione lavoro visualizza le statistiche relative agli elementi di Gestione lavoro. Scoprite come visualizzare e filtrare gli elementi di lavoro.
...
**** Gestione processi: Tutti i processi appartenenti a Job Manager. Job Manager gestisce i propri processi e ha i propri stati. Consultate gli stati specifici del processo descritti di seguito.
...
**** Eventi: Tutti gli elementi di lavoro appartenenti a Gestione evento. Gestione eventi non gestisce i propri elementi di lavoro, ma si affida a Work Manager; pertanto, gli stati appartengono a Work Manager.
...
**** In pausa: Visualizza tutti gli elementi di lavoro pianificati messi in pausa dall&#39;applicazione client. Questi elementi possono essere eseguiti o eliminati. Consultate Gestire gli elementi di lavoro o i processi.

**** In corso: Visualizza tutti gli elementi di lavoro estratti dal manager del server applicazione e che verranno completati o meno. Non è possibile utilizzare le operazioni su questi elementi di lavoro.
...
**** Sospendi richiesta: Visualizza i processi per i quali è stata effettuata una richiesta di sospensione.
...
## Informazioni sull&#39;interfaccia della scheda Gestione lavoro {#about-the-work-manager-tab-interface}
...
1. Utilizzate gli strumenti operativi descritti di seguito per gestire gli elementi di lavoro o i processi elencati.
   ...
   **** Riprova elementi: Tenta di ripetere l&#39;elemento di lavoro o il processo selezionato dallo stato corrente.
...
Lo stato Pausa interrompe questo flusso normale. L&#39;applicazione client o l&#39;amministratore di sistema possono avviare questa interruzione (ad esempio, per manutenzione o aggiornamento). È possibile invertire questa azione utilizzando l&#39;operazione Riprendi per riportare l&#39;elemento di lavoro in uno stato Pianificato.

...
La prima volta che si installa Document Security, questo contiene un criterio condiviso denominato *Limita a tutte le entità*. Quando questo criterio viene applicato a un documento, tutti gli utenti che possono accedere a Document Security possono accedere al documento. Questo criterio si trova nel set di criteri denominato *Global Policy Set*. Per impostazione predefinita, questo criterio non è attivato. Puoi attivarla se soddisfa le esigenze della tua organizzazione.

**Criteri generati automaticamente da Microsoft Outlook**

Con Acrobat è possibile applicare criteri ai documenti inviati come allegati e-mail in Microsoft Outlook. In Outlook, è possibile proteggere un documento utilizzando un criterio esistente o utilizzando un criterio generato automaticamente che Acrobat genera con impostazioni predefinite per la salvaguardia della riservatezza e si applica al documento allegato a un messaggio e-mail. (Vedere la Guida *[di](https://help.adobe.com/en_US/acrobat/pro/using/index.html)*Acrobat).
...
1. Aggiungete utenti e gruppi al criterio e impostate le autorizzazioni appropriate. Consultate [Utenti e gruppi](creating-policies.md#users-and-groups).
1. In Impostazioni generali, selezionate le opzioni appropriate. Consultate Impostazioni [generali](creating-policies.md#general-settings).
...
1. In Impostazioni avanzate, selezionate le opzioni appropriate. Consultate Impostazioni [](creating-policies.md#advanced-settings)avanzate.
1. In Impostazioni avanzate non modificabili, selezionare le opzioni appropriate. Consultate [Impostazioni](creating-policies.md#unchangeable-advanced-settings)avanzate non modificabili.
1. Fai clic su Salva. Il criterio viene visualizzato nell&#39;elenco dei criteri. Accanto al nuovo criterio viene visualizzata un&#39;icona con un cerchio rosso a indicare che è ancora disattivato.
   ...
   Per rendere il criterio disponibile agli utenti, attivatelo. Consultate [Attivare o disattivare i criteri](creating-policies.md#enable-or-disable-shared-policies)condivisi.

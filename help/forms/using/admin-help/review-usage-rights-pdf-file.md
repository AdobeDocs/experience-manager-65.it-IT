...
1. Accedere all’applicazione Web delle estensioni Acrobat Reader DC all’indirizzo `http://[localhost]:[port]/ReaderExtensions` (dove *[porta]* è il numero di porta del server dell’applicazione).

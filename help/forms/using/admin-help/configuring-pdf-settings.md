...
* Caricare e scaricare file prolog ed epilog. Consultate [Caricamento e download di file](configuring-pdf-settings.md#uploading-and-downloading-prologue-and-epilogue-files)prolog ed epilog.
...
**** Dimensione file minima: Consente di creare file PDF per la visualizzazione sul Web o su una rete Intranet o per la distribuzione tramite un sistema e-mail per la visualizzazione a schermo. Questa serie di opzioni utilizza la compressione, il downsampling e una risoluzione delle immagini relativamente bassa. Converte tutti i colori in sRGB e non incorpora i font se non necessario. Ottimizza anche i file per la trasmissione dei byte. Questi file PDF possono essere aperti in Acrobat 5 e Acrobat Reader 5.0 e versioni successive.
...
1. Fate clic su Nuovo o sul nome di un’impostazione esistente.
...
È possibile eliminare definitivamente le impostazioni PDF se non sono più necessarie.
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>Non può contenere immagini con effetti di trasparenza dinamici. Qualsiasi trasparenza deve essere appiattita prima di convertirla in PDF 1.3.</p> </td>
  ...
  <tr>
   <td><p>È possibile incorporare più font. (Distiller converte i font durante l'incorporazione.)</p> </td>
   <td><p>È possibile incorporare più font.</p> </td>
   <td><p>È possibile incorporare più font.</p> </td>
   <td><p>È possibile incorporare più font.</p> </td>
  </tr>
  <tr>
...
***Nota **: Se Elabora commenti DSC è selezionato nelle impostazioni Avanzate e se sono inclusi i commenti di orientamento %%Viewing, tali commenti hanno precedenza nel determinare l&#39;orientamento della pagina.*
...
***Nota **: Aumentando l&#39;impostazione della risoluzione, la dimensione del file aumenta e potrebbe aumentare leggermente il tempo necessario per elaborare alcuni file.*
...
Le opzioni Immagini specificano la compressione e il ricampionamento delle immagini. Potete provare a utilizzare queste opzioni per trovare un equilibrio appropriato tra dimensione del file e qualità dell&#39;immagine. Per istruzioni su come accedere alle impostazioni Immagini, vedere [Aggiungere o modificare le impostazioni](configuring-pdf-settings.md#add-or-edit-pdf-settings)PDF.
...
***Nota **: La compressione di testo e grafica è sempre attiva.*
...
***Nota **: In tutti i casi, gli intenti possono essere ignorati o sostituiti da operazioni di gestione del colore che si verificano dopo la creazione del file PDF.*
...
**** Grigio: Definisce lo spazio colore di tutte le immagini in scala di grigio nei file. Questa opzione è disponibile solo se avete scelto Tag Tutto per Gestione colore o Tag Solo Immagini per Gestione colore. Il profilo ICC predefinito per le immagini in grigio è Gamma 2.2. Potete anche selezionare Nessuno per impedire la conversione delle immagini in scala di grigio.

**** RGB: Definisce lo spazio colore di tutte le immagini RGB nei file. Il valore predefinito, sRGB IEC61966-2.1, è generalmente una buona scelta perché sta diventando uno standard di settore e molti dispositivi di output lo riconoscono. Potete anche selezionare Nessuno per evitare la conversione delle immagini RGB.
...
***Nota **: La selezione di Nessuno per tutti e tre gli spazi di lavoro ha lo stesso effetto della selezione di Mantieni colore invariato.*
...
**** Nome Registro di sistema (URL): Indica l&#39;indirizzo Web per ulteriori informazioni sul Registro di sistema. L’URL viene immesso automaticamente per i nomi del registro ICC.
...
***Nota **: L&#39;impostazione Predefinita per le opzioni di ingrandimento e layout di pagina utilizza le singole impostazioni utente nelle preferenze Visualizzazione pagina di Acrobat o Adobe Reader.*
...
***Nota **: Se si nascondono la barra dei menu e la barra degli strumenti, gli utenti non possono applicare comandi e selezionare strumenti a meno che non siano a conoscenza delle scelte rapide da tastiera all&#39;apertura del file in Acrobat.*

...
**Oggetto singolo:** Il provider di posta elettronica non dispone della destinazione della cartella di origine; i risultati vengono restituiti come allegati. Il pattern è Result/%F.ps e restituisce Result%%sourcefilename.ps come allegato del nome del file.

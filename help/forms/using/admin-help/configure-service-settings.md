...
**Risoluzione soglia per l&#39;arrotondamento (in dpi):** La risoluzione dell&#39;immagine al di sotto della quale viene applicata l&#39;uniformità (o l&#39;anti-alias) al testo, alla grafica e alle immagini, se per tali elementi avete selezionato le opzioni &quot;Applica arrotondamento&quot;.
...
**Applicazione dell’arrotondamento alle immagini:** Applica l’uniformità per ridurre al minimo le modifiche brusche apportate alle immagini.
...
**pathInfoExpiryInSeconds:** Intervallo dopo il quale scade una richiesta di informazioni sul percorso da parte di un client. Default is 1.
...
**Secondi di scansione pulizia PDFG:** Per informazioni dettagliate, consultate la sezione Secondi scadenza processo.
...
**Cache del ciclo di vita del certificato:** Durata di un certificato, recuperata online o con altri metodi, nella cache. Il valore predefinito è 1 giorno.
...
**Tempo di connessione scaduto:** Tempo massimo di attesa, in secondi, per stabilire una nuova connessione. Il valore minimo è 1 e il valore massimo è 300. Il valore predefinito è 5.
...
**Seguite gli URI in Certificate AIA:** Specifica se gli URI (Uniform Resource Identifiers) nell&#39;AIA del certificato vengono elaborati durante l&#39;individuazione del percorso. Il valore predefinito è false.
...
**Richiedi alias credenziali firmatario:** Specifica l&#39;alias delle credenziali da utilizzare per firmare la richiesta OCSP se la firma è abilitata. Utilizzata solo se la firma della richiesta OCSP è abilitata. Nessun valore predefinito.
...
**Conteggio ripetizioni:** Il numero di volte in cui viene effettuato il polling della directory di input. Conteggio ripetizioni predefinito da utilizzare se questo valore non è specificato nella configurazione dell&#39;endpoint. Il valore -1 indica la scansione indefinita della directory. Il valore predefinito è -1.

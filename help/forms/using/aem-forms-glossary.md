...
[Moduli adattivi](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/creating-adaptive-form)
...
[Controllo delle versioni dei moduli adattivi](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-core-components/add-versioning-reviews-comments)
...
## Integrazione di Adobe Analytics Forms

[Integrazione di Adobe Analytics Forms](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation)
...
[Pacchetto del componente aggiuntivo AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/osgi-installation/installing-configuring-aem-forms-osgi)

Un’applicazione distribuita in Adobe Experience Manager (AEM) come pacchetto, contenente servizi (provider API) e servlet o JSP gestiti dal framework Sling di AEM.

## AEM Forms su JEE

[AEM Forms su JEE](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/jee-installation/aem-forms-jee-supported-platforms)
...
AEM Forms nell’ambiente OSGi è il pacchetto standard AEM Author o AEM Publish con AEM Forms distribuito su di esso. Puoi eseguire AEM Forms su OSGi in un ambiente server singolo, in una farm e in configurazioni cluster. La configurazione del cluster è disponibile solo per le istanze di AEM Author.

## Adobe Accedi ad AEM Forms

[Adobe Accedi ad AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-advanced-authoring/adobe-sign-integration-adaptive-forms)
...
API fornite dal livello web di AEM Forms per l’utilizzo remoto da parte di client basati su HTTP, come i moduli SDK per dispositivi mobili.Funzionalità all’interno di AEM Forms che consentono la creazione, l’assemblaggio, la distribuzione e l’archiviazione di documenti PDF, l’aggiunta di firme digitali e la decodifica di Forms in codice a barre.

| **Nome servizio** | **Descrizione** | **Collegamento alla documentazione** |
|------------------------------|---------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
| **Servizio Forms** | Esegui il rendering di PDF forms utilizzando modelli e XML, integra i dati del modulo per l’importazione o l’esportazione e supporta il rendering basato su frammenti. | [Documentazione del servizio Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
| **Servizio di output** | Genera documenti unendo dati con modelli in formati come PDF, PCL o PostScript. | [Documentazione del servizio di output](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/output-service) |
| **Servizio assemblatore** | Combina, riorganizza, convalida e migliora i documenti PDF e XDP. | [Documentazione del servizio Assembler](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/assembler-service) |
| **Converti servizio PDF** | Converte i documenti PDF in PostScript o in formati immagine come PNG, JPEG o TIFF. | [Documentazione del servizio ConvertPDF](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/using-convertpdf-service) |
...
| **Servizio DocAssurance** | Crittografia, decrittografia, firma digitale e applicazione di criteri di protezione dei documenti ai PDF. | [Documentazione del servizio DocAssurance](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-document-services/overview-aem-document-services#doc-assurance-service) |
...
## API di comunicazione Forms as a Cloud Service

[API di comunicazione Forms as a Cloud Service](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction)
...
| **Nome servizio** | **Descrizione** | **Collegamento alla documentazione** |
|-------------------------------|------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
| **Generazione documento** | Combinate un modello (XFA o PDF) con dati XML per generare documenti in formato PDF e formati di stampa come PS, PCL, DPL, IPL e ZPL. | [Documentazione sulla generazione di documenti](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html#document-generation) |
| **Manipolazione documento** | Combinare e ridisporre i documenti di PDF. | [Documentazione sulla manipolazione dei documenti](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#document-manipulation) |
| **Conversione documento** | Converti un PDF in PDF/A e verifica la conformità PDF/A. | [Documentazione sulla conversione dei documenti](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#document-conversion) |
| **Documento Assurance** | Aggiungere o rimuovere campi di firma, firmare, certificare, crittografare, decrittografare e applicare diritti di utilizzo ai documenti di PDF. | [Documentazione di Document Assurance](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#doc-assurance) |
...
Modello o pattern utilizzato in AEM per generare un nuovo progetto con una struttura predefinita, che facilita la standardizzazione, la configurazione rapida e l’adesione alle best practice di sviluppo di AEM.

## Istanza di authoring

[Istanza di authoring](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[Creazione front-end](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)

Interfaccia utente per la creazione e la gestione dei moduli in AEM Forms.

## Blocco modulo adattivo
...
[Componenti core](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/introduction)
...
[Gestione della corrispondenza](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/cm-overview)
...
[Componente personalizzato](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/customize-adaptive-forms-core-components)
...
## XCI personalizzato (informazioni configurazione XML)

[XCI personalizzato (informazioni configurazione XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/administrator-help/configure-forms/specifying-xci-configuration-options)
...
[Integrazione dei dati](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/data-integration)
...
[Origini dati](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/configure-data-sources)
...
[Frammenti del documento](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/lists)
...
## Documento record (DoR)

[Documento record (DoR)](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/generate-document-of-record-for-non-xfa-based-adaptive-forms)
...
[Integrazione Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/form-data-model/data-integration)
...
[Revisione modulo](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-reviews-forms)

Funzione basata su flusso di lavoro che consente alle parti interessate di rivedere i moduli adattivi, aggiungere annotazioni e approvare modifiche prima della pubblicazione. Utilizza la casella in entrata di AEM e la gestione delle attività.
...
[Portale moduli](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/use-forms-portal/creating-form-portal-page)
...
## Front-end di invio e rappresentazione modulo

[Front-end di invio e rappresentazione modulo](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)

Interfaccia utente in AEM Forms che consente agli utenti di visualizzare e inviare moduli tramite un browser Web.

## Set di moduli

[Set di moduli](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/html5-forms/formset-in-aem-forms)
...
## Flusso di lavoro incentrato su Forms

[Flusso di lavoro incentrato su Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/workflows/aem-forms-workflow)
...
[Comunicazione interattiva](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/getting-started/interactive-communications-overview)
...
[Lettere](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/letters-correspondences/create-letter#create-a-letter-template)
...
## Metadati in AEM Forms

[Metadati in AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/manage-administer-aem-forms/manage-form-metadata)
...
[Istanza di pubblicazione](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/publish-process-aem-forms/publishing-unpublishing-forms)
...
[Editor di regole](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/rule-editor-core-components/rule-editor-core-components)
...
[Firme a mano](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/add-components-to-an-adaptive-form/signing-forms-using-scribble)
...
## Azione di invio in AEM Forms

[Azione di invio in AEM Forms](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/configuring-submit-actions)
...
[Modello](https://experienceleague.adobe.com/en/docs/experience-manager-core-components/using/adaptive-forms/sample-themes-templates-form-data-models-core-components)
...
[Livello web](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/install-aem-forms/aem-forms-architecture-deployment#architecture)
...
## XDP (pacchetto dati XML)

[XDP (pacchetto dati XML)](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/manage-administer-aem-forms/get-xdp-pdf-documents-aem)

Formato di file utilizzato in AEM Forms per la progettazione e la strutturazione dei moduli, che consente il rendering come PDF o HTML e al tempo stesso supporta il contenuto dinamico e l’interattività.
...
Tecnologia legacy per la creazione di PDF forms interattivi e dinamici. I moduli XFA offrono funzionalità avanzate, come regolazioni del layout dinamico, scripting e integrazione perfetta con i sistemi back-end.

## Schema XML o JSON

[Schema XML o JSON](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/forms/adaptive-forms-basic-authoring/creating-adaptive-form#create-an-adaptive-form-based-on-xml-or-json-schema)

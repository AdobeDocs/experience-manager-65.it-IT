...
| § 1194.21 Linee guida | Descrizione linea guida | Best practice Designer LiveCycle richieste per la conformità | Note |
|-----------|-----------------------|-----------------------------------------------------------|-------|
...
| g) | Le applicazioni non devono sostituire le selezioni del contrasto e del colore e altri attributi di visualizzazione selezionati dall’utente. | Nessuna tecnica Designer specifica per LiveCycle | Se possibile, utilizzate i colori di sistema predefiniti di base. |
...
| §11942 linea guida | Descrizione linea guida | Best practice Designer LiveCycle richieste per la conformità | Note |
|-----------|-----------------------|-----------------------------------------------------------|-------|
...
| Checkpoint | Descrizione checkpoint | Best practice Designer LiveCycle richieste per la conformità | Note |
|------------|------------------------|-----------------------------------------------------------|-------|

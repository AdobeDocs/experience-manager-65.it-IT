...
1. Nell’istanza di creazione di AEM Forms, andate a **Strumenti** ![](assets/hammer.png) > **Generale** > Browser **** di configurazione.
...
1. Passa a **Strumenti** ![](assets/hammer.png) > Servizi **** cloud > **Adobe Sign** e seleziona il contenitore di configurazione creato nel passaggio precedente.

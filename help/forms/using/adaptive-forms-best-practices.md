...
* Utilizzare le scelte rapide da tastiera per eseguire azioni rapide sui moduli. Consultate [Scelte Rapide Da Tastiera](/help/forms/using/keyboard-shortcuts.md)AEM Forms.
...
* I moduli adattivi forniscono una serie di API utilizzabili per comunicare con i moduli adattivi ed eseguire azioni su di essi. Alcune delle API chiave sono le seguenti. Per ulteriori informazioni, consultate [JavaScript Library API reference for Adaptive Forms](https://adobe.com/go/learn_aemforms_documentation_63).
...
È possibile sfruttare l&#39;esperienza con più firme di  Adobe Sign nei moduli adattivi. Durante la configurazione  Adobe Sign nei moduli adattivi, tenere presente quanto segue. Per informazioni dettagliate, vedere [Utilizzo  Adobe Sign in un modulo](/help/forms/using/working-with-adobe-sign.md)adattivo.
...
Per ulteriori informazioni, vedere [AEM plug-in Chrome - Modulo](https://adobe-consulting-services.github.io/acs-aem-tools/aem-chrome-plugin/adaptive-form/)adattivo.

Calvin SDK è un&#39;API di utilità per gli sviluppatori di Forms adattivi per testare l&#39;Forms adattivo. Calvin SDK è basato sul framework [di test di](https://docs.adobe.com/docs/en/aem/6-3/develop/ref/test-api/index.html)Hobbes.js. Potete utilizzare il framework per verificare quanto segue:
...
AEM fornisce flussi di lavoro di traduzione che è possibile utilizzare per localizzare i moduli adattivi. Per ulteriori informazioni, vedere [Utilizzo AEM flusso di lavoro di traduzione per localizzare i moduli](/help/forms/using/using-aem-translation-workflow-to-localize-adaptive-forms.md)adattivi.
...
* Memorizzare nella cache tutte le librerie client `/etc.clientlibs/fd` e tutte le librerie client personalizzate aggiuntive sul dispatcher AEM per aumentare la capacità di risposta e la sicurezza dei moduli pubblicati. For more information, see [Dispatcher](https://helpx.adobe.com/experience-manager/dispatcher/using/dispatcher.html).
...
* Abilitare l&#39;HTML tramite il modulo di compressione del server Web. Per ulteriori informazioni, vedere Ottimizzazione [delle prestazioni di  server](/help/forms/using/performance-tuning-aem-forms.md)AEM Forms.
...
* Le dimensioni dell&#39;heap devono essere pari ad almeno 8 GB. Per altre impostazioni, consultate Ottimizzazione [delle prestazioni di  server](/help/forms/using/performance-tuning-aem-forms.md)AEM Forms.

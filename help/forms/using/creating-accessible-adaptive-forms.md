---
title: Creare moduli adattivi accessibili
...
# Creare moduli adattivi accessibili{#creating-accessible-adaptive-forms}
...
### &#x200B;2. Fornire etichette appropriate per i controlli modulo {#provide-proper-labels-for-form-controls}
...
### &#x200B;3. Fornisci equivalenti di testo per le immagini {#provide-text-equivalents-for-images}
...
### &#x200B;5. Verificare che i controlli del modulo siano accessibili da tastiera {#ensure-that-form-controls-are-keyboard-accessible}

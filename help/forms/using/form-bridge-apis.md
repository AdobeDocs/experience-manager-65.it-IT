...
* **Input:**
   ...
   * **** configName: Nome della configurazione da ignorare
      ...
      * **** LoggingConfig: Consente all&#39;utente di ignorare il livello di registrazione, disabilitare la registrazione per una categoria o se visualizzare la console dei registri o inviare al server. La configurazione può essere sostituita come segue:

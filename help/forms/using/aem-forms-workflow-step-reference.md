...
* **** Informazioni inviate: I seguenti campi elencati di seguito fungono da percorsi di output per l&#39;attività:
   ...
   * **** Salva allegati utilizzando: Salvare gli allegati del modulo forniti in un&#39;attività. È possibile salvare gli allegati utilizzando un percorso relativo al payload o memorizzarlo in una variabile di array di tipi di dati Document.
...
* **Configurazione** di Adobe Sign Cloud: Scegliere una configurazione di Adobe Sign Cloud. Se non hai configurato Adobe Sign per AEM Forms, consulta [Integrazione di Adobe Sign con AEM Forms](../../forms/using/adobe-sign-integration-adaptive-forms.md).

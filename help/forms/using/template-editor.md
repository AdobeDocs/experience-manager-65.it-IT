...
seo-title: Modelli di modulo adattivi
...
seo-description: Creare modelli di modulo adattivo definendo la struttura di base e il contenuto iniziale del modulo utilizzando l’Editor modelli.
...
1. Nella sezione Scegli un tipo di modello , seleziona **Modello di modulo adattivo** e tocca **Avanti**.

1. Nella sezione Template Details (Dettagli modello), specifica un Titolo modello e tocca **Create** (Crea).
...
Per informazioni sull’editor dell’interfaccia touch, consulta [Introduzione alla creazione di moduli adattivi](../../forms/using/introduction-forms-authoring.md) .
...
Dopo aver creato e abilitato un modello, questo è disponibile in Forms Manager quando si crea un modulo adattivo. Per utilizzare un modello e creare un modulo adattivo, consultare [Creazione di un modulo adattivo](../../forms/using/creating-adaptive-form.md).
...
1. Individua e apri le impostazioni **Configurazione FormsManager** :

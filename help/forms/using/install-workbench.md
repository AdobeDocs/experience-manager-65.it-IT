...
* **Opzioni di rendering**: all&#39;interno della cache del modulo renderizzato, il contenuto della cache viene memorizzato separatamente per ogni set di opzioni di rendering univoche.

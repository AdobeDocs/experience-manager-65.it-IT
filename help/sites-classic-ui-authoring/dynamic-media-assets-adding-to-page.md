...
Aggiunta di [!UICONTROL Dynamic Media] o [!UICONTROL File multimediali interattivi] per aggiungere un componente a una pagina si intende come aggiungere un componente a una pagina. Il [!UICONTROL Dynamic Media] e [!UICONTROL File multimediali interattivi] I componenti sono descritti in dettaglio nelle sezioni seguenti.
...
1. Se non è disponibile alcun componente di Dynamic Media, selezionare il righello nella [!UICONTROL Barra laterale] per inserire **[!UICONTROL Progettazione]** modalità.
1. Seleziona **[!UICONTROL Modifica]** parsys.
1. Seleziona **[!UICONTROL Dynamic Media]** in modo da poter rendere disponibili i componenti Dynamic Media.
...
1. Torna a **[!UICONTROL Modifica]** facendo clic sull’icona della matita nella [!UICONTROL Barra laterale].
1. Trascina **[!UICONTROL Dynamic Media]** o **[!UICONTROL File multimediali interattivi]** componente da **[!UICONTROL Altro]** raggruppa nella barra laterale sulla pagina nella posizione desiderata.
...
[!UICONTROL Dynamic Media] e [!UICONTROL File multimediali interattivi] sono disponibili in [!UICONTROL Barra laterale] in **[!UICONTROL Dynamic Media]**. Utilizzi il **[!UICONTROL File multimediali interattivi]** componente per qualsiasi risorsa interattiva come video interattivo, immagini interattive o set carosello. Per tutti gli altri componenti di Dynamic Media, utilizza **[!UICONTROL Dynamic Media]** componente.
...
>[!NOTE]
>
>Quando si aggiunge [!UICONTROL Dynamic Media] componente, e **[!UICONTROL Impostazioni Dynamic Media]** è vuoto oppure non è possibile aggiungere correttamente una risorsa, verifica quanto segue:
>
...
Il [!UICONTROL Dynamic Media] Questo componente consente di aggiungere immagini dinamiche, inclusi set di immagini, set 360 gradi e set di file multimediali diversi. È possibile ingrandire, ridurre e, se applicabile, ruotare un&#39;immagine all&#39;interno di un set 360 gradi o selezionare un&#39;immagine da un altro tipo di set.
...
Puoi modificare le seguenti impostazioni di Dynamic Media facendo clic su **[!UICONTROL Modifica]** nel componente, quindi facendo clic su **[!UICONTROL Impostazioni Dynamic Media]** scheda.
...
Utilizza il **[!UICONTROL Dynamic Media]** per aggiungere video dinamici alle pagine web. Quando modifichi il componente, puoi scegliere di utilizzare un predefinito visualizzatore video predefinito per riprodurre il video sulla pagina.

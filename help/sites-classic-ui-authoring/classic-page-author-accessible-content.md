...
>
>Consulta le pagine seguenti per informazioni su AEM e WCAG 2.1:
>
...
* Foto illustrative:
   ...
   Queste sono immagini di persone, oggetti o luoghi. Think about the role of the photo in the page; an appropriate text equivalent is likely to be *Photo of[object ]*, but may be dependent on the surrounding text.
...
* **Utilizzare gli elenchi**: è possibile utilizzare l’HTML per specificare tre diversi tipi di elenchi:
   ...
   * The `<ul>` element is used for *unordered* lists (bulleted) lists. Le singole voci dell’elenco sono identificate dall’elemento `<li>`. 

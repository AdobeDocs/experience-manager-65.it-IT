...
Non è possibile utilizzare Dynamic Media nell’interfaccia utente classica. Consulta [Utilizzo di Dynamic Media](/help/assets/dynamic-media.md), che copre l’interfaccia touch.

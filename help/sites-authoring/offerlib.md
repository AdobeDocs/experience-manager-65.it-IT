...
Quando crei un marchio utilizzando la console Offerte, questa viene visualizzata anche nella [Console Attività](/help/sites-authoring/activitylib.md) dove puoi aggiungere e amministrare attività per il brand.
...
1. Digita un titolo per il brand come desideri che appaia nelle console Offerte e Attività. Facoltativamente, digita o seleziona uno o più tag da associare al brand.
...
1. Nella console Offerte, apri il percorso in cui desideri creare la cartella. Ad esempio, apri il brand per creare una cartella di livello superiore o un’altra cartella nella libreria.
...
Aggiungi un’offerta alla libreria di offerte di un brand in modo che possa essere aggiunta alle esperienze del brand. Quando aggiungi un’offerta, fornisci un titolo. Puoi anche associare l’offerta a uno o più tag per migliorare la ricercabilità.

Dopo aver creato l’offerta, puoi aprirla per creare il contenuto.

1. Nella console Offerte, apri la posizione in cui desideri creare l’offerta. Ad esempio, apri il brand per creare un’offerta di livello superiore o una cartella nella libreria.
1. Tocca o fai clic su **Crea** > **Crea cartella o offerta**.
...
Apri un’offerta e modifica il contenuto come desideri che appaia nelle esperienze che la utilizzano. Quando modifichi un’offerta utilizzata in una qualsiasi esperienza, le modifiche vengono visualizzate nelle esperienze.
...
Puoi eliminare un’offerta quando visualizzi il contenuto di una cartella in una libreria di offerte o i risultati della ricerca.

...
* [Modifica il modello](#editingtemplates) per definire i seguenti elementi:
   ...
   * [Struttura](#editingatemplatestructureauthor) : contenuto predefinito che non può essere modificato sulle pagine create con il modello.
   ...
   * [Layout](#editingatemplatelayoutauthor) - Per una serie di dispositivi.
...
1. Seleziona **Crea**. Viene visualizzata una conferma; seleziona **Apri** per iniziare a [modificare il modello](#editingatemplate) o **Fine** per tornare alla console dei modelli.
...
* [Abilitate il modello](#enablingatemplate) per renderlo disponibile per la creazione di pagine.
* [Consentite al modello](#allowingatemplate) di specificare i rami di contenuto in cui può essere utilizzato il modello.
...
È possibile definire il layout del modello per una serie di dispositivi. [Il layout](/help/sites-authoring/responsive-layout.md) reattivo per i modelli funziona come per l&#39;authoring delle pagine.

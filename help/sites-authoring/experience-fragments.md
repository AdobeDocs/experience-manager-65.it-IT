...
1. Specificate l&#39;espressione regolare per recuperare i modelli richiesti nel campo Modelli **** consentiti.
   ...
   ![Proprietà frammento esperienza - Modelli consentiti](/help/sites-authoring/assets/xf-folders-templates.png)

   >[!NOTE]
   Per ulteriori informazioni, consulta la sezione sui [modelli per frammenti esperienza](/help/sites-developing/experience-fragments.md#templates-for-experience-fragments).
...
1. Seleziona Frammenti esperienza da Navigazione globale.
...
1. Aggiungi la **Risorsa** e definisci le **Proprietà** come richiesto.
...
1. Il **blocco predefinito** viene visualizzato nella scheda e può essere selezionato nel sistema di paragrafo:
...
1. I dettagli vengono visualizzati in tutte le viste della console **Frammenti esperienza**, dove la **vista a elenco** comprende i dettagli di una [esportazione in Target](/help/sites-administering/experience-fragments-target.md):
...
1. Quando apri le **Proprietà** del frammento esperienza:
   ...
   Se **aprite le proprietà** durante la modifica di un frammento esperienza, vengono visualizzate le proprietà [di](/help/sites-authoring/editing-page-properties.md) pagina appropriate.

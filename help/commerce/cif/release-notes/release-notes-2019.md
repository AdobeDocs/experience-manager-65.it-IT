...
* È stato aggiunto il supporto per i pagamenti Braintree nella vetrina AEM Venia.
...
* La personalizzazione delle query GraphQL è stata semplificata. Questo consente agli sviluppatori di personalizzare i componenti core di CIF con meno codice.
...
* Tutti i componenti core di CIF compatibili con l&#39;autore sono stati migliorati per supportare [il sistema di stili di AEM](https://experienceleague.adobe.com/docs/experience-manager-65/authoring/siteandpage/style-system.html?lang=it). Sono stati forniti stili di esempio per il componente elenco prodotti.
...
* Associazione di più cataloghi per consentire agli autori di associare più cataloghi nella console del prodotto AEM. Gli autori possono inoltre modificare e visualizzare le proprietà di associazione del catalogo dopo aver creato l&#39;associazione.
...
| Archetipo CIF | 0.3.0 | [Note sulla versione](https://github.com/adobe/aem-cif-project-archetype/releases) |

### Novità {#what-is-new-august}

* L’incorporamento del connettore CIF in Archetipo CIF è facoltativo per fornire agli sviluppatori maggiore flessibilità.
...
* Funzione multi-store/sito per consentire l’utilizzo dei componenti core di CIF su più strutture di siti AEM e consentire all’implementazione client GraphQL sottostante di connettersi a diverse viste store/store di Adobe Commerce.
...
* Pulsante che consente agli autori di inserire in una pagina di AEM un collegamento a una pagina di AEM, una pagina dei dettagli del prodotto, una pagina dell’elenco dei prodotti o un collegamento esterno.

### Novità {#what-is-improved-august}

* La configurazione dello store di Adobe Commerce è stata spostata da OSGi alla console Prodotti AEM per rendere la configurazione dell’integrazione più semplice da creare.
...
| Archetipo CIF | 0.2.0 | [Note sulla versione](https://github.com/adobe/aem-cif-project-archetype/releases) |

### Novità {#what-is-new-july}

* Primo Archetipo CIF a fornire agli sviluppatori diverse opzioni di distribuzione: 1. Distribuire AEM Venia storefront 2. Distribuire lo scaffolding per un nuovo progetto 3. Utilizzare elementi CIF in un progetto esistente
...
* Elenco categorie in primo piano lato server per visualizzare un elenco di categorie in una pagina AEM.
...
* Vetrina AEM B2C con stile CSS Venia mobile-first, pagina di destinazione, navigazione dinamica del catalogo tramite pagine di prodotti e categorie, pagina di ricerca dei prodotti e funzionalità del carrello acquisti per avviare e accelerare i progetti di e-commerce.

* Connettore CIF e strumenti di authoring (console prodotti, selettore prodotti e selettore categorie) per consentire agli autori di creare esperienze in AEM con contenuti commerce.

* Prima versione dei componenti core di CIF compatibili con Adobe Commerce 2.3.1:

...
Controllate i file di configurazione sotto la cartella `crx-quickstart/install`. Se fosse necessaria una migrazione, queste verranno aggiornate per riflettere il repository di destinazione.

...
Ogni aggiornamento del repository crea una nuova revisione del contenuto. Di conseguenza, con ogni aggiornamento, le dimensioni dell&#39;archivio crescono. Le vecchie revisioni devono essere ripulite per liberare risorse su disco - questo è importante per evitare una crescita incontrollata del repository. Questa funzionalità di manutenzione è denominata Revision Cleanup (Pulizia delle revisioni). È disponibile come routine offline dal AEM 6.0.
...
>[!CAUTION]
>
>Utilizza una versione dello strumento Oak-run che ha un numero di versione (sia principale che secondario) corrispondente alla versione di base Oak dell&#39;installazione AEM. Ad esempio, se l’istanza di AEM ha Oak core versione 1.2.x, utilizza l’ultima versione di Oak-run tool 1.22.x.

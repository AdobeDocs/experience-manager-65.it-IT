...
| Forms | Aggiornamento single-hop da LiveCycle ES4 SP1 a Forms 6.5 su JEE non disponibile | Consulta [percorsi di aggiornamento disponibili](../forms/using/upgrade.md) nella documentazione di aggiornamento di AEM Forms. |
| Forms | Supporto del clustering basato su UPD rimosso da AEM Forms su JEE | È possibile utilizzare solo il clustering basato su TCP in AEM Forms su JEE. Se si aggiorna un server multicast UDP da una versione precedente a AEM 5.5 Forms su JEE, si eseguono configurazioni manuali per passare al clustering gemfire basato su TCP. Per istruzioni dettagliate, consulta [Aggiornamento a AEM 6.5 forms su JEE](../forms/using/upgrade-forms-jee.md) |

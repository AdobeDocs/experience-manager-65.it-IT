...
| Screens | Adobe non prevede di mantenere e aggiornare ulteriormente il bundle com.adobe.cq.screens.mq.activemq e le relative configurazioni utilizzati per la configurazione di 2Publishers. | L’Adobe consiglia ai clienti che richiedono ancora l’impostazione di 2Publishers di utilizzare l’approccio di bilanciamento del carico. |  |

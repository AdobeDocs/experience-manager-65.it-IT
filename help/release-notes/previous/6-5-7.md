...
* Nell&#39;editor dei predefiniti per visualizzatori [!UICONTROL 1&rbrace;, quando si modifica il predefinito &#x200B;]ImmaginePanoramica/ImmaginePanoramica_VR[!UICONTROL &#x200B; nel componente &#x200B;], l&#39;etichetta del modificatore `PanoramicView` non è disponibile (CQ-4302443).`PANORAMICVIEW_AUTOROTATE`

...
Di seguito è riportato l&#39;elenco delle correzioni fornite nella versione 6.5.7.0 di [!DNL Experience Manager].
...
* Nell&#39;editor dei predefiniti per visualizzatori [!UICONTROL 1}, quando si modifica il predefinito [!UICONTROL ImmaginePanoramica/ImmaginePanoramica_VR] nel componente `PanoramicView`, l&#39;etichetta del modificatore `PANORAMICVIEW_AUTOROTATE` non è disponibile (CQ-4302443).]

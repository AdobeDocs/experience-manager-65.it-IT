...
* [!DNL Experience Manager Sites] Il componente Dynamic Media Foundation ora consente di attivare o disattivare l’ottimizzazione per i dispositivi ad alta risoluzione quando si utilizza il predefinito per immagini reattivo o il ritaglio avanzato.
...
* [!UICONTROL Pubblica su Dynamic Media] non è disponibile all’interno di [!UICONTROL Pubblicazione rapida] opzioni in [!UICONTROL Proprietà] (CQ-4317199).
...
>Problemi noti relativi alla riproduzione di video in Dynamic Media *solo sull&#39;Experience Manager 6.5.9.0*:
...
* Impossibile salvare le proprietà della pagina con l’ereditarietà abilitata per i frammenti esperienza Cloud Services (NPR-36107).

---
title: '[!DNL Adobe Experience Manager] 6.5.8 Service Pack - Note sulla versione'
...
* Per le risorse caricate che vengono pubblicate automaticamente in DM, lo stato non mostra Pubblicato su AEM. Inoltre, la colonna di stato Dynamic Medie Publish non mostra lo stato di pubblicazione corretto (CQ-4306415).
...
* Contatta l&#39;Assistenza clienti di Adobe se riscontri problemi durante la modifica e la creazione di regole a catena in [!UICONTROL Folder Metadata Schema Forms Editor] e [!UICONTROL Metadata Schema Forms Editor] tramite la finestra di dialogo [!UICONTROL Define Rule]. Le regole già create e salvate funzionano come previsto.

...
Di seguito è riportato l&#39;elenco delle correzioni fornite nella versione [!DNL Experience Manager] di 6.5.8.0.
...
* Quando abiliti SSL per un’istanza di Experience Manager, il percorso contestuale viene rimosso (NPR-35477).
...
* Quando avvii un aggiornamento dell’istanza di AEM da AEM 6.3 a AEM 6.5, l’avvio dell’istanza di aggiornamento richiede più tempo (NPR-35323).
...
* Dopo l’aggiornamento ad AEM 6.5.7, le build iniziano a non riuscire. Il motivo è che una vecchia versione o nessun jackson-core è incorporato in uber-jar (GRANITE-33006).
...
* Nella scheda [!UICONTROL Da fare] dell&#39;area di lavoro di HTML vengono visualizzati i caratteri HTML (NPR-35298).

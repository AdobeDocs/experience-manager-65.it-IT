---
title: '[!DNL Adobe Experience Manager] 6.5.6 Service Pack - Note sulla versione'
...
* Le opzioni predefinite per `test` e `aiprocess` sono state aggiornate a `Thumbnail`, da `Rasterize` in precedenza in Dynamic Medie, per garantire che gli utenti debbano creare solo miniature e saltare l&#39;estrazione della pagina e delle parole chiave.
...
* Il flusso di lavoro Aggiorna risorse DAM viene attivato quando l&#39;utente scorre la pagina [!UICONTROL Archivio flussi di lavoro] nella scheda [!UICONTROL Flusso di lavoro] all&#39;interno di [!UICONTROL Strumenti] in [!DNL Adobe Experience Manager] configurato con Dynamic Medie Scene7 (CQ-4299727).
...
Per informazioni sugli aggiornamenti della protezione, vedere [Experience Manager di bollettini sulla protezione](https://helpx.adobe.com/security/products/experience-manager.html).

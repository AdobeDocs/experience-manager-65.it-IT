---
title: Note sulla versione di [!DNL Adobe Experience Manager] 6.5.12.0
...
| URL di download | [Distribuzione del software](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=/content/software-distribution/en/details.html/content/dam/aem/public/adobe/packages/cq650/servicepack/aem-service-pkg-6.5.12.0.zip) |
...
Di seguito è riportato l&#39;elenco delle correzioni fornite nella versione 6.5.12.0 di [!DNL Experience Manager].
...
* L’operazione di spostamento delle pagine su Experience Manager è lenta (NPR-37961).
...
* Il contenitore di layout nel modello di pagina di un’applicazione a pagina singola non è in grado di registrare le classi CSS personalizzate definite nell’informativa sui modelli durante l’esecuzione di pagine di applicazioni a pagina singola di React (NPR-37697).
...
* Dopo l&#39;aggiornamento alla versione 6.5.10.0, la pagina delle proprietà della risorsa riflette un messaggio di rendering di HTML non necessario (CQ-4336994).
...
* Le miniature PDF generate sono diverse dalla prima pagina del PDF effettivo. Mancano alcune parti dell&#39;immagine nella miniatura (CQ-4315554).
...
* Problemi relativi ai documenti di Office durante l&#39;utilizzo del servizio PDF Generator dopo l&#39;aggiornamento da AEM 6.5.7.0 Forms ad AEM 6.5.10.0 Forms (NPR-37758).
...
* Il salvataggio dei registri comporta un elevato utilizzo di CPU che richiede il riavvio del server (NPR-37868).
...
## Installare 6.5.12.0 {#install}

**Requisiti di installazione e ulteriori informazioni**

* Experience Manager 6.5.12.0 richiede Experience Manager 6.5. Per istruzioni dettagliate, consulta la [documentazione sull&#39;aggiornamento](/help/sites-deploying/upgrade.md).
...
* In una distribuzione con MongoDB e più istanze, installare Experience Manager 6.5.12.0 in una delle istanze di authoring utilizzando Gestione pacchetti.

>[!NOTE]
>
>Adobe sconsiglia di rimuovere o disinstallare il pacchetto 6.5.12.0 di [!DNL Adobe Experience Manager].
...
UberJar per Experience Manager 6.5.12.0 è disponibile nell&#39;[archivio centrale Maven](https://repo1.maven.org/maven2/com/adobe/aem/uber-jar/6.5.12/).
...
* Se utilizzi Frammenti di contenuto e GraphQL, è consigliabile installare i seguenti pacchetti sopra 6.5.12.0:
...
* [Elenco dei bundle OSGi inclusi in Experience Manager 6.5.12.0](/help/release-notes/assets/65120_bundles.txt)

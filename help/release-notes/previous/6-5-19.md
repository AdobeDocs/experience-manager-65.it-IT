...
* **[Miglioramenti all&#39;accessibilità in AEM Forms Designer](https://helpx.adobe.com/content/dam/help/it/experience-manager/6-5/forms/pdf/using-designer.pdf)**: AEM Forms Designer introduce i seguenti miglioramenti all&#39;accessibilità:

   * AEM Forms Designer ora supporta un sommario accessibile tramite i nuovi tag `<TOC>` e `<TOCI>`, consentendo agli autori di assegnare questi ruoli alle sottomaschere tramite la scheda Accessibilità. La funzione supporta strutture di sommario multilivello, voci con etichetta, riferimenti numerati e sottostrutture span, consentendo agli assistenti vocali di identificare e navigare correttamente nel contenuto del sommario.

   * AEM Forms Designer ora supporta la configurazione delle proprietà di accessibilità per le celle di tabella, tra cui Ambito, Estensione riga e Estensione colonna, consentendo agli assistenti vocali e ai dispositivi di assistenza di interpretare correttamente la struttura della tabella nei PDF generati. Gli autori possono impostare queste proprietà direttamente dalla finestra di dialogo Proprietà cella e verificarle nella visualizzazione Source XML. Le proprietà configurate vengono riflesse con precisione nell’output di PDF con tag e possono essere convalidate utilizzando l’Editor tabelle di Acrobat.
...
#### Editor di pagine{#sites-pageeditor-6519}
...
>[!IMPORTANT]
>
> Adobe consiglia di non rimuovere o disinstallare il pacchetto [!DNL Experience Manager] 6.5.19.0. Pertanto, prima di installare il pacchetto, è necessario creare un backup di `crx-repository` nel caso sia necessario eseguirne il rollback. <!-- UPDATE FOR EACH NEW RELEASE -->
...
>[!NOTE]
>
>Experience Manager 6.5.19.0 non supporta l&#39;installazione di Bootstrap. <!-- UPDATE FOR EACH NEW RELEASE -->
...
* [Elenco dei bundle OSGi inclusi in Experience Manager 6.5.19.0](/help/release-notes/assets/65190_bundles.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Elenco dei pacchetti di contenuti inclusi in Experience Manager 6.5.19.0](/help/release-notes/assets/65190_packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->

---
title: '''[!DNL Adobe Experience Manager] 6.5.10 note sulla versione del service pack'
...
* Quando si promuove un lancio, le modifiche apportate al lancio promosso vengono implementate due volte negli altri lanci. Se un utente promuove il doppio lancio, i contenuti raddoppiati vengono riportati nella pagina sorgente (NPR-36893).

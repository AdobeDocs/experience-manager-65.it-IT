...
* È ora possibile utilizzare [!DNL Dynamic Media] per configurare le impostazioni generali anziché passare attraverso l&#39;applicazione desktop [!DNL Dynamic Media Classic]. Consulta [Configurare le impostazioni generali di Dynamic Medie](/help/assets/dm-general-settings.md).

  ![Impostazioni generali DM](/help/assets/assets-dm/dm-general-settings.png)

* È ora possibile utilizzare [!DNL Dynamic Media] per configurare Installazione di Publish anziché passare attraverso l&#39;applicazione desktop [!DNL Dynamic Media Classic]. Vedere [Configurazione di Dynamic Medie Publish Setup](/help/assets/dm-publish-settings.md).
...
>[!NOTE]
>
>L&#39;Adobe non consiglia di rimuovere o disinstallare il pacchetto [!DNL Adobe Experience Manager] 6.5.11.0.

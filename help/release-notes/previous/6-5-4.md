...
* È ora possibile sincronizzare sottostrutture di contenuto selettivo con *Dynamic Medie - Modalità Scene7* invece di tutti gli elementi disponibili all’indirizzo `content/dam`.
...
* Generazione rappresentazione per risorse con ${extension} guasto (NPR-32294).
...
* La pagina dei dettagli delle risorse PDF non mostra i pulsanti di azione, ad eccezione dei pulsanti A raccolta e Aggiungi rappresentazione, nell’Experience Manager in esecuzione in modalità di esecuzione Dynamic Medie Scene7 (CQ-4286705).
...
* L’editor carosello non si apre in IE 11 in modalità ibrida Dynamic Medie Experience Manager (CQ-4255590). **Ad Adobe, Dynamic Medie - Clienti in modalità ibrida:** Adobe cesserà il supporto per Internet Explorer 11 in modalità Dynamic Medie - Ibrido dopo maggio 2022.

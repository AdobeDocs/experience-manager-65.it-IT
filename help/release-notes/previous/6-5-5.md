...
* Per ottenere l&#39;URL di pubblicazione per Dynamic Medie Scene7, è stato aggiunto un nuovo metodo `getRemoteAssetPublishURL` all&#39;interfaccia `com.day.cq.dam.api.s7dam.scene7.ImageUrlApi`.
...
* I nomi delle risorse vengono modificati in minuscolo quando si spostano le risorse da una cartella a un&#39;altra in [!DNL Adobe Experience Manager] che funziona in modalità di esecuzione Dynamic Medie Scene7 (NPR-32995).
...
* I predefiniti immagine non vengono pubblicati se la modalità di sincronizzazione [!UICONTROL Dynamic Medie] è disabilitata per impostazione predefinita, ad Experience Manager con Dynamic Medie Scene7 runmode (CQ-4294200).

...
Alcune delle caratteristiche e dei miglioramenti principali sono:

* **[Supporto per l&#39;accessibilità dell&#39;elenco in AEM Forms Designer](https://helpx.adobe.com/content/dam/help/it/experience-manager/6-5/forms/pdf/using-designer.pdf)**: AEM Forms Designer ora consente agli autori di creare strutture elenco accessibili assegnando ruoli Elenco, Voce elenco ed Etichetta elenco ai sottomascheri tramite la scheda Accesso facilitato. La funzionalità supporta elenchi semplici, numerati, puntati e nidificati, con generazione tag `<L>`, `<LI>`, `<Lbl>` e `<Lbody>` corretta per la compatibilità con gli assistenti vocali. Questo miglioramento garantisce che gli elenchi dei moduli siano conformi agli standard di accessibilità PDF/UA, migliorando la navigazione e la comprensione dei contenuti per gli utenti di tecnologie per l’accessibilità.
...
* È stata aggiunta la possibilità di specificare il testo del Reader per i collegamenti ipertestuali in Forms Designer.(NPR-36221)

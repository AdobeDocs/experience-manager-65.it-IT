...
* La proprietà `dam:size` non viene aggiornata dopo il writeback dell&#39;XMP. Ciò comporta la restituzione di informazioni non corrette dall&#39;API `/platform/path/to/asset.jpg;resource=metadata`. (ASSETS-17631)
...
* Nella pagina Impostazioni generali di Dynamic Medie viene visualizzato un messaggio di errore non tradotto `Failed to fetch data`. (ASSETS-15617)
...
* Quando si esegue l&#39;aggiornamento a AEM 6.5.14.0 e si utilizza il servizio importData per unire PDF con XML, si verifica l&#39;errore seguente: `Caused by: java.lang.NoSuchMethodError: com.adobe.xfa.form.FormModel.isXFABarcode(Lcom/adobe/xfa/Node;)Ljava/lang/Boolean`. (NPR-39807)
...
Dopo l’installazione del service pack del componente aggiuntivo Forms AEM 6.5.16.0, i clienti riscontravano i problemi elencati di seguito. Viene quindi rilasciata una versione aggiornata del Service Pack del componente aggiuntivo Forms [AEM 6.5.16.0 - 6.0.914](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html). L’Adobe consiglia di utilizzare il service pack aggiornato:
...
>[!IMPORTANT]
>
> L&#39;Adobe non consiglia di rimuovere o disinstallare il pacchetto [!DNL Experience Manager] 6.5.16.0. Pertanto, prima di installare il pacchetto, è necessario creare un backup di `crx-repository` nel caso sia necessario ripristinarlo. <!-- UPDATE FOR EACH NEW RELEASE -->
...
Per installare automaticamente [!DNL Experience Manager] 6.5.16.0.<!-- UPDATE FOR EACH NEW RELEASE --> è possibile utilizzare due metodi diversi
...
I clienti che utilizzano GraphQL devono installare il [Frammento di contenuto AEM con pacchetto indice GraphQL 1.0.5](https://experience.adobe.com/#/downloads/content/software-distribution/en/aem.html?package=%2Fcontent%2Fsoftware-distribution%2Fen%2Fdetails.html%2Fcontent%2Fdam%2Faem%2Fpublic%2Fadobe%2Fpackages%2Fcq650%2Ffeaturepack%2Fcfm-graphql-index-def-1.0.5.zip).
...
* Sulla piattaforma JBoss® 7.1.4, quando un utente installa il service pack AEM 6.5.16.0, la distribuzione di `adobe-livecycle-jboss.ear` non riesce.

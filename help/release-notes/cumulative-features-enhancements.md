...
Vedi anche [Note sulla versione più recente del Service Pack di Adobe Experience Manager 6.5](/help/release-notes/release-notes.md).
...
* AEM Forms Designer è ora disponibile in [Lingua spagnola](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html).
* Ora puoi utilizzare [OAuth2 per l&#39;autenticazione con i protocolli del server di posta Microsoft® Office 365 (SMTP e IMAP)](/help/forms/using/oauth2-support-for-mail-service.md).

...
description: Le azioni di gestione dei contenuti sono gli elementi costitutivi che consentono di creare e gestire i contenuti all’interno di un’applicazione. Per ulteriori informazioni, segui questa pagina.
contentOwner: User
...
Gli argomenti seguenti descrivono la creazione e la gestione di contenuti, ovvero articoli, banner e raccolte. Dopo aver appreso come creare e gestire il contenuto, puoi visualizzare altri argomenti, ad esempio il caricamento di risorse condivise, la pubblicazione/annullamento della pubblicazione dei contenuti e la visualizzazione in anteprima con Verifica preliminare.

...
audience: end-user
user-guide-title: Guida utente per dispositivi mobili AEM 6.5
...
+ Amministrazione dell&#39;app dei servizi on-demand {#administering}
   ...
   + [Panoramica sui modelli](model-management.md)
...
+ Authoring  Adobe PhoneGap Enterprise {#author-phonegap}
   ...
   + [Creazione di una nuova app  AEM Mobile tramite la creazione guidata](phonegap-create-new-app.md)
...
+ Sviluppo  Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [Gestori di app in dotazione](contentsync-app-handlers.md)
...
+ Amministrazione  Adobe PhoneGap Enterprise {#administering-phonegap}
   ...
   + [Configurare il Cloud Service  Mobile Services](configure-adobe-mobile-cloud-service.md)

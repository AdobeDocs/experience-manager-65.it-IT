...
+ Amministrazione dell&#39;app dei servizi on-demand {#administering}
   ...
   + [Configurazione di AEM Mobile](aem-mobile-setup.md)
...
+ Authoring di Adobe PhoneGap Enterprise {#author-phonegap}
   ...
   + [Creazione di una nuova app AEM Mobile tramite la procedura guidata Crea](phonegap-create-new-app.md)
...
+ Amministrazione di Adobe PhoneGap Enterprise {#administering-phonegap}
   ...
   + [Configurare il servizio cloud Adobe PhoneGap Build](configure-phonegap-build-cloud.md)

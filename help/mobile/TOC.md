...
+ Sviluppo di Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [Configurazione di Adobe Target Cloud Service](aem-mobile-configuring-cloud-service.md)
...
+ Amministrazione di Adobe PhoneGap Enterprise {#administering-phonegap}
   ...
   + [Configurare Adobe PhoneGap Build Cloud Service](configure-phonegap-build-cloud.md)

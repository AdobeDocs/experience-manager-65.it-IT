...
+ Sviluppo di app On-Demand Services {#developing}
...
+ Amministrazione dell&#39;app dei servizi on-demand {#administering}
   ...
   + [Anteprima con Preflight](aem-mobile-manage-ondemand-services.md)
...
+ Authoring di Adobe PhoneGap Enterprise {#author-phonegap}
   ...
   + [Modifica dei metadati delle app](phonegap-editmetadata.md)
   ...
   + [Creazione guidata nuova app AEM Mobile](phonegap-create-new-app.md)
   + [Creazione di applicazioni mobili](phonegap-authoring-apps.md)
   + [Gestisci porzione app](phonegap-app-details-tile.md)
...
+ Sviluppo di Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [Mobile con sincronizzazione dei contenuti](phonegap-contentsync.md)
   + [L&#39;anatomia di un&#39;app](phonegap-apps-arch.md)
   + [Sviluppo di app con PhoneGap CLI](phonegap-apps-pg-cli.md)
   + [Gestori di app integrati](contentsync-app-handlers.md)

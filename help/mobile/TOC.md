...
+ Introduction to AEM Mobile {#introduction}
   ...
   + [AEM Mobile - Prontezza GDPR](aem-mobile-gdpr-compliance.md)
...
+ Creazione di un&#39;app di servizi on-demand {#authoring}
   ...
   + [Pannello applicazione AEM Mobile](mobile-apps-ondemand-application-dashboard.md)
...
+ Amministrazione dell&#39;app dei servizi on-demand {#administering}
   ...
   + [Impostazione AEM Mobile](aem-mobile-setup.md)
...
+ Authoring di Adobe PhoneGap Enterprise {#author-phonegap}
   ...
   + [Personalizzazione del contenuto AEM Mobile](phonegap-aem-mobile-content-personalization.md)

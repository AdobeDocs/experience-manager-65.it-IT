...
**etc.designs.default e etc.designs.mobile** - Le prime due voci della configurazione sono evidenti. Poiché stai per includere diverse pagine mobili, devi disporre dei relativi file di progettazione sotto /etc/designs. E poiché non è richiesta alcuna elaborazione aggiuntiva, la copia è sufficiente.

...
1. Scegliete **Crea** per creare uno spazio. Immettete **Titolo**, **Nome** e **Descrizione** per lo spazio.
...
1. Scegli albero **di pubblicazione**
...
1. Fate clic su **Crea** per creare la cartella in uno spazio
...
1. Una volta creata, una copia lingua viene visualizzata nello spazio disponibile nelle **lingue originali**.
...
1. Scegliete il modello per l&#39;entità. Questo è il tipo di entità che si desidera creare. Fai clic su Avanti.
   ...
   >
   >Consultate [Creazione di un modello](/help/mobile/administer-mobile-apps.md)per creare un&#39;entità personalizzata.

1. Immettete un **Titolo**, **Nome**, **Descrizione** e **Tag** per l&#39;entità. Fai clic su **Crea**. 
...
1. Fate clic su **Elimina** dalla barra degli strumenti per rimuovere l&#39;entità specifica dallo spazio

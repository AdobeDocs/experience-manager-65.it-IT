...
1. (Facoltativo) Se utilizzate PhoneGap Build per compilare l&#39;applicazione, nella scheda Build selezionate la Configurazione da utilizzare.
...
### Caratteristiche comuni delle pagine - App mobile Geometrixx {#common-page-features-geometrixx-mobile-app}

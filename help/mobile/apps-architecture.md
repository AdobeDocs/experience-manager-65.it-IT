...
Per risolvere il problema, l&#39;applicazione PhoneGap utilizza il pattern SPA (Single Page App) in modo che l&#39;URI di base (escluso l&#39;hash) non cambi mai. Pertanto, ogni risorsa, modello o script a cui si fa riferimento **deve essere relativo alla pagina di primo livello.** La pagina di primo livello inizializza il routing e i controller di Angular in virtù di `*<name>*.angular-app-module.js` e `*<name>*.angular-app-controllers.js`. Questa pagina deve essere la più vicina alla radice dell&#39;archivio che *non *estende un sling:redirect.

...
description: Annulla validità della rete CDN (Content Delivery Network) memorizzata in cache consente di aggiornare rapidamente le risorse consegnate da Dynamic Media, invece di attendere la scadenza della cache.
...
**Per annullare la validità dei contenuti CDN memorizzati nella cache per le risorse Dynamic Media:**

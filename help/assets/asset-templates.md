...
## Creare un materiale promozionale {#creating-a-collateral}
...
1. In entrata [!DNL Experience Manager] clic interfaccia [!UICONTROL Risorse].

1. Tra le opzioni, scegli **[!UICONTROL Modelli]**.

   ![chlimage_1-101](assets/chlimage_1-306.png)

1. Clic **[!UICONTROL Crea]**, quindi scegliere il materiale promozionale da creare dal menu. Ad esempio, scegli **[!UICONTROL Brochure]**.
...
È possibile modificare un materiale promozionale subito dopo averlo creato. In alternativa, è possibile aprirlo da [!UICONTROL Modelli] pagina della risorsa.

1. Per aprire il materiale promozionale per la modifica, effettuare una delle seguenti operazioni:

   * Aprire il materiale promozionale (in questo caso la brochure) creato nel passaggio 7 di [Creare un materiale promozionale](/help/assets/asset-templates.md#creating-a-collateral).
   * Dalla pagina Modelli, individua la cartella in cui è stato creato il materiale promozionale, quindi fai clic su [!UICONTROL Modifica] azione rapida sulla miniatura di una garanzia.
   ...
   * Seleziona il materiale promozionale e fai clic su **[!UICONTROL Modifica]** dalla barra degli strumenti.
   ...
   Il mirino delle risorse e l’editor di testo vengono visualizzati a sinistra della pagina. L’editor di testo è aperto per impostazione predefinita.

   È possibile utilizzare l’editor di testo per modificare il testo da visualizzare nel campo di testo. È possibile modificare la dimensione, lo stile, il colore e il tipo di carattere a livello di tag.

   Utilizzando il Finder per le risorse, puoi sfogliare o cercare le immagini in [!DNL Experience Manager Assets] e sostituisci le immagini modificabili nel modello con immagini di tua scelta.

   ![chlimage_1-109](assets/chlimage_1-314.png)

   Gli elementi modificabili sono visualizzati a destra. Per rendere modificabile un campo in [!DNL Experience Manager Assets], il campo corrispondente nel modello deve essere taggato in [!DNL InDesign]. In altre parole, devono essere contrassegnate come modificabili in [!DNL InDesign].
...
1. Clic **[!UICONTROL Anteprima]** per visualizzare in anteprima le modifiche apportate al testo.

1. Per scambiare un&#39;immagine, fare clic su **[!UICONTROL Asset Finder]** ![chlimage_1-113](assets/chlimage_1-318.png).
...
1. Clic **[!UICONTROL Anteprima]** per visualizzare l&#39;anteprima dell&#39;immagine.
...
1. Clic **[!UICONTROL Anteprima]** sulla barra degli strumenti per visualizzare in anteprima tutte le modifiche. Clic **[!UICONTROL Fine]** per salvare le modifiche apportate al materiale promozionale.
...
1. Il materiale promozionale viene creato nella cartella iniziale. Per visualizzare le rappresentazioni, apri il materiale promozionale e scegli **[!UICONTROL Rappresentazioni]** dall&#39;elenco GlobalNav.

   ![chlimage_1-118](assets/chlimage_1-323.png)

1. Per scaricare il file PDF, fai clic sulla copia trasformata PDF dall’elenco delle copie trasformate. Apri il file PDF per rivedere il materiale promozionale.
...
1. Clic **[!UICONTROL Crea]** e la scelta **[!UICONTROL Unisci]** dal menu.

   ![chlimage_1-120](assets/chlimage_1-325.png)

1. Dalla sezione [!UICONTROL Unione modelli] pagina, fai clic su **[!UICONTROL Unisci]** ![aggiungere risorse](assets/do-not-localize/assets_add_icon.png).

1. Passare alla posizione del materiale promozionale che si desidera unire, fare clic sulle miniature del materiale promozionale che si desidera unire per selezionarle.
...
1. In **[!UICONTROL Anteprima e riordina]** , ridisporre i modelli se necessario e visualizzare in anteprima la selezione dei modelli da unire. Quindi, fai clic su **[!UICONTROL Successivo]** dalla barra degli strumenti.
...
1. Clic **[!UICONTROL Salva]** e quindi fare clic su **[!UICONTROL OK]** nella finestra di dialogo per chiudere la finestra. Il materiale promozionale di più pagine viene creato nella cartella iniziale.

   >[!NOTE]
   >
   >Non è possibile modificare un materiale promozionale unito in un secondo momento né utilizzarlo per creare altro materiale promozionale.

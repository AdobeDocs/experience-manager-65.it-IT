...
1. Aggiungi [Predefiniti visualizzatore set immagini](/help/assets/managing-viewer-presets.md), in base alle esigenze.

   Gli amministratori possono creare o modificare i predefiniti visualizzatore set di immagini. Per visualizzare il set di immagini con un predefinito visualizzatore, seleziona il set di immagini e, nel menu a discesa della barra a sinistra, seleziona **[!UICONTROL Visualizzatori]**.

   Accedi a **[!UICONTROL Strumenti]** > **[!UICONTROL Risorse]** > **[!UICONTROL Predefiniti visualizzatore]** se desideri creare o modificare i predefiniti visualizzatore.

1. (Facoltativo) [Visualizzare un set di immagini](/help/assets/image-sets.md#viewing-image-sets) create utilizzando predefiniti per set di batch.
1. [Anteprima set immagini](/help/assets/previewing-assets.md).

   Seleziona il set di immagini e puoi visualizzarlo in anteprima. Seleziona le icone delle miniature per esaminare il set di immagini nel visualizzatore selezionato. È possibile scegliere visualizzatori diversi da **[!UICONTROL Visualizzatori]** disponibile dal menu a discesa della barra a sinistra.
...
1. Nella pagina Editor set di immagini, in **[!UICONTROL Titolo]** immetti un nome per il set di immagini. Il nome viene visualizzato nel banner del set di immagini. È possibile inserire una descrizione.
...
1. Quando aggiungi risorse al set, queste vengono aggiunte automaticamente in ordine alfanumerico. Puoi riordinare o ordinare manualmente le risorse dopo averle aggiunte.
   ...
   Se desideri modificare una miniatura o un campione, seleziona la **+** **miniatura** accanto all&#39;immagine e individuare la miniatura o il campione desiderato. Dopo aver selezionato tutte le immagini, seleziona **[!UICONTROL Salva]**.
...
>[!NOTE]
>
>I set possono essere visualizzati tramite l’interfaccia utente, come descritto in [Modifica set di immagini](#editing-image-sets).
...
1. Effettua una delle seguenti operazioni:
   ...
   * Passa il puntatore del mouse su una risorsa set di immagini, seleziona **[!UICONTROL Seleziona]** (icona di spunta), quindi seleziona **[!UICONTROL Modifica]** sulla barra degli strumenti.
   * Seleziona una risorsa set di immagini, quindi seleziona **[!UICONTROL Modifica]** (icona della matita) sulla barra degli strumenti.
...
1. Per modificare le immagini nel set di immagini, effettuate una delle seguenti operazioni:
   ...
   * Per eliminare un intero set di immagini, passa al set di immagini, selezionalo e seleziona **[!UICONTROL Elimina]**.
   ...
   >[!NOTE]
   >
   >Per modificare le immagini di un set di immagini, vai al set e seleziona **[!UICONTROL Membri set]** nella barra a sinistra, quindi seleziona l’icona a forma di matita su una singola risorsa per aprire la finestra di modifica.

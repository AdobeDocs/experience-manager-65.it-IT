...
1. [Creare set di immagini.](#creating-image-sets)
   ...
   Potete anche creare i set di immagini automaticamente tramite i predefiniti per set di [batch](/help/assets/config-dms7.md#creating-batch-set-presets-to-auto-generate-image-sets-and-spin-sets).
   >[!IMPORTANT]
   >
...
1. [Pubblicare i set di immagini](/help/assets/publishing-dynamicmedia-assets.md)
   ...
   La pubblicazione di un set di immagini attiva la stringa URL e incorpora. Inoltre, dovete [pubblicare qualsiasi predefinito](/help/assets/managing-viewer-presets.md) per visualizzatori personalizzato creato. I predefiniti per visualizzatori forniti sono già stati pubblicati.
...
1. [Collegare gli URL all’applicazione](/help/assets/linking-urls-to-yourwebapplication.md) Web o [incorporare il visualizzatore](/help/assets/embed-code.md)video o immagini.
   ...
   Consultate [Collegamento di un set di immagini a una pagina](/help/assets/linking-urls-to-yourwebapplication.md) Web e [Incorporamento di un visualizzatore](/help/assets/embed-code.md)video o immagini.
...
In caso di problemi durante la creazione di set, consultate Immagini e set in [Risoluzione di problemi relativi a file multimediali dinamici - modalità](/help/assets/troubleshoot-dms7.md#images-and-sets)Scene7.
...
>[!NOTE]
>
>Potete anche creare i set di immagini automaticamente tramite i predefiniti per set di [batch](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets).
...
Potete creare i set di immagini nell’interfaccia utente o automaticamente utilizzando i predefiniti per set di [batch](/help/assets/config-dms7.md#creating%20batch%20set%20presets%20to%20auto-generate%20image%20sets%20and%20spin%20sets).

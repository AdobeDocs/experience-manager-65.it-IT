...
* Il flusso di lavoro può verificare se una notifica di copyright su una risorsa consente o meno la distribuzione. Di conseguenza, il sistema invia la risorsa a un server o all’altro.

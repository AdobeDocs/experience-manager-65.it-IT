---
title: Utilizzo dei frammenti di contenuto
seo-title: Utilizzo dei frammenti di contenuto
...
# Utilizzo dei frammenti di contenuto{#working-with-content-fragments}

I frammenti di contenuto di Adobe Experience Manager (AEM) consentono di progettare, creare, curare e [pubblicare contenuti](/help/sites-authoring/content-fragments.md)indipendenti dalla pagina. Consentono di preparare i contenuti pronti per l’uso in più posizioni/su più canali.

I frammenti di contenuto possono essere consegnati anche in formato JSON, utilizzando le funzionalità di esportazione JSON dei componenti core di AEM. Questo modulo di consegna:
...
* [Gestione dei frammenti](/help/assets/content-fragments-managing.md) di contenuto: creazione dei frammenti di contenuto; quindi modifica, pubblicazione e riferimento
* [Modelli](/help/assets/content-fragments-models.md) di frammenti di contenuto - attivazione, creazione e definizione dei modelli
* [Variazioni - Creazione di contenuti](/help/assets/content-fragments-variations.md) di frammento - Creazione di contenuti di frammento e creazione di varianti del contenuto principale
* [Markdown](/help/assets/content-fragments-markdown.md) - uso della sintassi di marketing per il frammento
* [Utilizzo di contenuto](/help/assets/content-fragments-assoc-content.md) associato - aggiunta di contenuto associato
* [Metadati - Proprietà](/help/assets/content-fragments-metadata.md) frammento - visualizzazione e modifica delle proprietà del frammento

>[!NOTE]
>
>Queste pagine devono essere lette insieme all’authoring delle [pagine con frammenti](/help/sites-authoring/content-fragments.md)di contenuto.
...
* Creazione di pool di contenuti per diversi canali.
...
Questi frammenti di contenuto possono essere assemblati per fornire esperienze su diversi canali.
...
* Frammenti contenenti contenuto strutturatoQuesti si basano su un modello [di frammento di](/help/assets/content-fragments-models.md)contenuto, che preimposta una struttura per il frammento risultante.
...
* Utilizzato nell’editor [pagina tramite il componente](/help/sites-authoring/content-fragments.md) Frammento di contenuto (componente di riferimento):
...
* Sono privi di layout o di design (in modalità RTF è possibile formattare del testo).
...
* **Inserire una risorsa** in un frammento (frammenti multimediali diversi)
   ...
   * Per ulteriori informazioni, vedere [Inserimento di risorse nel frammento](/help/assets/content-fragments-variations.md#inserting-assets-into-your-fragment) nell’Editor frammento.
   >[!NOTE]
   >
...
* **Contenuto associato**
   ...
   * Per ulteriori informazioni, consulta Contenuto [](/help/assets/content-fragments-assoc-content.md) associato.

* Risorse disponibili dal browser **** Risorse dell’editor pagina
   ...
   * Per ulteriori informazioni, consulta Browser [](/help/sites-authoring/author-environment-tools.md#assets-browser) risorse.
...
* **Elementi frammento**
   ...
   * Per frammenti semplici:
      ...
      * Gli elementi sono definiti nel modello di frammento (non è possibile definirli durante la creazione del frammento, vedere Modelli [di frammento di](/help/sites-developing/content-fragment-templates.md)contenuto).
...
* **Paragrafi frammento**
   ...
   * Nelle modalità [Rich Text](/help/assets/content-fragments-variations.md#rich-text) e [Markdown](/help/assets/content-fragments-variations.md#markdown) , un paragrafo può essere formattato come intestazione, nel qual caso il paragrafo e il paragrafo seguente appartengono insieme come un’unica unità.
...
* **Risorse inserite in un frammento (frammenti di file multimediali diversi)**
   ...
   * Può essere formattato quando un [frammento viene utilizzato/a cui viene fatto riferimento in una pagina](/help/sites-authoring/content-fragments.md).
   ...
   * È possibile aggiungere, eliminare o spostare solo all’interno di un frammento utilizzando il formato [RTF nell’editor](/help/assets/content-fragments-variations.md#inserting-assets-into-your-fragment)frammento.
   ...
   * Sono allegati al testo precedente (paragrafo).
   ...
   >[!NOTE]
   >
   >Quando si utilizza un frammento in una pagina è inoltre possibile aggiungere risorse come contenuto [](/help/sites-authoring/content-fragments.md#using-associated-content) aggiuntivo (intermedio); utilizzando Contenuto associato o risorse dal browser Risorse.
...
* **Contenuto associato**
   ...
   * Le risorse sono [associate ai frammenti tramite raccolte](/help/assets/content-fragments-assoc-content.md); le raccolte associate consentono all&#39;autore di decidere quali risorse utilizzare per la creazione della pagina.

      * Le raccolte possono essere associate ai frammenti tramite modelli, contenuti predefiniti o autori durante l&#39;authoring dei frammenti.
   ...
   * Facoltativamente è possibile aggiungere il frammento stesso a una raccolta per facilitare il tracciamento.


* **Metadati frammento**

   * Utilizzate gli schemi [di metadati](/help/assets/metadata.md)Risorse.
...
* **Principale**
   ...
   * Master è accessibile nell&#39;editor frammento in **[Variazioni](/help/assets/content-fragments-variations.md)**.
...
* **Varianti**
   ...
   * Le varianti possono essere [sincronizzate](/help/assets/content-fragments-variations.md#synchronizing-with-master) con Master se il contenuto Master è stato aggiornato.
   * Può essere [sintetizzato](/help/assets/content-fragments-variations.md#summarizing-text) per troncare rapidamente il testo fino a una lunghezza predefinita.
   * Disponibile nella scheda [Variazioni](/help/assets/content-fragments-variations.md) dell&#39;Editor frammento.
...
* È disponibile nell’Editor [pagina quando si utilizzano i frammenti](/help/sites-authoring/content-fragments.md)di contenuto.
* Il contenuto [aggiuntivo viene aggiunto all’interno del flusso di un frammento](/help/sites-authoring/content-fragments.md#adding-in-between-content) una volta utilizzato/a cui è stato fatto riferimento in una pagina.
...
* **Modello contenuto**
   ...
   * Vengono [abilitati e quindi creati utilizzando Strumenti](/help/assets/content-fragments-models.md).
   * Obbligatorio per [creare un frammento](/help/assets/content-fragments-managing.md#creating-content-fragments)strutturato.
...
* **Modello frammento**
   ...
   * Obbligatorio per [creare un frammento](/help/assets/content-fragments-managing.md#creating-content-fragments)semplice.
   * Generalmente [sviluppato durante l&#39;attuazione](/help/sites-developing/content-fragment-templates.md)del progetto; impossibile creare durante la creazione.

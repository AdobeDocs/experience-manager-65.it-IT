...
Per creare una copia per lingua, attiva uno dei seguenti flussi di lavoro di copia per lingua disponibili nella barra Riferimenti nella sezione [!DNL Experience Manager] interfaccia utente.

* **Creare e tradurre**: In questo flusso di lavoro, le risorse da tradurre vengono copiate nella directory principale della lingua in cui desideri tradurre. Inoltre, a seconda delle opzioni selezionate, viene creato un progetto di traduzione per le risorse nella console Progetti . A seconda delle impostazioni, il progetto di traduzione può essere avviato manualmente o può essere eseguito automaticamente non appena viene creato il progetto di traduzione.

* **Aggiorna copie in lingua**: Esegui questo flusso di lavoro per tradurre un gruppo aggiuntivo di risorse e includerlo in una copia per lingua per una specifica impostazione internazionale. In questo caso, le risorse tradotte vengono aggiunte alla cartella di destinazione che contiene già risorse tradotte in precedenza.
...
1. Apri **[!UICONTROL Riferimenti]** riquadro e fai clic su **[!UICONTROL Copie per lingua]** sotto **[!UICONTROL Copie]**.

   ![Copie per lingua](assets/translation-language-copies.png)

1. Fai clic su **[!UICONTROL Crea e traduci]**. Da **[!UICONTROL Lingue di destinazione]** selezionare la lingua per la quale si desidera creare una struttura di cartelle.
...
1. Fare clic sulla struttura dall&#39;elenco, quindi fare clic su **[!UICONTROL Mostra in Assets]** per passare alla struttura delle cartelle nella lingua di destinazione.
...
1. In [!DNL Assets] interfaccia utente, selezionare la cartella di origine per la quale si desidera creare una copia in lingua.
1. Apri **[!UICONTROL Riferimenti]** riquadro e fai clic su **[!UICONTROL Copie per lingua]** sotto **[!UICONTROL Copie]**.
...
1. Passa a [!DNL Assets] e aprire l&#39;interfaccia utente [!UICONTROL Proprietà] per ciascuna delle risorse tradotte per visualizzare i metadati tradotti.
...
1. In [!DNL Assets] Nell’interfaccia utente, passa alla cartella di origine contenente risorse non tradotte.
...
1. Fai clic su **[!UICONTROL Copie per lingua]** sotto **[!UICONTROL Copie]**. Viene visualizzato un elenco delle copie di traduzione disponibili.
1. Fai clic su **[!UICONTROL Crea e traduci]** in basso.
...
1. Per avviare la traduzione delle risorse, fai clic sulla freccia **[!UICONTROL Processo di traduzione]** piastrelle e seleziona **[!UICONTROL Inizio]** dall&#39;elenco.
...
1. Al termine della traduzione, lo stato diventa Pronto per la revisione. Passa a [!DNL Assets] e apri la pagina Proprietà per ciascuna risorsa tradotta per visualizzare i metadati tradotti.
...
1. Da [!DNL Assets] Nell’interfaccia utente, seleziona la cartella di origine in cui è stata aggiunta una risorsa.
1. Apri **[!UICONTROL Riferimenti]** e fai clic su **[!UICONTROL Copie per lingua]** sotto **[!UICONTROL Copie]** per visualizzare l’elenco delle copie per lingua.
...
1. Fai clic su **[!UICONTROL Aggiorna copie in lingua]** in basso.

1. Da **[!UICONTROL Progetto]** elenco, scegli **[!UICONTROL Crea un nuovo progetto di traduzione]**.

1. Nel campo **[!UICONTROL Titolo progetto]**, inserisci un titolo.

1. Fai clic su **[!UICONTROL Inizio]**.
1. Passa alla console Progetti . La cartella di traduzione viene copiata nella console Progetti .
...
1. Passa a [!DNL Assets] e apri la pagina Proprietà per ciascuna risorsa tradotta per visualizzare i metadati tradotti.
...
1. Da [!DNL Assets] Nell’interfaccia utente, seleziona la cartella di origine in cui è stata aggiunta una cartella di risorse.
1. Apri **[!UICONTROL Riquadro Riferimenti]** e fai clic su **[!UICONTROL Copie per lingua]** sotto **[!UICONTROL Copie]** per visualizzare l’elenco delle copie per lingua.
...
1. Fai clic sulla cartella principale di origine in **[!UICONTROL Copie per lingua]** per il quale hai già creato una copia per lingua, quindi fai clic su **[!UICONTROL Mostra in Assets]** per aprire la cartella in [!DNL Experience Manager Assets].

   ![chlimage_1-99](assets/chlimage_1-99.png)

1. Da [!DNL Assets] seleziona una risorsa già tradotta e fai clic su **[!UICONTROL Modifica]** dalla barra degli strumenti per aprire la risorsa in modalità di modifica.
...
1. Fai clic sull&#39;ellissi nella parte inferiore della **[!UICONTROL Processo di traduzione]** piastrelle. Dall’elenco delle risorse nel **[!UICONTROL Processo di traduzione]** è possibile visualizzare chiaramente la posizione temporanea in cui è memorizzata la versione tradotta della risorsa.

   ![chlimage_1-101](assets/chlimage_1-101.png)

1. Seleziona la casella di controllo accanto a **[!UICONTROL Titolo]**.
1. Dalla barra degli strumenti, fai clic su **[!UICONTROL Accetta traduzione]** ![accettare la traduzione](assets/do-not-localize/thumb-up.png) quindi fai clic su **[!UICONTROL Accetta]** nella finestra di dialogo per sovrascrivere la risorsa tradotta nella cartella di destinazione con la versione tradotta della risorsa modificata.
   ...
   Fai clic su **[!UICONTROL Rifiuta traduzione]** ![rifiutare la traduzione](assets/do-not-localize/thumb-down.png) per mantenere la versione tradotta originariamente nella directory principale delle impostazioni internazionali di destinazione e rifiutare la versione modificata.

1. Per visualizzare i metadati tradotti, passa alla sezione [!DNL Assets] e apri la [!UICONTROL Proprietà] per ciascuna delle risorse tradotte.

## Suggerimenti e limitazioni {#tips-limitations}

* Se si avvia un flusso di lavoro di traduzione per risorse complesse, ad esempio PDF e [!DNL Adobe InDesign] i file, le relative risorse secondarie o rappresentazioni (se presenti) non vengono inviati per la traduzione.

...
>[!NOTE]
>
>Prima di usare i video in Contenuti multimediali dinamici, accertatevi che l’amministratore AEM abbia già attivato e configurato Cloud Services Contenuti multimediali dinamici in modalità Dynamic Media - Scene7 o Dynamic Media - Hybrid.
>
>* Consultate [Configuring Dynamic Media Cloud Services](/help/assets/config-dms7.md#configuring-dynamic-media-cloud-services) in Configuring Dynamic Media - Scene7 mode and [Troubleshooting Dynamic Media - Scene7 mode.](/help/assets/troubleshoot-dms7.md)
   >
   >
* Consultate [Configurazione di Cloud Services di contenuti multimediali dinamici](/help/assets/config-dynamic.md#configuring-dynamic-media-cloud-services) in Configurazione di contenuti multimediali dinamici - Modalità ibrida.

>



1. **Caricate i** video per contenuti multimediali dinamici effettuando le seguenti operazioni:

   * Create un profilo di codifica video personalizzato. Oppure, potete semplicemente utilizzare il profilo _Codifica video adattiva_ predefinito fornito con i file multimediali dinamici.
   ...
   * Associate il profilo di elaborazione video a una o più cartelle in cui intendete caricare i video sorgente principali.
      ...
      * Ulteriori informazioni sulle [Best practice per l&#39;organizzazione delle risorse digitali per l&#39;utilizzo dei profili di elaborazione](/help/assets/organize-assets.md).
...
1. **Per gestire i** video per contenuti multimediali dinamici, effettuate una delle seguenti operazioni:

   * Organizzare, sfogliare ed effettuare ricerche nelle risorse video

      * [Organizzazione delle ](/help/assets/organize-assets.md)
risorse digitaliUlteriori informazioni sulle  [procedure ottimali per l’organizzazione delle risorse digitali per l’utilizzo dei profili di elaborazione](organize-assets.md)
   ...
   * Revisione, approvazione e annotazione di video e mantenimento del controllo completo della versione
      ...
      * [Aggiunta di annotazioni ](managing-video-assets.md#annotate-video-assets) ai video o  [Annotazione delle risorse](manage-assets.md#annotating)

      * [Creazione di una versione](manage-assets.md#asset-versioning)
      * [Applicazione di flussi di lavoro alle risorse o ](assets-workflow.md) vedere  [Avvio di un flusso di lavoro su una risorsa](manage-assets.md#starting-a-workflow-on-an-asset)
...
1. **Pubblicate i** video per contenuti multimediali dinamici effettuando una delle seguenti operazioni:
...
## Utilizzo di video in elementi multimediali dinamici {#working-with-video-in-dynamic-media}
...
* **[!UICONTROL Codifica]**  bitrate costante (CBR) - Durante la codifica CBR, il bitrate o il numero di bit al secondo viene mantenuto invariato durante l&#39;intero processo di codifica. La codifica CBR persiste quando la velocità dati impostata viene impostata sull’intero video. Inoltre, la codifica CBR non ottimizza i file multimediali per la qualità, ma consente di risparmiare spazio di archiviazione.
Usate CBR se il video contiene un livello di movimento simile per l’intero video. CBR è utilizzato soprattutto per lo streaming di contenuti video. Consultate anche [Utilizzo di parametri di codifica video personalizzati](/help/assets/video-profiles.md#using-custom-added-video-encoding-parameters).
...
Se bypassate il profilo di elaborazione video e pubblicate direttamente su YouTube, significa semplicemente che la risorsa video in AEM risorsa potrebbe non ottenere una miniatura visualizzabile. Questo significa anche che se eseguite in modalità di esecuzione Dynamic Media o dynamicmedia_scene7, i video non codificati non funzioneranno con nessuno dei tipi di risorse Contenuti multimediali dinamici.
...
Per pubblicare contenuti su YouTube, è necessario un account Google. Se avete un account GMAIL allora avete già un account Google; se non avete un account Google, potete facilmente crearne uno. L’account è necessario perché sono necessarie le credenziali per pubblicare le risorse video su YouTube. Se avete già creato un account, saltate questa attività e passate direttamente a [Creazione di un canale YouTube](#creating-a-youtube-channel).
...
1. Nella pagina Google Cloud, nell’angolo superiore destro, fai clic su **[!UICONTROL Console.]**
   ...
   Se necessario, potrebbe essere necessario **[!UICONTROL Accedere]** utilizzando le credenziali account Google per visualizzare l&#39;opzione **[!UICONTROL Console]**.
...
1. Nella finestra di dialogo Selezionare un progetto, toccare **[!UICONTROL Nuovo progetto.]**
...
1. Effettuate una delle seguenti operazioni:
   ...
   * Nel dashboard del progetto, nella scheda Guida introduttiva, toccate **[!UICONTROL Esplora e abilita le API.]**
...
1. Nella pagina di YouTube Data API v3, toccate **[!UICONTROL Abilita.]**
...
1. Nella pagina **[!UICONTROL Aggiungi credenziali al progetto]**, procedere come segue:

   * Da **[!UICONTROL Quale API state utilizzando?]** dall&#39;elenco a discesa, selezionate  **[!UICONTROL YouTube Data API v3.]**

   * Da **[!UICONTROL Da dove chiamerete l&#39;API?]** elenco a discesa, selezionate Server  **[!UICONTROL Web (ad esempio, node.js, Tomcat)]**

   * Da **[!UICONTROL Quali dati accederai?]** dall&#39;elenco a discesa, toccate Dati  **[!UICONTROL utente.]**
...
1. Sotto l&#39;intestazione **[!UICONTROL Origini Javascript autorizzate]**, nel campo di testo, immettere il percorso seguente, sostituendo il proprio dominio e numero di porta nel percorso, quindi premere **[!UICONTROL Invio]** per aggiungere il percorso all&#39;elenco:
...
1. Sotto l&#39;intestazione **[!UICONTROL URI di reindirizzamento autorizzati]**, nel campo di testo, immettere il percorso seguente, sostituendo il proprio dominio e il numero di porta nel percorso, quindi premere **[!UICONTROL Invio]** per aggiungere il percorso all&#39;elenco:
...
1. Fare clic su **[!UICONTROL Crea ID client OAuth.]**
...
1. Sotto l&#39;intestazione **[!UICONTROL Nome prodotto visualizzato agli utenti]**, nel campo di testo, immettere il contenuto che si desidera visualizzare nella schermata di consenso.
...
Per pubblicare i video su YouTube è necessario disporre di uno o più canali. Se avete già creato un canale YouTube, potete saltare questa attività e passare a [Aggiunta di tag per la pubblicazione](/help/assets/video.md#adding-tags-for-publishing).
...
1. Nell&#39;angolo superiore destro della pagina di YouTube, fare clic sull&#39;immagine del profilo (può anche apparire come una lettera all&#39;interno di un cerchio colorato in tinta unita), quindi fare clic su **[!UICONTROL Impostazioni di YouTube]** (icona circolare dell&#39;ingranaggio).
1. Nella pagina Panoramica, sotto l&#39;intestazione Funzioni aggiuntive, fare clic su **[!UICONTROL Visualizza tutti i canali o creare un nuovo canale.]**
1. Nella pagina Canali, fare clic su **[!UICONTROL Crea un nuovo canale.]**
1. Nella pagina Account marchio, nel campo Nome account marchio, immettete un nome commerciale o un altro nome di canale scelto per la pubblicazione delle risorse video, quindi fate clic su **[!UICONTROL Crea.]**
...
Dopo aver attivato l&#39;agente di replica di pubblicazione di YouTube, per verificare la connessione all&#39;account Google Cloud, toccate **[!UICONTROL Test Connection.]** Una scheda del browser visualizza i risultati della connessione. Se avete aggiunto Canali di YouTube, un elenco di tali canali viene visualizzato come parte del test.

1. Nell&#39;angolo superiore sinistro del AEM, fare clic sul logo AEM, quindi nella barra a sinistra fare clic su **[!UICONTROL Strumenti]** > **[!UICONTROL Distribuzione]** > **[!UICONTROL Replica]** > **[!UICONTROL Agenti sull&#39;autore.]**
1. Nella pagina Agenti di authoring, fate clic su **[!UICONTROL Pubblicazione su YouTube (youtube).]**
...
* Per configurare YouTube in AEM 6.4 o versione successiva, vedere [Configurazione di YouTube in AEM 6.4 e versioni successive](#setting-up-youtube-in-aem-and-later).
...
1. Toccare **[!UICONTROL global]** (non selezionarlo).

1. Nell&#39;angolo superiore destro della pagina globale, toccare **[!UICONTROL Crea.]**
...
1. Utilizzando un editor di testo semplice, aprite il file JSON scaricato e salvato in precedenza nell&#39;attività [Configuring Google Cloud settings](/help/assets/video.md#configuring-google-cloud-settings).
...
1. Toccare **[!UICONTROL Aggiungi canale.]**
1. Nel campo Nome canale, immettere il nome del canale creato nell&#39;attività **[!UICONTROL Aggiunta di uno o più canali a YouTube]** precedente.

   Se necessario, potete aggiungere una descrizione.

1. Toccare **[!UICONTROL Aggiungi.]**
...
1. Toccare **[!UICONTROL Consenti.]**

   Ora verranno impostati i tag per la pubblicazione.

1. **[!UICONTROL Impostazione dei tag per la pubblicazione]**  - Nella pagina Cloud Services > YouTube, toccate l’icona a forma di matita per modificare l’elenco dei tag da usare.
...
1. Al termine dell&#39;aggiunta dei tag desiderati, toccare **[!UICONTROL Salva.]**

   Ora potete pubblicare i video sul vostro canale YouTube.

#### Configurazione di YouTube in AEM prima del 6.4 {#setting-up-youtube-in-aem-before}
...
1. Sotto l&#39;intestazione Servizi di terze parti, sotto YouTube, toccare **[!UICONTROL Configura ora.]**
...
1. Nella finestra di dialogo Impostazioni account di YouTube, immetti l’ID progetto Google nel campo **[!UICONTROL Nome applicazione]**.
   ...
   L&#39;ID progetto è stato specificato al momento della configurazione iniziale delle [impostazioni di Google Cloud](/help/assets/video.md#configuring-google-cloud-settings) precedenti.
...
1. In Pubblicazione su YouTube, fate clic su **[!UICONTROL Privacy su YouTube.]**
1. Sul lato destro della pagina, nella scheda **[!UICONTROL Impostazioni]**, effettuare le seguenti operazioni:
...
1. Nella pagina Profili metadati, accanto all&#39;angolo superiore destro della pagina, fare clic su **[!UICONTROL Crea.]**
...
1. Aggiungete i valori di Pubblicazione su YouTube copiati al profilo effettuando le seguenti operazioni:
   ...
   * Sul lato destro della pagina, fare clic sulla scheda **[!UICONTROL Crea modulo]**.
   * (Facoltativo) Trascinare a sinistra il componente etichettato **[!UICONTROL Intestazione sezione]** e rilasciarlo nell&#39;area del modulo.
   * (Facoltativo) Fare clic su **[!UICONTROL Etichetta campo]** per selezionare il componente.
   ...
   * Fate clic sulla scheda **[!UICONTROL Crea modulo]**, quindi trascinate il componente con l&#39;etichetta **[!UICONTROL Multi Value Text]** e rilasciatelo sotto l&#39;intestazione **[!UICONTROL Pubblicazione su YouTube]** appena creata.
...
1. Aggiungete i valori di privacy di YouTube copiati al profilo effettuando le seguenti operazioni:
   ...
   * Fare clic sulla scheda **[!UICONTROL Crea modulo]**, quindi trascinare il componente con l&#39;etichetta **[!UICONTROL Testo con più valori]** e rilasciarlo sotto l&#39;intestazione **[!UICONTROL Privacy su YouTube]** appena creata.

   * Fare clic su **[!UICONTROL Etichetta campo]** per selezionare il componente.
   * Sul lato destro della pagina, nella scheda Impostazioni, incollate i valori di Pubblicazione su YouTube (valore Etichetta campo e Mappa su valore proprietà) precedentemente copiati nei rispettivi campi del modulo. Incolla il valore di Scelte nel campo Valore predefinito.

1. Nell&#39;angolo superiore destro della pagina, fare clic su **[!UICONTROL Salva.]**
...
>[!NOTE]
>
>In modalità Dynamic Media - Scene7, la pubblicazione immediata non viene automaticamente pubblicata su YouTube. Quando è impostata la modalità Dynamic Media - Scene7, è possibile scegliere tra due opzioni di pubblicazione: **[!UICONTROL Immediatamente]** o **[!UICONTROL Al momento dell&#39;attivazione.]**
>
...
1. Nell&#39;angolo superiore destro della pagina delle proprietà del video, fare clic su **[!UICONTROL Salva e chiudi.]**
1. Sulla barra degli strumenti, fare clic su **[!UICONTROL Pubblicazione rapida.]**

   Vedere anche [Utilizzo della gestione della pubblicazione con  AEM Sites](https://docs.adobe.com/content/help/en/experience-manager-learn/sites/page-authoring/publication-management-feature-video-use.html).
...
1. Andate alla risorsa video *YouTube published* di cui desiderate copiare l&#39;URL, quindi selezionatela.
...
1. Sulla barra degli strumenti, fate clic su **[!UICONTROL Gestisci pubblicazione.]** Potrebbe essere necessario toccare l&#39;icona dei tre punti (. . . sulla barra degli strumenti per visualizzare **[!UICONTROL Gestisci pubblicazione.]**
1. Nella pagina Gestisci pubblicazione, toccate **[!UICONTROL Annulla pubblicazione.]**
1. Nell&#39;angolo superiore destro della pagina, toccare **[!UICONTROL Avanti.]**
1. Nell&#39;angolo superiore destro della pagina, toccare **[!UICONTROL Annulla pubblicazione.]**
...
1. Visualizzare l’avanzamento nei dettagli della risorsa. Quando tocchi o fai clic su una risorsa, apri il menu a discesa e seleziona **[!UICONTROL Timeline.]** Per restringere il campo alle attività del flusso di lavoro come la codifica o la pubblicazione su YouTube, selezionate  **[!UICONTROL Flussi di lavoro.]**
...
1. Per i flussi di lavoro in corso, vedi l’opzione Istanze flusso di lavoro accedendo a **[!UICONTROL Strumenti]** > **[!UICONTROL Flusso]** di lavoro > **[!UICONTROL Istanze.]**
   ...
   Selezionare l&#39;istanza e toccare o fare clic su **[!UICONTROL Apri cronologia.]**

   ![chlimage_1-434](assets/chlimage_1-434.png)

   Nell’area Istanze flusso di lavoro potete inoltre sospendere, terminare o rinominare i flussi di lavoro. Per ulteriori informazioni, vedere [Gestione dei flussi di lavoro](/help/sites-administering/workflows-administering.md).
...
1. Potete ricevere notifiche e-mail relative a processi di workflow interrotti o non riusciti. Queste notifiche e-mail possono essere configurate da un amministratore. Vedere [Configurazione delle notifiche e-mail](#configuring-e-mail-notifications).
...
* Per i processi di codifica, potete accedere alla pagina di configurazione per tutte AEM notifiche e-mail del flusso di lavoro, all&#39;indirizzo **[!UICONTROL Strumenti]** > **[!UICONTROL Operazioni]** > **[!UICONTROL Console Web]** e cercare il servizio di notifica e-mail per i flussi di lavoro di **[!UICONTROL Day CQ.]** Consultate  [Configurazione delle notifiche e-mail in AEM](/help/sites-administering/notification.md). È possibile selezionare o deselezionare le caselle di controllo per **[!UICONTROL Notifica su Interrompi]** o **[!UICONTROL Notifica su Completa]** di conseguenza.

* Per i processi di pubblicazione su YouTube, effettuate le seguenti operazioni:

1. In AEM, toccare **[!UICONTROL Strumenti]** > **[!UICONTROL Workflow]** > **[!UICONTROL Modelli.]**
1. Nella pagina Modelli flusso di lavoro, selezionare **[!UICONTROL Pubblica su YouTube]**, quindi toccare **[!UICONTROL Modifica]** sulla barra degli strumenti.
1. Nell&#39;angolo superiore destro della pagina del flusso di lavoro Pubblica su YouTube, toccate **[!UICONTROL Modifica.]**
...
1. Sulla barra degli strumenti in linea, toccate l&#39;icona Configurazione (chiave inglese). Fare clic sulla scheda **[!UICONTROL Argomenti]**.
...
1. È possibile selezionare o deselezionare le seguenti caselle di controllo:
   ...
   * Completamento pubblicazione - include informazioni su canali e URL
   ...
   >[!NOTE]
   >
   >Questi messaggi e-mail sono specifici di YouTube e si aggiungono alle notifiche e-mail generiche per i flussi di lavoro. Di conseguenza, potete ricevere due set di notifiche e-mail: la notifica generica disponibile nel **[!UICONTROL Day CQ Workflow Notification Service]** e una specifica per YouTube a seconda delle impostazioni di configurazione.

1. Al termine, nell&#39;angolo superiore destro della finestra di dialogo toccate l&#39;icona **[!UICONTROL Fine]** (segno di spunta).
1. Nella pagina del flusso di lavoro Pubblica su YouTube, nell&#39;angolo superiore destro, toccate **[!UICONTROL Sincronizza.]**
...
Vedere anche [Configurazione di Cloud Services di contenuti multimediali dinamici](/help/assets/config-dynamic.md).
...
1. Nell&#39;angolo superiore sinistro della pagina della risorsa, selezionate **[!UICONTROL Visualizzatori dall&#39;elenco a discesa.]**
...
1. Usate un’applicazione o un servizio di terze parti per creare il file di sottotitoli o sottotitoli video.
   ...
   Nel campo **[!UICONTROL Immettere l&#39;URL del file video]**, incollare l&#39;URL copiato del file video e quindi fare clic su **[!UICONTROL Carica]**. Consulta la sezione [Ottenere l’URL per una risorsa](/help/assets/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset) per conoscere l’URL del file video stesso, che potrai incollare nel campo **[!UICONTROL Enter URL of video file (Inserisci URL del file video).]** A quel punto, Internet Explorer, Chrome o Safari possono riprodurre il video in modalità nativa.
...
1. Andate alla risorsa video *pubblicata* che desiderate associare al file di sottotitoli che avete caricato.
   ...
   Vedere [Pubblicazione delle risorse.](/help/assets/publishing-dynamicmedia-assets.md)
   ...
   <table>
     <tbody>
      <tr>
       ...
       <li>Dal menu a discesa, quindi fare clic o toccare <strong>Visualizzatori</strong>.</li>
       ...
       <li>Nella barra a sinistra, nella parte inferiore, fare clic su <strong>URL</strong>.</li>
      ...
      <tr>
       ...
       <li>Dal menu a discesa, quindi fare clic o toccare <strong>Visualizzatori</strong>.</li>
       <li>Nella barra a sinistra, toccate o fate clic sul nome del predefinito per visualizzatori video. L’anteprima del video viene aperta in una pagina separata.</li>
       <li>Nella barra a sinistra, nella parte inferiore, fare clic su <strong>Incorpora</strong>.</li>
...
## Informazioni sulle miniature video in Contenuti multimediali dinamici - Modalità Scene7 {#about-video-thumbnails-in-dynamic-media-scene-mode}
...
Vedere anche [Le miniature video in Dynamic Media - Hybrid mode](#about-video-thumbnails-in-dynamic-media-hybrid-mode).

### Aggiunta di una miniatura video personalizzata {#adding-a-custom-video-thumbnail}

Questi passaggi si applicano solo agli elementi multimediali dinamici in esecuzione in modalità &quot;Dynamicmedia_Scene7&quot;.
...
1. Nella modalità di selezione delle risorse, toccate la risorsa video da **[!UICONTROL Visualizzazione elenco]** o da **[!UICONTROL Visualizzazione a schede]**.
1. Sulla barra degli strumenti, toccate l&#39;icona **[!UICONTROL Proprietà]** (un cerchio contenente un &quot;i&quot;).
...
1. Nella pagina Modifica miniatura, effettuate una delle seguenti operazioni:
   ...
   * Per usare un fotogramma del video come nuova miniatura:
      ...
      * Sulla barra degli strumenti, toccare **[!UICONTROL Seleziona fotogramma dal video.]**
   ...
   * Per usare una risorsa immagine come nuova miniatura:
      ...
      * Sulla barra degli strumenti, toccare **[!UICONTROL Seleziona miniatura da risorse.]**
...
1. Nella pagina Modifica miniatura, toccare **[!UICONTROL Salva modifica.]**
1. Nella pagina Proprietà del video, nell&#39;angolo superiore destro, toccate **[!UICONTROL Salva e chiudi.]**
...
Vedere anche [Le miniature video in Contenuti multimediali dinamici - Modalità Scene7](/help/assets/video.md#about-video-thumbnails-in-dynamic-media-scene-mode).

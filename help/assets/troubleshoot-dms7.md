...
* La creazione di una versione non è supportata in Contenuti multimediali dinamici - Distribuzione in modalità Scene7. La nuova versione sostituirà la risorsa esistente in fase di distribuzione.

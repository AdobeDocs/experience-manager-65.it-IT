...
Nel documento seguente viene descritta la risoluzione dei problemi per Dynamic Medie che esegue la modalità di esecuzione **dynamicmedia_scene7**.
...
* Tutti i Cumulative Fix Pack (CFP) di Adobe Experience Manager 6.4 sono stati installati *prima* dei Feature Pack di Dynamic Medie disponibili.
...
* Passa all&#39;interfaccia utente Cloud Service e verifica che l&#39;account con provisioning sia visualizzato in **[!UICONTROL Configurazioni disponibili]**.
...
Per confermare la corretta sincronizzazione della risorsa da CRXDE Lite Experience Manager a Dynamic Medie, puoi rivedere le seguenti proprietà della risorsa:
  ...
  <tr>
   ...
   <td>
    <ol>
     ...
     <li>Ricaricare il video, verificare che il flusso di lavoro Codifica video Dynamic Medie non sia in esecuzione.<br /> </li>
...
1. Seleziona tutti i predefiniti visualizzatore, quindi seleziona **Publish**.
...
1. Passa alla cartella `<sync-folder>/_CSS/_OOTB` all&#39;interno della cartella di sincronizzazione di Dynamic Medie (ad esempio, `/content/dam/_CSS/_OOTB`).
...
1. Ricreare una configurazione di [Dynamic Medie in Cloud Service](/help/assets/config-dms7.md#configuring-dynamic-media-cloud-services).

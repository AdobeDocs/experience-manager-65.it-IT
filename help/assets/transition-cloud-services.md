...
1. Da [!DNL Assets] interfaccia utente, selezionare la cartella a cui si desidera applicare i servizi di traduzione.
...
1. Fai clic sul pulsante [!DNL Experience Manager] e naviga verso **[!UICONTROL Strumenti]** > **[!UICONTROL Distribuzione]** > **[!UICONTROL Cloud Services]**.
1. Nella pagina **[!UICONTROL Cloud Services]**, individua il connettore installato in **[!UICONTROL Servizi di terze parti]**.

   ![chlimage_1-218](assets/chlimage_1-218.png)

1. Fai clic sul pulsante **[!UICONTROL Configura ora]** per aprire **[!UICONTROL Crea configurazione]** finestra di dialogo.

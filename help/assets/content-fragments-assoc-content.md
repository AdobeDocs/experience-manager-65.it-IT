...
Per creare l&#39;associazione, dovete prima [aggiungere le risorse multimediali a una raccolta](/help/assets/managing-collections-touch-ui.md#adding-assets-to-a-collection). Una volta completata questa operazione, potete:

1. Aprire il frammento e selezionare Contenuto **** associato dal pannello laterale.

   ![chlimage_1-207](assets/chlimage_1-207.png)

1. Selezionate **Associa contenuto** o **Associa raccolta** (a seconda dei casi, a seconda che siano già state associate o meno raccolte).

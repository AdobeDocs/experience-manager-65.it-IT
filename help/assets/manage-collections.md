...
Una raccolta è un insieme di risorse all&#39;interno di [!DNL Adobe Experience Manager Assets]. Utilizzate le raccolte per condividere le risorse tra gli utenti. Il set può essere una raccolta statica o una raccolta dinamica basata sui risultati di ricerca.
...
Per aprire le **[!UICONTROL Raccolte]**, nell&#39;interfaccia [!DNL Experience Manager] passare a **[!UICONTROL Risorse]** > **[!UICONTROL Raccolte]**.
...
1. Fare clic su **[!UICONTROL Crea]**, quindi fare clic su **[!UICONTROL OK]** per chiudere la finestra di dialogo. Una raccolta con il titolo e le proprietà specificati viene aperta nella console Raccolte.
   ...
   Per aggiungere risorse alla raccolta, passate all&#39;interfaccia utente [!DNL Assets]. Per informazioni dettagliate, consultate [Aggiungere risorse a una raccolta](#adding-assets-to-a-collection).

### Creazione di raccolte tramite dropzone {#create-collections-using-dropzone}

Potete trascinare le risorse dall&#39;interfaccia utente [!DNL Assets] a una raccolta. Potete anche creare una copia di una raccolta e trascinarvi le risorse.

1. Dall&#39;interfaccia utente [!DNL Assets], selezionate le risorse da aggiungere a una raccolta.
...
1. Nella pagina **[!UICONTROL Aggiungi alla raccolta]**, fare clic su **[!UICONTROL Crea raccolta]** dalla barra degli strumenti.

   Se desiderate aggiungere le risorse a una raccolta esistente, selezionatela dalla pagina e fate clic su **[!UICONTROL Aggiungi]**. Per impostazione predefinita, è selezionata la raccolta aggiornata più di recente.
...
1. Fate clic su **[!UICONTROL Continue]** per creare la raccolta.
...
1. Fare clic su **[!UICONTROL Salva raccolta avanzata]**.
...
1. Fate clic su **[!UICONTROL Salva]** per creare la raccolta avanzata, quindi chiudete la finestra di messaggio per completare il processo.
   ...
   L&#39;etichetta dell&#39;opzione **[!UICONTROL Crea selezione intelligente]** diventa **[!UICONTROL Modifica selezione avanzata]**. Per modificare le impostazioni della raccolta avanzata, seleziona **[!UICONTROL File]** dall’elenco **[!UICONTROL File e cartelle]**. Fare clic sull&#39;opzione **[!UICONTROL Modifica selezione intelligente]** ![modifica raccolta avanzata](assets/do-not-localize/edit-smart-collection.png).
...
1. Nell&#39;interfaccia utente delle [!DNL A]risorse, selezionate la risorsa e fate clic su **[!UICONTROL Alla raccolta]** ![aggiungi alla raccolta](assets/do-not-localize/add-to-collection.png) dalla barra degli strumenti.
...
1. Dall&#39;elenco **[!UICONTROL File e cartelle]**, selezionare **[!UICONTROL File]**.
1. Modificate uno o più filtri, a seconda delle necessità. Fare clic su **[!UICONTROL Edit Smart Collection]**.

   Potete anche modificare il nome della raccolta dinamica.

   ![edit_smart_collectiondialog](assets/edit_smart_collectiondialog.png)

1. Fai clic su **[!UICONTROL Salva]**. Viene visualizzata la finestra di dialogo **[!UICONTROL Edit Smart Collection]**.
1. Fate clic su **[!UICONTROL Sovrascrivi]** per sostituire la raccolta avanzata originale con la raccolta modificata. In alternativa, selezionare **[!UICONTROL Salva con nome]** per salvare separatamente la raccolta modificata.
1. Nella finestra di dialogo di conferma, fare clic su **[!UICONTROL Salva]** per completare il processo.
...
1. Modificate i metadati in base alle esigenze. Per salvare le modifiche, fare clic su **[!UICONTROL Salva e chiudi]** nella barra degli strumenti.
...
1. Per aggiungere i nuovi metadati ai metadati esistenti, selezionate **[!UICONTROL Aggiungi modalità]**. Se non selezioni questa opzione, i nuovi metadati sostituiranno quelli già esistenti nei campi. Fare clic su **[!UICONTROL Invia]**.
...
1. Selezionate una raccolta e fate clic su **[!UICONTROL Impostazioni]** nella barra degli strumenti. In alternativa, utilizzate l&#39;azione rapida **[!UICONTROL Settings]** (Impostazioni) dalla miniatura della raccolta.
...
1. Nella finestra di dialogo, fare clic su **[!UICONTROL Elimina]** per confermare l&#39;eliminazione.

   >[!NOTE]
   >
   >È inoltre possibile eliminare le raccolte avanzate eliminando le ricerche salvate [a](#saved-searches).
...
1. Dalla barra degli strumenti, fare clic su **[!UICONTROL Scarica]**.
1. Nella finestra di dialogo **[!UICONTROL Scarica]**, fare clic su **[!UICONTROL Scarica]**. Se desiderate scaricare i rendering delle risorse all&#39;interno della raccolta, selezionate **[!UICONTROL Rappresentazioni]**. Selezionate l&#39;opzione **[!UICONTROL E-mail]** per inviare una notifica e-mail al proprietario della raccolta.
...
La modifica delle ricerche salvate equivale alla modifica delle raccolte avanzate. Per informazioni dettagliate, consultate [modificare una raccolta avanzata](#editing-a-smart-collection).
...
1. Nella finestra di dialogo, fare clic su **[!UICONTROL Elimina]** per eliminare la ricerca salvata.
...
1. Aprire **[!UICONTROL Risorse]** > **[!UICONTROL Raccolte]**. Per eseguire un flusso di lavoro su una raccolta specifica, selezionatelo.
1. Aprire la barra laterale **[!UICONTROL Timeline]**. Fare clic su ![freccia su](assets/do-not-localize/chevron-up-icon.png) e fare clic su **[!UICONTROL Avvia flusso di lavoro]**.
...
1. Inserite un titolo per il flusso di lavoro e fate clic su **[!UICONTROL Start]**.
1. Nella finestra di dialogo, fare clic su **[!UICONTROL Procedi]**. Il flusso di lavoro elabora tutte le risorse nella raccolta selezionata.

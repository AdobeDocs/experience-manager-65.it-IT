...
Gli elementi multimediali dinamici dispongono già di un profilo di codifica video adattiva predefinito. Le impostazioni incluse in questo profilo out-of-the-box sono ottimizzate per offrire ai clienti la migliore esperienza di visualizzazione possibile. Quando codificate i video principali utilizzando il profilo di codifica video adattiva, durante la riproduzione il lettore video regola automaticamente la qualità del flusso video in base alla velocità di connessione Internet dei clienti. È noto come streaming adattivo.
...
Consultate [Best practice per la codifica](/help/assets/video.md#best-practices-for-encoding-videos)video.

Consultate anche [Best practice per l’organizzazione delle risorse digitali per l’utilizzo dei profili](/help/assets/organize-assets.md)di elaborazione.

>[!NOTE]
>
>Per generare i metadati di un video e le miniature delle immagini video associate, il video stesso deve seguire il processo di codifica in Contenuti multimediali dinamici. In AEM, il flusso di lavoro Codifica video **[!UICONTROL per contenuti multimediali]** dinamici codifica i video se avete attivato i contenuti multimediali dinamici e impostato i servizi cloud per video. Questo flusso di lavoro acquisisce la cronologia del processo del flusso di lavoro e le informazioni di errore. Consultate [Monitoraggio della codifica video e Stato](/help/assets/video.md#monitoring-video-encoding-and-youtube-publishing-progress)della pubblicazione su YouTube. Se avete attivato i contenuti multimediali dinamici e impostato i servizi cloud per video, il flusso di lavoro di codifica video **[!UICONTROL per file multimediali]** dinamici ha effetto automaticamente al momento del caricamento di un video. (Se non utilizzate contenuti multimediali dinamici, ha effetto il flusso di lavoro Aggiorna risorsa **** DAM.)
>
...
Al termine, il profilo video viene applicato a una cartella o più cartelle. See [Applying a video profile to folders.](#applying-a-video-profile-to-folders)

Per definire parametri di elaborazione avanzati per altri tipi di risorse, consulta [Configurazione dell’elaborazione](/help/assets/config-dms7.md#configuring-asset-processing)delle risorse.

Consultate anche [Profili per l’elaborazione di metadati, immagini e video](processing-profiles.md).
...
La dimensione massima del file video supportato per il ritaglio avanzato è la seguente:

* Durata di cinque minuti.
* 30 fotogrammi al secondo (FPS).
* Dimensioni file 300 MB.

Adobe Sensei è attualmente limitato a 9000 fotogrammi. Cioè, cinque minuti a 30 fps. Se il video ha un valore FPS superiore, la durata video massima supportata diminuisce. Ad esempio, un video a 60 fps deve avere una durata di due minuti e mezzo per essere supportato da Adobe Sensai e dallo smart crop.
...
Potete attivare o disattivare il ritaglio video avanzato nel profilo video utilizzando il cursore all’estrema destra di **[!UICONTROL Smart Crop Ratio]** (Proporzioni ritaglio avanzate) nell’interfaccia utente.
...
1. Toccate il logo AEM e selezionate **[!UICONTROL Strumenti]** > **[!UICONTROL Risorse]** > Profili **[!UICONTROL video]**.
...
1. Effettua una delle operazioni seguenti:
   ...
   * Nel campo **[!UICONTROL Larghezza]** , immettere **[!UICONTROL auto]**. Nel campo **[!UICONTROL Altezza]** , inserite un valore in pixel.
...
1. (Facoltativo) Per aggiungere video smart crop ai video a cui verrà applicato questo profilo, effettuate le seguenti operazioni:
   * Nella pagina Modifica profilo video, toccate **[!UICONTROL Aggiungi nuovo]** a destra dell’intestazione Rapporto di ritaglio avanzato.
   * Nel campo Nome, digitate un nome per il rapporto di ritaglio che vi consentirà di identificarlo facilmente.
   * Dall’elenco a discesa **[!UICONTROL Rapporto]** ritaglio, selezionate il rapporto da usare.
...
1. Nell’angolo superiore destro della pagina, toccate **[!UICONTROL Salva]** di nuovo per salvare il profilo.
...
1. Effettua le seguenti operazioni:
   ...
   * Nel campo **[!UICONTROL Altezza]** , inserite un valore in pixel.
Per visualizzare le dimensioni del video, toccate l’icona delle informazioni Altezza per aprire la pagina Calcolatore **** dimensioni. Utilizzate la pagina **[!UICONTROL Calcolatore]** dimensioni per impostare ulteriormente la dimensione video (casella blu) come desiderate. Al termine, nell’angolo superiore destro della finestra di dialogo toccate **[!UICONTROL X]**.
...
1. Nell’angolo superiore destro della pagina, toccate **[!UICONTROL Salva]** per salvare il profilo.
...
1. Toccate il logo AEM, quindi selezionate **[!UICONTROL Strumenti]** > **[!UICONTROL Generale]** > **[!UICONTROL CRXDE Lite]**.
1. Dalla pagina CRXDE Lite, nel pannello Esplora risorse a sinistra, andate a:

   `/conf/global/settings/dam/dm/presets/video/*name_of_video_encoding_profile_to_edit`

1. Nel pannello in basso a destra della pagina, dalla scheda Proprietà, specificate il **[!UICONTROL Nome]**, il **[!UICONTROL Tipo]** e il **[!UICONTROL Valore]** del parametro da utilizzare.
...
1. Come procedura ottimale, accertatevi che la casella di controllo **[!UICONTROL Codifica per lo streaming]** adattivo sia selezionata.
Toccate l’icona delle informazioni per una descrizione dello streaming adattivo. (Se state modificando un profilo video progressivo, non selezionate questa casella di controllo.)
1. Nell’intestazione Predefiniti codifica video, potete aggiungere, modificare o eliminare predefiniti di codifica video che compongono il profilo.
   ...
   Toccate l&#39;icona delle informazioni accanto a ciascuna opzione nelle schede **[!UICONTROL Base]** e **[!UICONTROL Avanzate]** per ottenere descrizioni aggiuntive o impostazioni consigliate in base al codec del formato video selezionato.
...
1. Come procedura ottimale, accertatevi che la casella di controllo **[!UICONTROL Codifica per lo streaming]** adattivo sia selezionata. Toccate l’icona delle informazioni per una descrizione dello streaming adattivo. (Se copiate un profilo video progressivo, non selezionate la casella di controllo).
...
Potete applicare profili video a cartelle specifiche o globalmente a tutte le risorse.
...
Potete applicare un profilo video a una cartella direttamente dal menu **[!UICONTROL Strumenti]** o, se siete nella cartella, dalle **[!UICONTROL Proprietà]**. Questa sezione descrive come applicare i profili video alle cartelle in entrambi i modi.
...
1. Toccate **[!UICONTROL Applica profilo alle cartelle]** e selezionate la cartella o più cartelle da usare per ricevere le risorse appena caricate, quindi toccate **[!UICONTROL Applica]**. Le cartelle a cui è già stato assegnato un profilo sono indicate dalla visualizzazione del nome del profilo direttamente sotto il nome della cartella in visualizzazione **[!UICONTROL a schede]**.
...
1. Selezionate la scheda Profili **** video, selezionate il profilo dal menu a discesa, quindi fate clic su **[!UICONTROL Salva e chiudi]**. Le cartelle a cui è già stato assegnato un profilo sono indicate dalla visualizzazione del nome del profilo direttamente sotto il nome della cartella.
...
Potete rimuovere un profilo video da una cartella dal menu **[!UICONTROL Strumenti]** o, se siete nella cartella, dalle impostazioni **[!UICONTROL delle]** cartelle. Questa sezione descrive come rimuovere i profili video dalle cartelle in entrambi i modi.
...
1. Toccate **[!UICONTROL Rimuovi profilo dalle cartelle]** e selezionate la cartella o più cartelle da cui desiderate rimuovere il profilo e toccate **[!UICONTROL Rimuovi]**.
...
1. Selezionate la scheda Profili **** video e selezionate **[!UICONTROL Nessuno]** dal menu a discesa, quindi fate clic su **[!UICONTROL Salva e chiudi]**. Le cartelle a cui è già stato assegnato un profilo sono indicate dalla visualizzazione del nome del profilo direttamente sotto il nome della cartella.

---
title: Profili immagine per file multimediali dinamici
...
# Profili immagine per file multimediali dinamici {#image-profiles}
...
>[!NOTE]
>
>Smart Crop è disponibile solo in modalità Contenuti multimediali dinamici - Scene7.
...
Usate la maschera **** di contrasto per regolare con precisione un effetto filtro di nitidezza sull’immagine ricampionata finale. Potete controllare l’intensità dell’effetto, il raggio (in pixel) e una soglia di contrasto che verrà ignorata. Questo effetto utilizza le stesse opzioni del filtro Maschera di contrasto di Adobe Photoshop.
...
La nitidezza è descritta in [Immagini]di nitidezza (/help/assets/assets/s7_sharpening_images.pdf).
...
Consultate [Profili per elaborazione di metadati, immagini e video](processing-profiles.md).
...
1. Toccate il logo AEM e selezionate **[!UICONTROL Strumenti > Risorse > Profili]** immagine.
...
1. Immettete un nome di profilo e valori per maschera di contrasto, ritaglio o campione oppure per entrambi.
   ...
   Consultate anche Opzioni [di ritaglio](#crop-options) avanzato e campione avanzato e Maschera [di](#unsharp-mask)contrasto.
...
Potete rielaborare le risorse in una cartella che dispone già di un profilo immagine esistente modificato in seguito. Consulta [Rielaborazione delle risorse in una cartella dopo la modifica del profilo di elaborazione](processing-profiles.md#reprocessing-assets).
...
Potete applicare un profilo immagine a una cartella direttamente dal menu **[!UICONTROL Strumenti]** oppure, se siete nella cartella, da **[!UICONTROL Proprietà]**. Questa sezione descrive come applicare i profili immagine alle cartelle in entrambi i modi.
...
1. Toccate la scheda **[!UICONTROL Profili]** immagine. Dall’elenco a discesa Nome **** profilo, selezionate il profilo, quindi toccate **[!UICONTROL Salva e chiudi]**. Le cartelle a cui è già stato assegnato un profilo sono indicate dalla visualizzazione del nome del profilo direttamente sotto il nome della cartella.
...
È possibile rimuovere un profilo immagine da una cartella dal menu **[!UICONTROL Strumenti]** oppure, se si trova nella cartella, da **[!UICONTROL Proprietà]**. Questa sezione descrive come rimuovere i profili immagine dalle cartelle in entrambi i modi.
...
1. Toccate **[!UICONTROL Rimuovi profilo di elaborazione dalle cartelle]** e selezionate la cartella o più cartelle da cui desiderate rimuovere il profilo e toccate **[!UICONTROL Rimuovi]**.
...
1. Sulla cartella, toccate il segno di spunta per selezionarlo, quindi toccate **[!UICONTROL Proprietà]**.
1. Selezionate la scheda Profili **[!UICONTROL immagine]** .
1. Dal menu a discesa Nome **** profilo, selezionate **[!UICONTROL Nessuno]**, quindi toccate **[!UICONTROL Salva e chiudi]**.

...
### Acquisisci risorse {#ingesting-assets}
...
1. Eseguire una ricerca del file system in `crx-quickstart/launchpad/felix` cerca di `sling.id`. Elimina questo file.
...
1. Abilita flussi di lavoro:Dopo aver completato la migrazione, riattivate i lanciatori per i flussi di lavoro DAM Update Asset per supportare la generazione di rappresentazioni e l&#39;estrazione di metadati per un utilizzo quotidiano del sistema.

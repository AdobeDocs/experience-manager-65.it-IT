...
* **maxLength**: Numero
   ...
   (facoltativo) L’impostazione predefinita corrisponde alla lunghezza del contesto.
...
* **contesto**: Stringa o oggetto
   ...
   (facoltativo, a meno che non venga specificato un percorso relativo)

      ...
      + Gestione delle esperienze headless {#headless}
         ...
         + Percorsi headless {#journeys}
            ...
            + Percorso di architettura dei contenuti headless {#architect}
               ...
               + [Scopri come creare modelli di frammenti di contenuto in AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/architect/model-structure.html)

...
+ Note sulla versione {#release-notes}
   ...
   + [Istruzioni di installazione del Service Pack di AEM Forms](/help/release-notes/aem-forms-current-service-pack-installation-instructions.md)
   + {hide-from-toc}[Programma di installazione patch di AEM Forms JEE](/help/release-notes/jee-patch-installer-65.md)
   + [Hotfix per il Service Pack di AEM Forms](/help/release-notes/aem-forms-hotfix.md)
   ...
   + [Stato delle funzioni dell’interfaccia utente touch](/help/release-notes/touch-ui-features-status.md)
+ Protezione {#security}
   + [Amministrazione utenti e protezione](/help/sites-administering/security.md)
   ...
   + [Come controllare le operazioni di gestione degli utenti in AEM.](/help/sites-administering/audit-user-management-operations.md)
   ...
   + [Gestione delle richieste GDPR per AEM Foundation](/help/sites-administering/handling-gdpr-requests-for-aem-platform.md)
...
+ Sites {#sites}
   + Authoring {#authoring}
      + Attività, strumenti e concetti essenziali per l’authoring AEM {#essentials}
         ...
         + [Concetti di authoring](/help/sites-authoring/author.md)
         + [Operazioni di base](/help/sites-authoring/basic-handling.md)
         + [Ricerca](/help/sites-authoring/search.md)
         + [Configurazione dell’ambiente account](/help/sites-authoring/user-properties.md)
      ...
      + Authoring {#authoring}
         + [Authoring - Ambiente e strumenti](/help/sites-authoring/author-environment-tools.md)
         ...
         + [Risoluzione di problemi AEM durante l’authoring](/help/sites-authoring/troubleshooting.md)
         + [Scelte rapide da tastiera durante la modifica di pagine](/help/sites-authoring/page-authoring-keyboard-shortcuts.md)
      ...
      + Funzioni per il sito e le pagine {#siteandpage}
         ...
         + [Visualizzazione dei dati analitici sulle pagine](/help/sites-authoring/page-analytics-using.md)
      + Progetti {#projects}
      ...
      + Prestazioni pagina {#page-performance}
         + [Approfondimenti contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/authoring/siteandpage/content-insights.html?lang=it)
         + [Analisi delle prestazioni della pagina](/help/sites-authoring/ci-analyze.md)
         + [Visualizzazione dei dati analitici sulle pagine](/help/sites-authoring/pa-using.md)
   ...
   + Amministrazione {#administering}
      + [Amministrazione panoramica sulla guida utente](/help/sites-administering/home.md)
      + Articoli in primo piano {#introduction}
         ...
         + [Creazione di una directory principale della lingua tramite interfaccia classica](/help/sites-administering/tc-lroot-classic.md)
         + [Connessione a Microsoft Translator](/help/sites-administering/tc-msconf.md)
         + [Configurazione del framework di integrazione della traduzione](/help/sites-administering/tc-tic.md)
         + [Creazione guidata della copia per lingua](/help/sites-administering/tc-wizard.md)
         ...
         + [Domande frequenti AEM](/help/sites-administering/aem-faqs.md)
      + Operazioni {#operations}
         ...
         + [Raccolta oggetti inattivi nell’archivio dati](/help/sites-administering/data-store-garbage-collection.md)
         ...
         + [Configurare il Rich Text editor](/help/sites-administering/rich-text-editor.md)
         + [Configurazione del Rich Text editor per la produzione di siti accessibili](/help/sites-administering/rte-accessible-content.md)
         + [Configurazione dell’annullamento per la modifica delle pagine](/help/sites-administering/config-undo.md)
         + [Configurare i plug-in del Rich Text editor](/help/sites-administering/configure-rich-text-editor-plug-ins.md)
         + [Configurare il componente Video](/help/sites-administering/config-video.md)
         + [La modifica in serie](/help/sites-administering/bulk-editor.md)
         + [Configurazione delle notifiche e-mail](/help/sites-administering/notification.md)
         + [La verifica collegamenti](/help/sites-administering/external-link-checker.md)
         ...
         + [Configurazione delle app AEM](/help/sites-administering/config-apps.md)
      ...
      + Personalizzazione {#personalization}
         ...
         + [Configurazione di ContextHub](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/personlization/ch-configuring.html?lang=it)
      ...
      + Integrazione {#integration}
         + [Integrazione di servizi di terze parti](/help/sites-administering/third-party-services.md)
         + [Integrare con Salesforce](/help/sites-administering/salesforce.md)
         ...
         + [Risoluzione di problemi dell’integrazione di Adobe Campaign](/help/sites-administering/troubleshooting-campaignintegration.md)
         + [Connettore SharePoint](/help/sites-administering/sharepoint-connector.md)
         + [Licenze del connettore SharePoint, notifiche sul copyright e liberatorie](/help/sites-administering/sharepoint-connector-licenses.md)
         ...
         + [Adesione ad Adobe Analytics e Adobe Target](/help/sites-administering/opt-in.md)
         + [Portlet e portali di AEM](/help/sites-administering/aem-as-portal.md)
      ...
      + Best practice {#bestpractices}
         ...
         + [Best practice per la traduzione](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/administering/introduction/tc-bp.html?lang=it)
         + [Best practice MSM](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/administering/introduction/msm-best-practices.html?lang=it)
         + [AEM Sites - Compatibilità GDPR](/help/sites-administering/gdpr-compliance-sites.md)
         + [Gestione delle richieste GDPR per AEM Foundation](https://experienceleague.adobe.com/docs/experience-manager-65/content/security/handling-gdpr-requests-for-aem-platform.html?lang=it)
         + [AEM Commerce - Compatibilità GDPR](/help/sites-administering/gdpr-compliance-commerce.md)
      + Gestione dei contenuti {#contentmanagement}
         ...
         + [Esportazione della pagina](/help/sites-administering/page-exporter.md)
   ...
   + Authoring dell’interfaccia classica {#classic-ui}
      + Introduzione all’authoring dell’interfaccia classica {#introduction}
         ...
         + [Configurazione dell’ambiente account](/help/sites-classic-ui-authoring/author-env-user-props.md)
      ...
      + Authoring {#authoring}
         ...
         + [Risoluzione di problemi AEM durante l’authoring](/help/sites-classic-ui-authoring/classic-page-author-troubleshooting.md)
         ...
         + [Scelte rapide da tastiera durante la modifica di pagine](/help/sites-classic-ui-authoring/classic-page-author-keyboard-shortcuts.md)
      + Funzioni per il sito e le pagine {#siteandpage}
         ...
         + [Layout dinamico](/help/sites-classic-ui-authoring/classic-page-author-responsive-layout.md)
      ...
      + Adobe Campaign {#campaign}
         ...
         + [Creazione di moduli di Adobe Campaign in AEM](/help/sites-classic-ui-authoring/classic-personalization-ac-forms.md)
      + Authoring di risorse nell’interfaccia classica {#assets}
         ...
         + [Distribuzione di risorse Dynamic Media](/help/sites-classic-ui-authoring/dynamic-media-assets-delivering.md)
         + [Aggiunta di risorse Dynamic Media alle pagine](/help/sites-classic-ui-authoring/dynamic-media-assets-adding-to-page.md)
         + [Aggiunta di funzionalità di Scene7 alla pagina](/help/sites-classic-ui-authoring/manage-assets-classic-s7.md)
...
+ Risorse {#assets}
   ...
   + [Best practice per Assets](/help/assets/best-practices-for-assets.md)
   + [Accessibilità in  [!DNL Assets]](/help/assets/accessibility.md)
   + Usa Experience Manager Assets {#using}
      + [[!DNL Assets] Esperienza della pagina Home](/help/assets/assets-home-page.md)
      + [Cercare risorse digitali](/help/assets/search-assets.md)
      + [Utilizzare metadati di risorse](/help/assets/metadata.md)
      + [Risorse multilinguistiche](/help/assets/multilingual-assets.md)
      + [Usare [!DNL Adobe Stock] risorse in Assets](/help/assets/aem-assets-adobe-stock.md)
      ...
      + [Risoluzione dei problemi di tag avanzati per le credenziali OAuth](/help/assets/config-oauth.md)
      + [Flusso di attività nella timeline](/help/assets/activity-stream.md)
      + [Elaborare risorse](/help/assets/assets-workflow.md)
   ...
   + Dynamic Media{#dynamic}
      ...
      + [Facoltativo - Configurare Dynamic Media - Modalità Scene7, installazione pubblicazione](/help/assets/dm-publish-settings.md)
      + [Risoluzione problemi di Dynamic Media - Modalità Scene7](/help/assets/troubleshoot-dms7.md)
      + {hide-from-toc}[Configurare un account alias società Dynamic Media](/help/assets/dm-alias-account.md)
      + [Configurare Dynamic Media - Modalità ibrida](/help/assets/config-dynamic.md)
      + [Migrare da Dynamic Media - Modalità ibrida a Dynamic Media - Modalità S7](/help/assets/migrate-from-hybrid-to-dms7.md)
      ...
      + [Gestione dei predefiniti per immagini Dynamic Media](/help/assets/managing-image-presets.md)
      + [Applicare predefiniti per immagini Dynamic Media](/help/assets/image-presets.md)
      + [Profili video di Dynamic Media](/help/assets/video-profiles.md)
      + [Profili immagine di Dynamic Media](/help/assets/image-profiles.md)
      ...
      + [Aggiungere risorse Dynamic Media Classic alle pagine](/help/assets/scene7.md)
   ...
   + Estendi risorse {#extending}
      ...
      + [Installare e configurare [!DNL ImageMagick] per lavorare con [!DNL Assets]](/help/assets/best-practices-for-imagemagick.md)
      + [Integrare le risorse con il flusso di attività](/help/assets/extending-activity-stream.md)
      + [Estendere l’editor risorse](/help/assets/asseteditorx.md)
      + [[!DNL Assets] API HTTP](/help/assets/mac-api-assets.md)
      + [Supporto dei frammenti di contenuto nell’ [!DNL Assets] API HTTP](/help/assets/assets-api-content-fragments.md)
   ...
   + Amministrare risorse {#administer}
      ...
      + [Configurare la funzionalità dei metadati](/help/assets/metadata-config.md)
      + [Schemi di metadati](/help/assets/metadata-schemas.md)
      + [Write-back XMP alle rappresentazioni](/help/assets/xmp-writeback.md)
      ...
      + [Guida al dimensionamento delle risorse](/help/assets/assets-sizing-guide.md)
      ...
      + [Considerazioni sulla rete di [!DNL Assets]](/help/assets/assets-network-considerations.md)
      ...
      + [Generare rappresentazioni FPO per Adobe InDesign](/help/assets/configure-fpo-renditions.md)
      + [Best practice relative ai formati di file delle risorse](/help/assets/assets-file-format-best-practices.md)
      ...
      + [Rilevare il tipo di risorse MIME utilizzando Apache Tika](/help/assets/detect-asset-mime-type-with-tika.md)
      ...
      + [Modelli per risorse](/help/assets/asset-templates.md)
   + Brand Portal {#brandportal}
      ...
      + [Pubblicare cartelle su [!DNL Brand Portal]](/help/assets/brand-portal-publish-folder.md)
      + [Pubblicare raccolte su [!DNL Brand Portal]](/help/assets/brand-portal-publish-collection.md)
   ...
   + Gestire le risorse {#managing}
      ...
      + [Abilitare rilevamento duplicati](/help/assets/duplicate-detection.md)
      ...
      + [Insight sulle risorse](/help/assets/asset-insights.md)
      + [Abilitare gli insight sulle risorse tramite DTM](/help/assets/use-dtm-for-asset-insights.md)
      + [Configurare le informazioni delle risorse](/help/assets/configure-asset-insights.md)
      + [Consegnare ed estrarre le risorse](/help/assets/check-out-and-submit-assets.md)
      + [Applicare i servizi cloud di traduzione alle cartelle](/help/assets/transition-cloud-services.md)
      + [Utilizzare il tracciamento pagina e il codice da incorporare nelle pagine web](/help/assets/use-page-tracker.md)
...
+ Forms {#forms}
   ...
   + Guida introduttiva {#getting-started}
      ...
      + Esercitazione: creare il primo modulo adattivo {#create-first-adaptive-form}
         + [Esercitazione: creare il primo modulo adattivo](/help/forms/using/create-your-first-adaptive-form.md)
         + [Esercitazione: creare un modulo adattivo](/help/forms/using/create-adaptive-form.md)
         + [Tutorial: creare un modello dati modulo](/help/forms/using/create-form-data-model.md)
         + [Esercitazione: applicare regole ai campi modulo adattivo l](/help/forms/using/apply-rules-to-adaptive-form-fields.md)
         + [Esercitazione: definire lo stile del modulo adattivo](/help/forms/using/style-your-adaptive-form.md)
      ...
      + Esercitazione: creare la prima comunicazione interattiva {#create-first-interactive-communication}
         + [Esercitazione: creare la prima comunicazione interattiva](/help/forms/using/create-your-first-interactive-communication.md)
         + [Esercitazione: pianificare la comunicazione interattiva](/help/forms/using/planning-interactive-communications.md)
         + [Tutorial: creare un modello dati modulo](/help/forms/using/create-form-data-model0.md)
         + [Esercitazione: creare frammenti di documento](/help/forms/using/create-document-fragments.md)
         + [Esercitazione: creare modelli](/help/forms/using/create-templates-print-web.md)
         + [Esercitazione: creare una comunicazione interattiva](/help/forms/using/create-interactive-communication0.md)
      + Materiali collaterali di riferimento di AEM Forms {#aem-forms-reference-collaterals}
         ...
         + [Procedura dettagliata sul sito di riferimento per l’assunzione dei dipendenti](/help/forms/using/employee-recruitment-reference-site.md)
         ...
         + [Procedura dettagliata FOIA sul sito di riferimento We.Gov](/help/forms/using/gov-reference-site-foia-walkthrough.md)
         + [Frammenti di moduli adattivi di riferimento](/help/forms/using/reference-adaptive-form-fragments.md)
         ...
         + [Configura Microsoft Dynamics 365 per il flusso di lavoro relativo ai mutui per la casa del sito di riferimento We.Finance](/help/forms/using/ms-dynamics-configuration-home-mortgage.md)
   + Installare e configurare AEM Forms {#install-aem-forms}
      ...
      + [Scegliere un tipo di persistenza per un’installazione di AEM Forms](/help/forms/using/choosing-persistence-type-for-aem-forms.md)
      + Installare AEM Forms su OSGi {#osgi-installation}
         ...
         + [Installare e configurare i servizi per documenti](/help/forms/using/install-configure-document-services.md)
         ...
         + [Installare e configurare il servizio di conversione automatica dei moduli](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html?lang=it)
      + Installare AEM Forms su JEE {#jee-installation}
         ...
         + [Installazione e distribuzione di AEM Forms su JEE utilizzando JBoss Turnkey](https://www.adobe.com/go/learn_aemforms_installTurnkey_65_it)
         + [Installare e configurare il server di Protezione dei documenti di AEM Forms](/help/forms/using/installing-and-configuring-the-document-security-server.md)
         + [Preparazione all&#39;installazione di AEM Forms (server singolo)](https://www.adobe.com/go/learn_aemforms_prepareInstallsingle_65_it)
         + [Installazione e distribuzione di Adobe Experience Manager Forms su JEE per JBoss](https://www.adobe.com/go/learn_aemforms_installJBoss_65_it)
         + [Installazione e distribuzione di Adobe Experience Manager Forms su JEE per WebSphere](https://www.adobe.com/go/learn_aemforms_installWebSphere_65_it)
         + [Installazione e distribuzione di AEM Forms su JEE per WebLogic](https://www.adobe.com/go/learn_aemforms_installWebLogic_65_it)
         ...
         + [Preparazione all&#39;installazione di AEM Forms (cluster di server)](https://www.adobe.com/go/learn_aemforms_prepareInstallcluster_65_it)
         + [Configurazione di Adobe Experience Manager Forms su JEE nel cluster JBoss](https://www.adobe.com/go/learn_aemforms_clusterJBoss_65_it)
         + [Configurazione di Adobe Experience Manager Forms su JEE in un cluster WebSphere](https://www.adobe.com/go/learn_aemforms_clusterWebSphere_65_it)
         + [Configurazione di Adobe Experience Manager Forms su JEE in un cluster WebLogic](https://www.adobe.com/go/learn_aemforms_clusterWebLogic_65_it)
         + [Mitigazione dei problemi di serializzazione in AEM Forms JEE](/help/forms/using/mitigating-serialization-issues-forms-jee.md)
      + Configurare i moduli AEM {#configure-aem-forms}
         ...
         + [Configurazione del modulo di pianificazione di sincronizzazione](/help/forms/using/configure-synchronization-scheduler.md)
         + [Configurazione del connettore per Microsoft SharePoint](https://help.adobe.com/it_IT/AEMForms/6.1/SharePointConfig/index.html)
         + [Collegamento di AEM Forms con Adobe LiveCycle](/help/forms/using/aem-livecycle-connector.md)
         + [Configurazione di AEM Forms per inviare i dati del modulo a un processo AEM Forms su JEE](/help/forms/using/submit-form-data-livecycle-process.md)
   ...
   + Aggiornare AEM Forms {#upgrade-aem-forms}
      ...
      + Aggiornare AEM Forms su OSGi {#aem-forms-osgi-upgrade}
         ...
         + [Installare pacchetto di compatibilità](/help/forms/using/compatibility-package.md)
      ...
      + Aggiornare AEM Forms su JEE {#aem-forms-jee-upgrade}
         + [Preparazione all’aggiornamento di AEM Forms](https://www.adobe.com/go/learn_aemforms_prepareupgrade_65_it)
         + [Elenco di controllo e pianificazione dell’aggiornamento a Adobe Experience Manager Forms su JEE](https://www.adobe.com/go/learn_aemforms_upgrade_checklist_65_it)
         + [Aggiornamento ad AEM 6.5 Forms su JEE](/help/forms/using/upgrade-forms-jee.md)
         + [Aggiornamento ad Adobe Experience Manager Forms su JEE per JBoss](https://www.adobe.com/go/learn_aemforms_upgradeJBoss_65_it)
   ...
   + Gestire AEM Forms {#manage-administer-aem-forms}
      ...
      + Gestione dei dati utente {#handling-user-data}
         ...
         + [Protezione dei documenti](/help/forms/using/document-security-handling-user-data.md)
      + Rafforzamento dell’ambiente AEM Forms {#hardening-aem-forms-environment}
         + [Rafforzamento e protezione di AEM Forms in ambiente OSGi](/help/forms/using/hardening-securing-aem-forms-environment.md)
         ...
         + [Configurazione delle impostazioni di amministrazione sciura per AEM Forms su JEE](/help/forms/using/configuring-secure-administration-settings-aem.md)
   + Modello dati modulo {#form-data-model}
      ...
      + [Configurazione Odata per Microsoft Dynamics](/help/forms/using/ms-dynamics-odata-configuration.md)
      + [Integrazione di Salesforce tramite l’autorizzazione del flusso delle credenziali client OAuth 2.0](/help/forms/using/oauth2-client-credentials-flow-for-server-to-server-integration.md)
      + [Creare un modello di dati modulo](/help/forms/using/create-form-data-models.md)
      + [Utilizzare il modello dati modulo](/help/forms/using/work-with-form-data-model.md)
      + [Utilizzare il modello dati modulo](/help/forms/using/using-form-data-model.md)
   + Moduli adattivi - Componenti core {#adaptive-forms-core-components}
      ...
      + [Creare e utilizzare frammenti di moduli adattivi in un modulo adattivo](/help/forms/using/adaptive-form-fragment-core-components.md)
      + [Creare temi per moduli adattivi basati sui componenti core](/help/forms/using/create-or-customize-themes-for-adaptive-forms-core-components.md)
      + [Editor di regole](/help/forms/using/rule-editor-core-components.md)
      + [Creare e utilizzare una funzione personalizzata per i componenti core del modulo adattivo](/help/forms/using/create-and-use-custom-functions-core-components.md)
      + [Creare e utilizzare un gestore errori personalizzato per i moduli adattivi basati su componenti core](/help/forms/using/add-custom-error-handler-adaptive-forms-core-components.md)
      ...
      + {hide-from-toc}[Attiva/Disattiva funzionalità](/help/forms/using/enable-feature-toggle.md)
   + Moduli adattivi - Authoring di base {#adaptive-forms-basic-authoring}
      ...
      + [Frammenti di un modulo adattivo](/help/forms/using/adaptive-form-fragments.md)
      ...
      + [Tabelle nei moduli adattivi](/help/forms/using/adaptive-forms-tables.md)
      + [Grafici nei moduli adattivi](/help/forms/using/adaptive-form-charts.md)
      + [Salvare in automatico un modulo adattivo](/help/forms/using/auto-save-an-adaptive-form.md)
      + [Configurare la pagina di reindirizzamento](/help/forms/using/configuring-redirect-page.md)
      + [Creare moduli adattivi accessibili](/help/forms/using/creating-accessible-adaptive-forms.md)
      + [Creare moduli con sezioni ripetibili](/help/forms/using/creating-forms-repeatable-sections.md)
      ...
      + [Stile in linea dei componenti dei moduli adattivi](/help/forms/using/inline-style-adaptive-forms.md)
      ...
      + [Riutilizzare i moduli adattivi](/help/forms/using/reusing-adaptive-forms.md)
      ...
      + [Scelte rapide da tastiera in AEM Forms](/help/forms/using/keyboard-shortcuts.md)
      + [Associare i revisori di invio a un modulo](/help/forms/using/adding-reviewers-form.md)
      ...
      + [Collegare e inviare i dati del modulo adattivo a Microsoft® Power Automate](/help/forms/using/forms-microsoft-power-automate-integration.md)
   + Moduli adattivi - Creazione avanzata {#adaptive-forms-advanced-authoring}
      + [Creare moduli adattivi con lo schema JSON](/help/forms/using/adaptive-form-json-schema-form-model.md)
      + [Creare moduli adattivi con lo schema XML](/help/forms/using/adaptive-form-xml-schema-form-model.md)
      + [Utilizzare l’accesso di Adobe in un modulo adattivo](/help/forms/using/working-with-adobe-sign.md)
      + [Creazione e utilizzo di temi](/help/forms/using/themes.md)
      + [Editor di regole dei moduli adattivi](/help/forms/using/rule-editor.md)
      + [API per richiamare il servizio Modello dati modulo (FDM) nei moduli adattivi](/help/forms/using/invoke-form-data-model-services.md)
      ...
      + [Espressioni dei moduli adattivi](/help/forms/using/adaptive-form-expressions.md)
      + [Generare un documento record per moduli adattivi](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md)
      ...
      + [Precompilare i campi di un modulo adattivo](/help/forms/using/prepopulate-adaptive-form-fields.md)
      + [Utilizzare le espressioni SOM nei moduli adattivi](/help/forms/using/using-som-expressions-adaptive-forms.md)
      + [Aggiungere informazioni prese dai dati utente ai metadati di invio di un modulo](/help/forms/using/form-submission-metadata.md)
      + [Supporto XFA in moduli adattivi basati su XDP](/help/forms/using/xfa-api-supported-in-adaptive-form.md)
      + [Concedere l’accesso all’editor di regole a specifici gruppi di utenti](/help/forms/using/rule-editor-access-user-groups.md)
      + [Utilizzare il flusso di lavoro per traduzione di AEM per localizzare i moduli adattivi e il documento record](/help/forms/using/using-aem-translation-workflow-to-localize-adaptive-forms.md)
      + [Costrutti di stile per moduli adattivi](/help/forms/using/styling-constructs-adaptive-forms.md)
      + [Sincronizzazione di moduli adattivi con i modelli di modulo XFA](/help/forms/using/synchronizing-adaptive-forms-xfa.md)
      + [Integrare Adobe Acrobat Sign con AEM Forms](/help/forms/using/adobe-sign-integration-adaptive-forms.md)
      + [Creare e gestire le revisioni delle risorse nei moduli](/help/forms/using/create-reviews-forms.md)
      + [Incorporare un modulo adattivo o una comunicazione interattiva nell’applicazione a pagina singola di AEM Sites](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
      + [Creare e utilizzare funzioni personalizzate in un modulo adattivo](/help/forms/using/create-and-use-custom-functions.md)
      + [Creare e utilizzare un handler degli errori personalizzato per i moduli adattivi](/help/forms/using/standard-validation-error-messages-adaptive-forms.md)
   + Comunicazioni interattive {#interactive-communications}
      + [Introduzione all’interfaccia utente di creazione delle comunicazioni interattive](/help/forms/using/introduction-interactive-communication-authoring.md)
      + [Creare una comunicazione interattiva](/help/forms/using/create-interactive-communication.md)
      + [Utilizzare i grafici nelle comunicazioni interattive](/help/forms/using/chart-component-interactive-communications.md)
   ...
   + Flussi di lavoro {#workflows}
      ...
      + [Avviare le API dei servizi basati sui documenti dal flusso di lavoro AEM](/help/forms/using/initiating-document-services-apis-aem.md)
      + [Registrazione nei flussi di lavoro di AEM Forms](/help/forms/using/forms-workflow-logs.md)
      + [Variabili nei flussi di lavoro AEM](/help/forms/using/variable-in-aem-workflows.md)
      ...
      + [Configurare opzione Fuori sede](/help/forms/using/configure-out-of-office-settings.md)
   + Area di lavoro di AEM Forms {#use-aem-forms-workspace}
      + [Introduzione all’area di lavoro di AEM Forms](/help/forms/using/introduction-html-workspace.md)
      + [Utilizzo dell’area di lavoro di AEM Forms](/help/forms/using/html-workspace-overview.md)
      + [Architettura dell’area di lavoro di AEM Forms](/help/forms/using/html-workspace-architecture.md)
      ...
      + [Funzioni dell’area di lavoro Flex non disponibili in AEM Forms](/help/forms/using/features-flex-workspace-available-html.md)
      + [Interazione portante](/help/forms/using/backbone-interaction.md)
      ...
      + [Introduzione alla personalizzazione dell’area di lavoro di AEM Forms](/help/forms/using/introduction-customizing-html-workspace.md)
      ...
      + [Modifica delle impostazioni locali dell’interfaccia utente dell’area di lavoro di AEM Forms](/help/forms/using/changing-locale-user-interface.md)
      ...
      + [Visualizzazione di dati aggiuntivi nell’elenco delle attività da svolgere](/help/forms/using/display-additional-data-in-todo-list.md)
      ...
      + [Hosting di due istanze dell’area di lavoro di AEM Forms su un server](/help/forms/using/two-html-workspace-instances-one.md)
      + [Modifica della combinazione di colori dell’interfaccia](/help/forms/using/changing-color-scheme-interface.md)
      + [Modifica del font nell’interfaccia](/help/forms/using/changing-font-interface.md)
      + [Modifica del logo dell’organizzazione per il branding](/help/forms/using/changing-organization-logo-branding.md)
      ...
      + [Guida introduttiva all’area di lavoro AEM Forms](/help/forms/using/getting-started-livecycle-html-workspace.md)
      + [Gestione delle attività in una gerarchia organizzativa tramite la vista Responsabile](/help/forms/using/tasks-organizational-hierarchy-using-manager.md)
      + [Avvio dei processi](/help/forms/using/starting-processes.md)
      + [Tracking dei processi](/help/forms/using/tracking-processes.md)
      + [Gestori del Single Sign On e del timeout](/help/forms/using/single-sign-timeout-handlers.md)
      + [Utilizzo di un modulo adattivo nell’area di lavoro HTML](/help/forms/using/using-adaptive-form-html-workspace.md)
      ...
      + [Linee guida per la risoluzione dei problemi per l’area di lavoro di AEM Forms](/help/forms/using/troubleshooting-guidelines-html-workspace.md)
   + App AEM Forms {#aem-forms-app}
      ...
      + [Creare l’app AEM Forms per Android](/help/forms/using/setup-eclipse-project-build-installer.md)
      ...
      + [Utilizzo dei punti iniziali](/help/forms/using/working-with-startpoints.md)
      ...
      + [Salvare i moduli come modelli](/help/forms/using/save-forms-and-start-points-as-templates.md)
      ...
      + [Risoluzione dei problemi dell’app AEM Forms](/help/forms/using/issues-aem-forms-app.md)
   + Moduli HTML5 {#html5-forms}
      ...
      + [Progettazione di modelli per moduli per moduli HTML5](/help/forms/using/designing-form-template.md)
      ...
      + [Rendering del modello per moduli HTML5](/help/forms/using/rendering-form-template.md)
   ...
   + Lettere e corrispondenze {#letters-correspondences}
      ...
      + [Creare una lettera](/help/forms/using/create-letter.md)
      + [Crea corrispondenza](/help/forms/using/create-correspondence.md)
      + [Funzioni remote nel Generatore di espressioni](/help/forms/using/expression-builder.md)
      + [Gestire immagini firma agente](/help/forms/using/manage-agent-signature-images.md)
      + [Post-elaborazione di lettere e comunicazioni interattive](/help/forms/using/submit-letter-topostprocess.md)
      + [Aggiungere un’azione personalizzata alla vista elenco delle risorse](/help/forms/using/add-custom-action-asset-listing-view.md)
      + [Aggiungere un’azione/pulsante personalizzato nell’interfaccia utente per la creazione di corrispondenza](/help/forms/using/add-action-button-in-create-correspondence-ui.md)
      ...
      + [API per accedere alle istanze lettera](/help/forms/using/cm-apis-to-access-letter-instances.md)
      ...
      + [Proprietà configurazione gestione della corrispondenza](/help/forms/using/cm-configuration-properties.md)
   + Integrare AEM Forms con le soluzioni Experience Cloud {#integrate-aem-forms-with-experience-cloud-solutions}
      ...
      + [Visualizzare e comprendere i rapporti di analisi di AEM Forms](/help/forms/using/view-understand-aem-forms-analytics-reports.md)
   ...
   + Pubblicare ed elaborare AEM Forms {#publish-process-aem-forms}
      ...
      + [Incorporazione del componente collegamento in una pagina](/help/forms/using/embedding-link-component-page.md)
      + [Pubblicare e annullare la pubblicazione di moduli e documenti](/help/forms/using/publishing-unpublishing-forms.md)
      + [Elenco di moduli su una pagina web utilizzando le API](/help/forms/using/listing-forms-webpage-using-apis.md)
      + [Accesso e compilazione di moduli pubblicati](/help/forms/using/accessing-filling-published-forms.md)
      + [Invio di una conferma di invio modulo tramite e-mail](/help/forms/using/form-submission-receipt-via-email.md)
   ...
   + Portale dei moduli {#use-forms-portal}
      ...
      + [Abilitazione dei componenti del portale dei moduli](/help/forms/using/enabling-forms-portal-components.md)
   ...
   + Servizi per documenti {#use-document-services}
      + [Panoramica dei servizi basati su documenti di AEM](/help/forms/using/overview-aem-document-services.md)
      ...
      + [Servizio moduli con codice a barre](/help/forms/using/using-barcoded-forms-service.md)
      ...
      + [Utilizzo dei servizi basati su documenti di AEM a livello di programmazione](/help/forms/using/aem-document-services-programmatically.md)
      + [Utilizzo dell’API sendToPrinter](/help/forms/using/using-sendtoprinter-api.md)
   + Protezione dei documenti {#use-document-security}
      + [Offerte sulla protezione dei documenti](/help/forms/using/document-security-offerings.md)
      + [Consentire ad AEM di effettuare ricerche nei documenti PDF protetti da protezione dei documenti](/help/forms/using/enable-search-for-drm-protected-pdf-documents-in-aem.md)
      + [Reader estende i documenti PDF protetti da criterio utilizzando la libreria di protezione portatile](/help/forms/using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
      + [Consentire ad AEM di effettuare ricerche nei documenti PDF e Microsoft Office protetti da protezione dei documenti](/help/forms/using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
   ...
   + Forms Designer {#use-forms-designer}
      ...
      + [Tutorial introduttivi su Designer](https://www.adobe.com/go/learn_aemforms_designer_quick_start_65)
      ...
      + [Utilizzo della firma a meno nei moduli HTML5](/help/forms/using/scribble-signature.md)
      + [Modifica del contenuto della pagina zero in Designer](/help/forms/using/changing-page-zero-content-designer.md)
      + Best practice sull’accessibilità {#accessibility-best-practices}
         + {hide-from-toc}[Introduzione](/help/forms/using/introduction-accessibility-forms-designer.md)
         + {hide-from-toc}[Procedure consigliate per la creazione di moduli](/help/forms/using/best-practices-for-creating-forms-in-designer.md)
         + {hide-from-toc}[Tecniche per testare l&#39;accessibilità del modulo](/help/forms/using/techniques-for-testing-form-accessibility.md)
         + {hide-from-toc}[Mappatura tra linee guida e best practice](/help/forms/using/mapping-between-guidelines-and-best-practices.md)
         + {hide-from-toc}[Collegamenti utili](/help/forms/using/useful-links-accessibility-forms-designer.md)
   + Personalizzare AEM Forms {#customize-aem-forms}
      + [Framework dell’aspetto per moduli adattivi e HTML5](/help/forms/using/introduction-widgets.md)
      ...
      + [Aggiunta di azioni personalizzate agli elementi dell’elenco del modulo](/help/forms/using/add-custom-action-form-lister.md)
      ...
      + [Personalizzazione del modulo di tracciamento degli eventi](/help/forms/using/customizing-form-event-tracking.md)
   ...
   + Rapporti sulle transazioni {#transaction-reports}
      ...
      + Rapporti sulle transazioni di AEM Forms su JEE {#transaction-reports-jee}
   ...
   + Guida per gli amministratori di AEM Forms su JEE {#administrator-help}
      ...
      + Impostazione e gestione dei domini {#setup-manage-domains}
         + [Aggiungere domini](/help/forms/using/admin-help/adding-domains.md)
         ...
         + [Configurare le directory](/help/forms/using/admin-help/configuring-directories.md)
      + Configurazione di Gestione utenti {#configure-user-management}
         ...
         + [Importare ed esportare il file di configurazione](/help/forms/using/admin-help/importing-exporting-configuration-file.md)
         + [Configurare attributi di sistema avanzati](/help/forms/using/admin-help/configure-advanced-system-attributes.md)
         + [Prevenzione degli attacchi CSFR](/help/forms/using/admin-help/preventing-csrf-attacks.md)
      + Impostazione e organizzazione degli utenti {#setup-organize-users}
         + [Aggiungere e configurare gli utenti](/help/forms/using/admin-help/adding-configuring-users.md)
         + [Provisioning utente just-in-time](/help/forms/using/admin-help/just-in-time-user-provisioning.md)
         + [Creazione e configurazione dei gruppi](/help/forms/using/admin-help/creating-configuring-groups.md)
         + [Ricerca di un utente o gruppo](/help/forms/using/admin-help/search-user-or-group.md)
         + [Creare e configurare i ruoli](/help/forms/using/admin-help/creating-configuring-roles.md)
      ...
      + Gestione di certificati e credenziali {#manage-certificates-credentials}
         ...
         + [Informazioni di base sulla gestione di certificati e credenziali](/help/forms/using/admin-help/overview-2.md)
         + [Gestire i certificati](/help/forms/using/admin-help/certificates.md)
      ...
      + Gestione degli endpoint {#manage-endpoints}
         ...
         + [Configurazione endpoint di Gestione attività](/help/forms/using/admin-help/configuring-task-manager-endpoints.md)
      ...
      + Configurazione delle estensioni di Acrobat Reader DC {#configure-acrobat-reader-dc-extensions}
         + [Tipi di certificati utilizzati dalle estensioni di Adobe Reader DC](/help/forms/using/admin-help/certificate-types-used-acrobat-reader.md)
         ...
         + [Configurazione delle estensioni di Acrobat Reader DC per l’acquisizione dei dati](/help/forms/using/admin-help/configuring-acrobat-reader-dc-extensions.md)
         + [Rivedere le informazioni sull’utilizzo delle credenziali](/help/forms/using/admin-help/review-credential-information.md)
         + [Configurazione delle credenziali per l’utilizzo con le estensioni di Acrobat Reader DC](/help/forms/using/admin-help/configuring-credentials-acrobat-reader-dc.md)
         + [Rivedere i diritti di utilizzo di un file PDF](/help/forms/using/admin-help/review-usage-rights-pdf-file.md)
         + [Abilitare i commenti online per il plug-in del browser web Adobe Reader](/help/forms/using/admin-help/enabling-online-commenting-reader-web.md)
         + [Impostare i valori di timeout per l’utilizzo con le estensioni di Acrobat Reader DC](/help/forms/using/admin-help/setting-timeout-values-acrobat-reader.md)
      ...
      + Utilizzo di PDF Generator {#work-with-pdf-generator}
         ...
         + [Abilitazione delle conversioni di file a più thread](/help/forms/using/admin-help/enabling-multi-threaded-file-conversions.md)
         + [Configurazione delle impostazioni di Adobe PDF](/help/forms/using/admin-help/configuring-pdf-settings.md)
         + [Configurare le impostazioni di protezione](/help/forms/using/admin-help/configuring-security-settings.md)
         + [Configurare le impostazioni tipo di file](/help/forms/using/admin-help/configuring-file-type-settings.md)
         ...
         + [Impostazione di una stampante di rete PDFG (solo Windows)](/help/forms/using/admin-help/setting-pdfg-network-printer-windows.md)
         + [Configurazione dei font di fallback](/help/forms/using/admin-help/configuring-fallback-fonts.md)
         + [Modifica delle impostazioni di conversione dell’esportazione di PDF](/help/forms/using/admin-help/modifying-pdf-export-conversion-settings.md)
      ...
      + Configurazione di SSL {#configure-ssl}
         ...
         + [Configurazione SSL in Windows Vista](/help/forms/using/admin-help/configuring-ssl-windows-vista.md)
         + [Configurare SSL per il server applicazioni WebSphere](/help/forms/using/admin-help/configuring-ssl-websphere-application-server.md)
      + Utilizzo della protezione dei documenti {#work-with-document-security}
         ...
         + [Consegna sicura delle informazioni con volumi elevati](/help/forms/using/admin-help/high-volume-secure-information-delivery.md)
         + [Configurazione delle opzioni client e server](/help/forms/using/admin-help/configuring-client-server-options.md)
         + [Configurare l’autenticazione estesa dal browser esterno per la sicurezza dei documenti](/help/forms/using/admin-help/configure-external-browser-authentication-document-security.md)
         + [Gestione degli account utente invitati e locali](/help/forms/using/admin-help/invited-local-user-accounts.md)
         + [Controllo dell’accesso ai documenti protetti da criteri](/help/forms/using/admin-help/controlling-access-policy-protected-documents.md)
         + [Monitoraggio degli eventi](/help/forms/using/admin-help/monitoring-events.md)
         + [Creare e gestire i criteri](/help/forms/using/admin-help/creating-policies.md)
      ...
      + Configurazione di Forms {#configure-forms}
         ...
         + [Specificare le opzioni di configurazione XCI](/help/forms/using/admin-help/specifying-xci-configuration-options.md)
         + [Configurazione dell’output del modulo](/help/forms/using/admin-help/configuring-form-output.md)
         + [Specificare i font da incorporare](/help/forms/using/admin-help/specifying-fonts-embed.md)
         + [Configurazione delle posizioni per Forms](/help/forms/using/admin-help/configuring-locations-forms.md)
         + [Specificare le impostazioni di protezione](/help/forms/using/admin-help/specifying-security-settings.md)
      ...
      + Configurazione dell’output {#configure-output}
         + [Panoramica sul servizio di output](/help/forms/using/admin-help/overview-8.md)
         ...
         + [Rendere disponibili i font](/help/forms/using/admin-help/make-fonts-available.md)
         + [Specificare i font da incorporare](/help/forms/using/admin-help/specify-fonts-embed.md)
         + [Specificare le impostazioni di sicurezza](/help/forms/using/admin-help/specify-security-settings.md)
         + [Modificare il set di caratteri](/help/forms/using/admin-help/change-character-set.md)
      + Configurazione di Forms Workflow{#configure-forms-workflow}
         + [Informazioni sulla terminologia dell’amministrazione e dei processi](/help/forms/using/admin-help/administration-process-terminology.md)
         ...
         + [Configurare le code condivise](/help/forms/using/admin-help/configuring-shared-queues.md)
         + [Utilizzo delle attività](/help/forms/using/admin-help/tasks.md)
      + Configurazione di Workspace {#configure-workspace}
         + [Panoramica dell’area di lavoro](/help/forms/using/admin-help/overview-10.md)
         + [Importazione ed esportazione delle impostazioni globali](/help/forms/using/admin-help/importing-exporting-global-settings.md)
         ...
         + [Gestire le categorie visualizzate in Workspace](/help/forms/using/admin-help/categories-displayed-workspace.md)
      + Monitoraggio dello stato {#health-monitor}
         + [Panoramica sul monitoraggio dello stato](/help/forms/using/admin-help/overview-11.md)
         + [Ottimizzazione delle prestazioni del monitoraggio dello stato](/help/forms/using/admin-help/fine-tuning-health-monitor-performance.md)
         + [Visualizzare le statistiche relative a Work Manager](/help/forms/using/admin-help/view-statistics-related-manager.md)
         + [Visualizzare le informazioni di sistema](/help/forms/using/admin-help/view-system-information.md)
         + [Eliminare record dal database di Gestione processo](/help/forms/using/admin-help/purge-records-job-manager-database.md)
      + Manutenzione di AEM Forms {#maintain-aem-forms}
         + [File di registro](/help/forms/using/admin-help/log-files.md)
         + [Gestione utenti](/help/forms/using/admin-help/user-management.md)
         + [Monitoraggio dell’implementazione di AEM Forms](/help/forms/using/admin-help/monitoring-aem-forms-deployments.md)
         + [Work Manager e limitazioni](/help/forms/using/admin-help/manager-throttling.md)
      ...
      + Manutenzione del database di AEM Forms {#maintain-aem-forms-database}
         ...
         + [Rimozione dei dati di processo](/help/forms/using/admin-help/purging-process-data.md)
      ...
      + Manutenzione del server applicazioni {#manage-application-server}
         + [Siti web del server applicazioni](/help/forms/using/admin-help/application-server-websites.md)
         + [Directory di archiviazione globale dei documenti](/help/forms/using/admin-help/global-document-storage-directory.md)
         + [Considerazioni durante l’esecuzione della console di amministrazione](/help/forms/using/admin-help/considerations-running-administration-console.md)
         ...
         + [Avviare e interrompere il server applicazioni WebSphere](/help/forms/using/admin-help/starting-stopping-websphere-application-server.md)
      + Backup e ripristino di AEM Forms {#aem-forms-backup-recovery}
         + [Backup e ripristino dell’archivio Documentum di EMC](/help/forms/using/admin-help/backing-recovering-emc-documentum-repository.md)
         + [Abilitazione e disabilitazione della modalità backup sicuro](/help/forms/using/admin-help/enabling-disabling-safe-backup-mode.md)
         + [Backup dei dati di AEM Forms](/help/forms/using/admin-help/backing-aem-forms-data.md)
         + [File da sottoporre a backup e da ripristinare](/help/forms/using/admin-help/files-back-recover.md)
         + [Strategia di backup e ripristino di AEM Forms](/help/forms/using/admin-help/backup-recovery-strategy-aem-forms.md)
         ...
         + [Recupero dei dati di AEM Forms](/help/forms/using/admin-help/recovering-aem-forms-data.md)
         + [Strategia di backup per il connettore per utenti EMC Documentum](/help/forms/using/admin-help/backup-strategy-connector-emc-documentum.md)
         + [Strategia di backup e ripristino in un ambiente in cluster](/help/forms/using/admin-help/strategy-backup-restore-clustered-environment.md)
      + Servizio informativo del sistema {#system-information-service}
         + [Configurare il servizio informativo del sistema](/help/forms/using/admin-help/set-system-information-service.md)
         + [API del servizio informativo del sistema](/help/forms/using/admin-help/system-information-service-apis.md)
   + Rapporti sui processi {#process-reporting}
      + [Introduzione ai rapporti sui processi](/help/forms/using/process-reporting/introduction-process-reporting.md)
      + [Guida introduttiva ai rapporti sui processi](/help/forms/using/process-reporting/install-start-process-reporting.md)
      + [Funzionamento dei rapporti sui processi](/help/forms/using/process-reporting/process-reporting-architecture.md)
      + [Rapporti predefiniti in Rapporti sui processi](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
      + [Rapporti personalizzati in Rapporti sui processi](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
      + [Query ad hoc in Rapporti sui processi](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)
      + [Risoluzione dei problemi di Rapporti sui processi](/help/forms/using/process-reporting/troubleshooting-process-management.md)
   + Riferimenti per sviluppatori {#developer-reference}
      ...
      + [Riferimento API Java di AEM Forms](https://helpx.adobe.com/it/experience-manager/6-5/forms/javadocs/index.html)
      + [Riferimento API Java di AEM Forms su JEE](https://helpx.adobe.com/it/experience-manager/6-5/forms/programlc/javadoc/index.html)
      + [API Form Bridge per moduli HTML5](/help/forms/using/form-bridge-apis.md)
      + [Riferimento API della libreria JavaScript per Forms adattivo](https://helpx.adobe.com/it/experience-manager/6-5/forms/javascript-api/index.html)
      + [Servizio assemblatore e riferimento DDX](https://www.adobe.com/go/learn_aemforms_ddxRef_65_it)
      + [Guida di Workbench](https://www.adobe.com/go/learn_aemforms_workbench_65_it)
      + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
         + Introduzione alla programmazione con AEM Forms su JEE {#introduction-programming-aem-forms-jee}
            + [Introduzione a API Java QuickStart](/help/forms/developing/introducing-java-api-soap-quick.md)
            ...
            + [Contenitore di servizio](/help/forms/developing/service-container.md)
         + Sviluppo di SPI per AEM Forms {#developing-spis-aem-forms}
            + [Creazione di un gestore per l’invito di utenti esterni](/help/forms/developing/creating-invite-external-users-handler.md)
         + Avvio rapido API Java: esempi di codice {#java-api-quick-start-code-examples}
            + [Avvio rapido API Java per il client di Application Manager (SOAP)](/help/forms/developing/application-manager-client-java-api.md)
            + [Avvio rapido di API Java per il servizio Application Manager (SOAP)](/help/forms/developing/application-manager-service-java-api.md)
            + [Avvio rapido di API Java per il servizio Assembler (SOAP)](/help/forms/developing/assembler-service-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio estensioni di Acrobat Reader DC (SOAP)](/help/forms/developing/acrobat-reader-dc-extensions-service.md)
            + [Avvio rapido di API per il servizio di backup e ripristino](/help/forms/developing/backup-restore-service-api-quick.md)
            + [Avvio rapido di API Java per il servizio Moduli con codice a barre (SOAP)](/help/forms/developing/barcoded-forms-service-java-api.md)
            + [Avvio rapido di API Java per componenti e servizi (SOAP)](/help/forms/developing/components-services-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio di conversione PDF (SOAP)](/help/forms/developing/convert-pdf-service-java-api.md)
            + [Avvio rapido di API Java per il servizio di credenziali SOAP)](/help/forms/developing/credential-service-java-api-quick.md)
            + [Avvio rapido di API Java per per il servizio Distiller (SOAP)](/help/forms/developing/distiller-service-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio DocConverter (SOAP)](/help/forms/developing/docconverter-service-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio di gestione dei documenti (obsoleto) (SOAP)](/help/forms/developing/document-management-service-deprecated-java.md)
            + [Avvio rapido di API Java per il servizio di sicurezza dei documenti (SOAP)](/help/forms/developing/document-security-service-java-api.md)
            + [Avvio rapido di API Java per il servizio di crittografia (SOAP)](/help/forms/developing/encryption-service-java-api-quick.md)
            + [Avvio rapido di API Java per il registro degli endpoint (SOAP)](/help/forms/developing/endpoint-registry-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio di integrazione dei dati del modulo (SOAP)](/help/forms/developing/form-data-integration-service-java.md)
            + [Avvio rapido di API Java per il servizio dei moduli](/help/forms/developing/forms-service-api-quick-starts.md)
            + [Avvio rapido di API Java per il servizio di generazione dei PDF (SOAP)](/help/forms/developing/generate-pdf-service-java-api.md)
            + [Avvio rapido di API per la chiamata](/help/forms/developing/invocation-api-quick-starts.md)
            + [Avvio rapido di API Java per il processo del ciclo dal vivo (SOAP)](/help/forms/developing/livecycleprocess-java-api-soap-quick.md)
            + [Avvio rapido di API Java per il servizio di output (SOAP)](/help/forms/developing/output-service-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio delle utilità di PDF (SOAP)](/help/forms/developing/pdf-utilities-service-java-api.md)
            + [Avvio rapido di API per il servizio di archivio](/help/forms/developing/repository-service-api-quick-starts.md)
            + [Avvio rapido di API Java per il servizio di firma (SOAP)](/help/forms/developing/signature-service-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio di gestione delle attività (SOAP)](/help/forms/developing/task-manager-service-java-api.md)
            + [Avvio rapido di API Java per la gestione degli utenti (SOAP)](/help/forms/developing/user-manager-java-api-quick.md)
            + [Avvio rapido di API Java per il servizio delle utilità di XMP (SOAP)](/help/forms/developing/xmp-utilities-service-java-api.md)
         + Richiamare AEM Forms su JEE utilizzando l’API {#invoking-aem-forms-jee-apis}
            ...
            + [Richiamare AEM Forms tramite comunicazione remota](/help/forms/developing/invoking-aem-forms-using-remoting.md)
         ...
         + Esecuzione di operazioni del servizio tramite API {#performing-service-operations-using-apis}
            + [Esecuzione di operazioni del servizio tramite API](/help/forms/developing/performing-service-operations-using-apis.md)
            + [Rendering dei moduli](/help/forms/developing/rendering-forms.md)
            ...
            + [Assemblaggio di documenti utilizzando la numerazione Bates](/help/forms/developing/assembling-documents-using-bates-numbering.md)
            ...
            + [Assemblaggio di portfolio PDF](/help/forms/developing/assembling-pdf-portfolios.md)
            + [Calcolo dei dati del modulo](/help/forms/developing/calculating-form-data.md)
            + [Creazione di applicazioni web per il rendering dei moduli](/help/forms/developing/creating-web-applications-renders-forms.md)
            ...
            + [Determinazione se i documenti sono conformi PDF/A](/help/forms/developing/determining-whether-documents-pdf-a.md)
            + [Creazione dinamica di documenti DDX](/help/forms/developing/dynamically-creating-ddx-documents.md)
            + [Gestione dei moduli inviati](/help/forms/developing/handling-submitted-forms.md)
            + [Ottimizzazione delle prestazioni del servizio Forms](/help/forms/developing/optimizing-performance-forms-service.md)
            + [Trasmissione dei documenti al servizio Forms](/help/forms/developing/passing-documents-forms-service.md)
            + [Precompilazione dei moduli con layout fluidi](/help/forms/developing/prepopulating-forms-flowable-layouts.md)
            + [Rendering dei moduli basato su frammenti](/help/forms/developing/rendering-forms-based-fragments.md)
            + [Rendering dei moduli per valore](/help/forms/developing/rendering-forms-value.md)
            + [Rendering dei moduli come HTML](/help/forms/developing/rendering-forms-html.md)
            + [Rendering dei moduli nel client](/help/forms/developing/rendering-forms-client.md)
            + [Rendering di moduli HTML tramite file CSS personalizzati](/help/forms/developing/rendering-html-forms-using-custom.md)
            ...
            + [Rendering di moduli con diritti](/help/forms/developing/rendering-rights-enabled-forms.md)
            + [Convalida dei documenti DDX](/help/forms/developing/validating-ddx-documents.md)
            + [Conversione di PDF in file PostScript e immagine](/help/forms/developing/converting-pdf-postscript-image-files.md)
            ...
            + [Gestione a livello di programmazione degli endpoint](/help/forms/developing/programmatically-endpoints.md)
            + [Gestione a livello di programmazione dei nodi delle preferenze](/help/forms/developing/programmatically-preferences-nodes.md)
   ...
   + Risoluzione di problemi {#troubleshooting}
      ...
      + [Passaggi aggiuntivi per ricevere e-mail con allegato per la versione adattiva di Forms su JEE](/help/forms/using/additional-steps-to-use-email-with-attachments.md)
      + [Impossibile convertire file Word o Excel in PDF sul server Windows](/help/forms/using/disable-uac-for-pdfgconfiguration.md)
      ...
      + [Errori di servizio non disponibile dopo l’installazione del service pack 6.5.15.0 di AEM](/help/forms/using/aem-service-pack-installation-solution.md)
      + [Problema di installazione del service pack di AEM Forms JEE 6.5.15.0 nell’ambiente JBoss Linux](/help/forms/using/linux-jboss-installation-issue-on-sp15.md)
      ...
      + [Il servizio PaperCapture non riesce a eseguire l’OCR dei PDF](/help/forms/using/papercapture-service-resolution.md)
      + [Mitigazione delle vulnerabilità del framework Spring per AEM Forms su JEE](/help/forms/using/mitigating-spring-framework-vulnerabilities-for-aem-forms-on-jee.md)
      + [Mitigazione delle vulnerabilità di Log4j2 per Experience Manager Forms](/help/forms/using/aem-forms-vulnerability-cve.md)
      + [Mitigazione delle vulnerabilità di esecuzione del codice remoto per AEM Forms su JEE](/help/forms/using/aem-forms-rce-vulnerability-mitigation-troubleshooting.md)
      + [Mitigazione delle vulnerabilità XXE, di configurazione e di esecuzione remota del codice per AEM Forms su JEE](/help/forms/using/mitigating-xxe-and-configuration-vulnerabilities-for-experience-manager-forms-jee.md)
      ...
      + [Vulnerabilità XML External Entity (XXE) in BlazeDS](/help/forms/using/xxe-vulnerability-blazeds.md)
      + [Distribuzione EAR non riuscita sul server WebLogic JEE](/help/forms/using/ear-deployment-failing-on-jee-weblogic-server.md)
      + [Mitigazione della vulnerabilità di CVE-2025-64775 (Apache Struts)](/help/forms/using/mitigating-cve-apache-struts.md)
   + Documentazione legacy {#legacy-documentation}
      + [Utilizzo del servizio di esecuzione dello script in AEM Forms su JEE Workbench per generare dati XML](/help/forms/developing/building-xml.md)
      ...
      + [Generazione e utilizzo di hash in PDF forms dinamici](/help/forms/developing/hashing-forms.md)
   ...
   + Glossario {#aem-forms-glossary}
      + {hide-from-toc}[Glossari di AEM Forms](/help/forms/using/aem-forms-glossary.md)
+ IA in AEM {#ai-in-aem}
...
+ Content and Commerce {#commerce}
   ...
   + [Modifiche di rilievo apportate ai contenuti di AEM e ad AEM Commerce](/help/commerce/cif/changes.md)
   + Integrazioni {#integrations}
      + [Adobe Commerce](/help/commerce/cif/integrating/magento.md)
      + [Soluzione di terze parti per l’e-commerce](/help/commerce/cif/integrating/third-party.md)
   + Vetrina AEM {#storefront}
      ...
      + Sviluppo {#developing}
         ...
         + [Utilizzo di selettori del catalogo CIF](/help/commerce/cif/customizing/use-cif-pickers.md)
   ...
   + AEM CIF Classic {#classic}
      ...
      + Amministrazione {#administering}
         ...
         + [Amministrazione di eCommerce generico](/help/commerce/cif-classic/administering/generic.md)
...
+ Headless {#headless}
   ...
   + Percorso architetto di contenuti AEM headless {#architect}
   ...
   + Percorso di traduzione headless in AEM {#translation}
   ...
   + [Cos’è un percorso di documentazione?](/help/journey-documentation/home.md)
+ Implementazione {#implementing}
   + Sviluppo {#developing}
      + Introduzione per sviluppatori {#introduction}
         + [Guida introduttiva allo sviluppo per AEM Sites - Tutorial WKND](/help/sites-developing/getting-started.md)
         ...
         + [URL e confronto tra pagine](/help/sites-developing/pagediff.md)
         ...
         + [Apportare contributi in AEM](/help/sites-developing/contributing-to-cq.md)
         + [Protezione](/help/sites-developing/security.md)
         + [Materiali di riferimento](/help/sites-developing/reference-materials.md)
         + [Creare un sito web completo di tutte le funzioni (interfaccia utente classica)](/help/sites-developing/website.md)
         + [Progettazioni e Designer (interfaccia utente classica)](/help/sites-developing/designer.md)
      ...
      + Platform {#platform}
         ...
         + Modelli{#templates}
            ...
            + [Rendering del modello adattivo](/help/sites-developing/templates-adaptive-rendering.md)
         ...
         + Assegnazione tag{#tagging}
            + [Assegnazione tag](/help/sites-developing/tags.md)
         ...
         + [Personalizzazione delle pagine mostrate dal gestore degli errori](/help/sites-developing/customizing-errorhandler-pages.md)
      ...
      + Componenti{#components}
         ...
         + [Sistema di stili](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/authoring/siteandpage/style-system.html?lang=it)
         + [Panoramica sui componenti](/help/sites-developing/components.md)
         ...
         + Componenti interfaccia utente classica{#classic-ui-components}
      ...
      + Gestione delle esperienze headless {#headless}
         ...
         + Percorsi headless {#journeys}
            + Percorso per sviluppatori headless {#developer}
               + [Capire headless in AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/overview.html?lang=it)
               + [Informazioni sullo sviluppo headless di CMS](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/learn-about.html?lang=it)
               + [Guida introduttiva ad AEM headless as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/getting-started.html?lang=it)
               + [Percorso della tua prima esperienza con AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/path-to-first-experience.html?lang=it)
               + [Come modellare il contenuto come modelli di contenuto AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/model-your-content.html?lang=it)
               + [Come accedere ai contenuti tramite API di consegna AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/access-your-content.html?lang=it)
               + [Come aggiornare i contenuti tramite API di AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/update-your-content.html?lang=it)
               + [Come mettere tutto insieme](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/put-it-all-together.html?lang=it)
               + [Come pubblicare con la tua applicazione headless](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/go-live.html?lang=it)
               + [Facoltativo - Come creare applicazioni a pagina singola con AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/create-spa.html?lang=it)
         ...
         + Frammenti di contenuto{#content-fragments}
            + [Distribuzione headless con frammenti di contenuto e GraphQL](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-graphql.html?lang=it)
            + [Utilizzo di frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments.html?lang=it)
            + [Abilita funzionalità frammento di contenuto per la tua istanza](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-configuration-browser.html?lang=it)
            + [Modelli per frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-models.html?lang=it)
            + [Gestione dei frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-managing.html?lang=it)
            + [Varianti - Authoring dei contenuti di frammenti](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-variations.html?lang=it)
            + [Markdown](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-markdown.html?lang=it)
            + [Uso di contenuti associati](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-assoc-content.html?lang=it)
            + [Metadati - Proprietà dei frammenti](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-metadata.html?lang=it)
            + [Albero struttura](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-structure-tree.html?lang=it)
            + [Anteprima - Rappresentazione JSON](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/content-fragments/content-fragments-json-preview.html?lang=it)
         + API di distribuzione{#delivery-api}
            + [API HTTP di Assets](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/mac-api-assets.html?lang=it)
            + [API REST per frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/assets-api-content-fragments.html?lang=it)
            + [API GraphQL per frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/graphql-api-content-fragments.html?lang=it)
            + [Gestione degli endpoint GraphQL](/help/sites-developing/headless/graphql-api/graphql-endpoint.md)
            + [Utilizzo dell’IDE GraphiQL](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/graphiql-ide.html?lang=it)
            + [Query persistenti](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/persisted-queries.html?lang=it)
            ...
            + [Autenticazione per query GraphQL AEM remote su frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/graphql-authentication-content-fragments.html?lang=it)
            + [API GraphQL di AEM con frammenti di contenuto - Contenuto di esempio e query](https://experienceleague.adobe.com/docs/experience-manager-65/content/assets/extending/content-fragments-graphql-samples.html?lang=it)
         + L’editor universale {#universal-editor}
            + [Introduzione](/help/sites-developing/universal-editor/introduction.md)
      + Sviluppo ibrido e di SPA con AEM {#spas}
         ...
         + [Rimozione dell’editor di SPA](/help/sites-developing/spa-editor-deprecation.md)
         ...
         + [Mappatura di un modello dinamico a un componente per SPA](/help/sites-developing/spa-dynamic-model-to-component-mapping.md)
         + [Indirizzamento del modello SPA](/help/sites-developing/spa-routing.md)
         ...
         + [Abilitazione dell’esportazione JSON per un componente](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/components/json-exporter-components.html?lang=it)
      ...
      + Strumenti di sviluppo {#devtools}
         ...
         + [Strumento di conversione per finestre di dialogo](/help/sites-developing/dialog-conversion.md)
         ...
         + [Strumenti per sviluppatori AEM per Eclipse](/help/sites-developing/aem-eclipse.md)
      ...
      + Personalizzazione {#personlization}
         ...
         + [Configurare Context Hub](/help/sites-developing/ch-configuring.md)
         + [Aggiunta di ContextHub alle pagine e accesso agli archivi](/help/sites-developing/ch-adding.md)
         + [Estensione di ContextHub](/help/sites-developing/ch-extend.md)
         + [Candidati dell’archivio di ContextHub di esempio](/help/sites-developing/ch-samplestores.md)
         + [Tipi di modulo dell’interfaccia utente di ContextHub di esempio](/help/sites-developing/ch-samplemodules.md)
         + [Diagnostica ContextHub](/help/sites-developing/ch-diagnostics.md)
         + [Sviluppo per contenuti mirati](/help/sites-developing/target.md)
         + [Riferimento API di JavaScript per ContextHub](/help/sites-developing/contexthub-api.md)
         + ClientContext{#client-context}
            + [ClientContext nei dettagli](/help/sites-developing/client-context.md)
            + [API di JavaScript per ClientContext](/help/sites-developing/ccjsapi.md)
      + Estensione di AEM {#extending-aem}
         ...
         + [Configurazione della pagina per la modifica in blocco delle proprietà pagina](/help/sites-developing/bulk-editing.md)
         ...
         + Tracciamento e analisi{#extending-analytics}
            ...
            + [Personalizzazione del framework di Adobe Analytics](/help/sites-developing/extending-analytics-framework.md)
         ...
         + Forms{#extending-forms}
            ...
            + [Creazione di un modello di pagina AEM personalizzato con i componenti per i moduli di Adobe Campaign](/help/sites-developing/extending-campaign-custom-template.md)
         + [Richiedere lo script di analisi](/help/sites-developing/analyze-request.md)
         + Estensione dell’interfaccia classica{#extending-classic-ui}
            ...
            + [Sviluppo di rapporti](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/platform/dev-reports.html?lang=it)
      + Test {#testing}
         ...
         + [La versione successiva...](/help/sites-developing/the-next-release.md)
         + [Elenchi di controllo](/help/sites-developing/checklists.md)
         + [Giorno difficile](/help/sites-developing/tough-day.md)
         + [Test dell’interfaccia utente](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/components/hobbes.html?lang=it)
      + Best practice {#bestpractices}
         + [Analisi delle best practice](/help/sites-developing/best-practices.md)
         + [Linee guida per lo sviluppo e best practice per AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/introduction/dev-guidelines-bestpractices.html?lang=it)
         + [Best practice specifiche per lo sviluppo](/help/sites-developing/development-practices.md)
         ...
         + Implementazione di riferimento di We.Retail{#we-retail}
            + [Implementazione di riferimento di We.Retail](/help/sites-developing/we-retail.md)
            + [Prova dei frammenti di contenuto in We.Retail](/help/sites-developing/we-retail-content-fragments.md)
            ...
            + [Prova del layout responsive in We.Retail](/help/sites-developing/we-retail-responsive-layout.md)
            + [Prova della struttura globalizzata di un sito in We.Retail](/help/sites-developing/we-retail-globalized-site-structure.md)
            + [Prova dei frammenti di esperienza in We.Retail](/help/sites-developing/we-retail-experience-fragments.md)
         + [Suggerimenti per la codifica](/help/sites-developing/coding-tips.md)
         + [Imprevisti del codice](/help/sites-developing/code-pitfalls.md)
      ...
      + Web per dispositivi mobili {#mobileweb}
         + [Web per dispositivi mobili](/help/sites-developing/mobile-web.md)
         + [Creazione di filtri per gruppo dispositivi](/help/sites-developing/groupfilters.md)
   ...
   + Implementazione {#deploying}
      ...
      + Distribuzione di AEM {#deploying}
         ...
         + [Consenso alla raccolta di statistiche di utilizzo aggregate](/help/sites-deploying/opt-in-aggregated-usage-statistics.md)
      ...
      + Configurazione di AEM {#configuring}
         ...
         + [Impostazioni di configurazione di OSGi](/help/sites-deploying/osgi-configuration-settings.md)
         ...
         + [Eliminazione della versione](/help/sites-deploying/version-purging.md)
         ...
         + [Guida delle prestazioni delle risorse](/help/sites-deploying/assets-performance-sizing.md)
      ...
      + Aggiornamento ad AEM 6.5 {#upgrading}
         ...
         + [Valutazione della complessità dell’aggiornamento con il rilevamento pattern](/help/sites-deploying/pattern-detector.md)
         ...
         + [Aggiornamento dei moduli di ricerca personalizzati](/help/sites-deploying/upgrading-custom-search-forms.md)
         ...
         + [Passaggi per l’aggiornamento delle installazioni del server applicazioni](/help/sites-deploying/app-server-upgrade.md)
      ...
      + Ristrutturazione dell’archivio {#restructuring}
         ...
         + [Ristrutturazione dell’archivio risorse in AEM 6.5](/help/sites-deploying/assets-repository-restructuring-in-aem-6-5.md)
      ...
      + Best practice {#practices}
         + [Best practice per la distribuzione](/help/sites-deploying/best-practices.md)
         + [Struttura delle prestazioni](/help/sites-deploying/performance-tree.md)
         + [Best practice per il test delle prestazioni](/help/sites-deploying/best-practices-for-performance-testing.md)
...
+ Gestione {#managing}
   + [Guida utente per la gestione](/help/managing/home.md)
   + Gestione - Elenco di controllo delle best practice {#managing-best-practices-checklist}
      ...
      + [Elenco di controllo - Altri riferimenti](/help/managing/best-practices-further-reference.md)
   + Gestione - Altri riferimenti {#managing-further-reference}
   ...
   + Accessibilità {#accessibility}
      ...
      + [Guida rapida di WCAG 2.1](/help/managing/qg-wcag.md)
   + Protezione dei dati {#data-protection}
      + [Compatibilità di AEM alle normative su privacy e protezione dei dati](/help/managing/data-protection-and-privacy.md)

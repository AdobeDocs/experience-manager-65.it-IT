...
+ Sicurezza {#security}
   ...
   + [Top 10 OWASP](/help/sites-administering/owasp-top10.md)
   ...
   + [Adobe Systems supporto IMS Authentication e Admin Console per AEM Managed Services](/help/sites-administering/ims-config-and-admin-console.md)
   + [Creazione di un gruppo utenti chiuso](/help/sites-administering/cug.md)
   + [Mitigazione dei problemi di serializzazione nell’AEM](/help/sites-administering/mitigating-serialization-issues.md)
   ...
   + [Gestione delle richieste RGPD per la Fondazione AEM](/help/sites-administering/handling-gdpr-requests-for-aem-platform.md)
...
+ Sites {#sites}
   + Authoring {#authoring}
      ...
      + Prestazioni Pagina {#page-performance}
         ...
         + [Analisi delle prestazioni Pagina](/help/sites-authoring/ci-analyze.md)
         + [Visualizzazione Pagina dati Analytics](/help/sites-authoring/pa-using.md)
      ...
      + AEM e Adobe Campaign {#aem-adobe-campaign}
         ...
         + [Targeting della tua Adobe Campaign](/help/sites-authoring/target-adobe-campaign.md)
         + [Creazione di Forms Adobe Campaign in AEM](/help/sites-authoring/adobe-campaign-forms.md)
         + [Componenti Adobe Campaign](/help/sites-authoring/adobe-campaign-components.md)
   + Amministrazione {#administering}
      ...
      + Caratteristiche siti {#introduction}
         ...
         + [Creazione di una radice Lingua utilizzando il interfaccia classico](/help/sites-administering/tc-lroot-classic.md)
      ...
      + Operazioni {#operations}
         ...
         + [Manutenzione del registro di controllo dell’AEM 6](/help/sites-administering/operations-audit-log.md)
      ...
      + Integrazione {#integration}
         ...
         + [Avviso sulla fine del ciclo di vita dei visualizzatori di Flash](/help/sites-administering/flash-viewers-eol.md)
         ...
         + [Portali e portlet AEM](/help/sites-administering/aem-as-portal.md)
         ...
         + [Best practice per i modelli di e-mail](/help/sites-administering/best-practices-for-email-templates.md)
      ...
      + Best practice {#bestpractices}
         ...
         + [Best practice di traduzione](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/administering/introduction/tc-bp.html)
         ...
         + [AEM Sites - GDPR prontezza](/help/sites-administering/gdpr-compliance-sites.md)
         + [Gestione delle richieste di GDPR per la AEM Foundation](https://experienceleague.adobe.com/docs/experience-manager-65/content/security/handling-gdpr-requests-for-aem-platform.html)
         + [AEM Commerce - Preparazione GDPR](/help/sites-administering/gdpr-compliance-commerce.md)
   ...
   + Authoring interfaccia classico {#classic-ui}
      + Introduzione all&#39;interfaccia Authoring classico {#introduction}
         + [Primi passi per gli autori](/help/sites-classic-ui-authoring/classic-page-author-first-steps.md)
         + [Authoring nelle interfaccia classiche](/help/sites-classic-ui-authoring/classicui.md)
         + [Utilizzo dell&#39;ambiente Autore](/help/sites-classic-ui-authoring/author-env.md)
...
+ Assets {#assets}
   ...
   + Dynamic Media{#dynamic}
      ...
      + [Consegna HTTP2 di contenuto](/help/assets/http2.md)
...
+ Forms {#forms}
   ...
   + Installa e configura AEM Forms {#install-aem-forms}
      ...
      + Installa AEM Forms su OSGi {#osgi-installation}
         + [Piattaforme supportate per moduli AEM su OSGi](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/deploying/introduction/technical-requirements.html)
         ...
         + [Installa e configura servizio di Automated forms conversion](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html?lang=it)
      + Installa AEM Forms su JEE {#jee-installation}
         + [Piattaforme supportate per i moduli AEM su JEE](/help/forms/using/aem-forms-jee-supported-platforms.md)
   ...
   + Aggiorna AEM Forms {#upgrade-aem-forms}
      ...
      + Aggiorna AEM Forms su OSGi {#aem-forms-osgi-upgrade}
         + [Aggiornamento a moduli AEM 6.5 su OSGi](/help/forms/using/upgrade-forms-osgi.md)
      ...
      + [Aggiornamento a moduli AEM 6.5 su JEE](/help/forms/using/upgrade-forms-jee.md)
   ...
   + Gestisci AEM Forms {#manage-administer-aem-forms}
      ...
      + Trattamento utente dati {#handling-user-data}
         + [Flussi di lavoro incentrati sulla Forms su OSGi](/help/forms/using/forms-workflow-osgi-handling-user-data.md)
         + [Forms gestione utente](/help/forms/using/user-management-handling-user-data.md)
         + [Forms flussi di lavoro JEE](/help/forms/using/forms-workflow-jee-handling-user-data.md)
      ...
      + Protezione avanzata dell&#39;ambiente AEM Forms {#hardening-aem-forms-environment}
         + [Protezione e protezione dei moduli AEM nell’ambiente OSGi](/help/forms/using/hardening-securing-aem-forms-environment.md)
   ...
   + Forms adattivo - Authoring di base {#adaptive-forms-basic-authoring}
      ...
      + [Incorporare un modulo adattivo o una comunicazione interattiva nella pagina dei siti AEM](/help/forms/using/embed-adaptive-form-aem-sites.md)
   ...
   + Forms adattivo - Authoring avanzato {#adaptive-forms-advanced-authoring}
      ...
      + [Utilizzo di Adobe Sign in un modulo adattivo](/help/forms/using/working-with-adobe-sign.md)
   ...
   + Comunicazioni interattive {#interactive-communications}
      + [Introduzione all&#39;authoring di comunicazioni interattive interfaccia](/help/forms/using/introduction-interactive-communication-authoring.md)
      + [Crea una comunicazione interattiva](/help/forms/using/create-interactive-communication.md)
      ...
      + [Condizioni in Comunicazioni interattive](/help/forms/using/conditions-interactive-communications.md)
   ...
   + Flussi di lavoro {#workflows}
      + [workflow Forms-centrica su OSGi](/help/forms/using/aem-forms-workflow.md)
      + [workflow Forms-centric su OSGi - Guida dei passaggi](/help/forms/using/aem-forms-workflow-step-reference.md)
      + [Seleziona dinamicamente un utente o un gruppo per i passaggi workflow incentrati sull&#39;AEM Forms](/help/forms/using/dynamically-select-a-user-or-group-for-aem-workflow.md)
      ...
      + [Configura Fuori sede](/help/forms/using/configure-out-of-office-settings.md)
   + AEM Forms Workspace {#use-aem-forms-workspace}
      ...
      + [Integrazione di applicazioni di terze parti in AEM Forms&#39;area di lavoro](/help/forms/using/integrating-correspondence-management-html-workspace.md)
      + [AEM Forms descrizione dell&#39;oggetto JSON dell&#39;area di lavoro](/help/forms/using/html-workspace-json-object-description.md)
      + [Introduzione alla personalizzazione dell AEM area di lavoro dei moduli](/help/forms/using/introduction-customizing-html-workspace.md)
      + [Passaggi generici per AEM Forms personalizzazione dell&#39;area di lavoro](/help/forms/using/generic-steps-html-workspace-customization.md)
      ...
      + [Integrazione dell’area di lavoro dei moduli AEM con Microsoft Office SharePoint Server](/help/forms/using/integrating-aem-forms-workspace-with-microsoft-office-sharepoint-server.md)
   ...
   + Moduli HTML5 {#html5-forms}
      + [Introduzione ai moduli di HTML5](/help/forms/using/introduction.md)
      + [Guida introduttiva ai moduli di HTML5](/help/forms/using/get-started.md)
      + [Architettura dei moduli di HTML5](/help/forms/using/html5-forms-architecture.md)
      + [Differenziazione delle funzioni tra moduli di HTML5 e PDF forms](/help/forms/using/feature-differentiation-html5-forms-pdf-forms.md)
      + [Domande frequenti per i moduli di HTML5](/help/forms/using/faq.md)
      ...
      + [Ottimizzazione dei moduli di HTML5](/help/forms/using/optimize-html5-forms.md)
      + [Lettori di schermi per moduli HTML5](/help/forms/using/screen-readers.md)
      ...
      + [Integrazione di Form Bridge con portale personalizzato per HTML5 Forms](/help/forms/using/integrate-form-bridge-forms-portal.md)
      ...
      + [Abilitare registrazione per i moduli HTML5](/help/forms/using/enable-logs.md)
      + [Debug di moduli HTML5](/help/forms/using/debug.md)
      + [Scripting supporto per moduli HTML5](/help/forms/using/scripting-support.md)
   ...
   + Lettere e corrispondenze {#letters-correspondences}
      ...
      + [Aggiungi un&#39;azione personalizzata alla vista Elenco risorse](/help/forms/using/add-custom-action-asset-listing-view.md)
      + [Aggiungi azioni/pulsante personalizzate in Crea interfaccia Corrispondenza](/help/forms/using/add-action-button-in-create-correspondence-ui.md)
      + [Aggiungi proprietà personalizzate ai risorse Gestione Corrispondenza](/help/forms/using/add-custom-properties-cm-assets.md)
      + [Personalizza la creazione di interfaccia di corrispondenza](/help/forms/using/customize-create-correspondence-ui.md)
      + [Personalizzare la editor di testo](/help/forms/using/customize-text-editor.md)
      ...
      + [Filigrana personalizzata nell&#39;anteprima PDF lettera](/help/forms/using/custom-watermark.md)
   ...
   + Servizi documentali {#use-document-services}
      + [Panoramica dei servizi documentali AEM](/help/forms/using/overview-aem-document-services.md)
      ...
      + [Utilizzo dei servizi documentali AEM a livello di programmazione](/help/forms/using/aem-document-services-programmatically.md)
   ...
   + Document Security {#use-document-security}
      ...
      + [Consenti a AEM di effettuare ricerche nei documenti di PDF protetti da Document Security](/help/forms/using/enable-search-for-drm-protected-pdf-documents-in-aem.md)
      + [Reader che estende i documenti di PDF protetti tramite policy utilizzando la Libreria di protezione portatile](/help/forms/using/reader-extending-policy-protected-pdf-documents-using-ppl.md)
      + [Consentire all&#39;AEM di effettuare ricerche nei documenti PDF e Microsoft Office protetti da Document Security](/help/forms/using/enable-search-for-drm-protected-pdf-and-office-documents-in-aem.md)
      + [Protect un documento per conto di un altro utente](/help/forms/using/protect-document-on-behalf-of-another-user.md)
   ...
   + Guida per gli amministratori di AEM Forms su JEE {#administrator-help}
      ...
      + Impostazione e gestione di domini {#setup-manage-domains}
         + [Aggiunta di domini](/help/forms/using/admin-help/adding-domains.md)
         + [Elimina un dominio](/help/forms/using/admin-help/delete-domain.md)
      ...
      + Configurazione di User Management {#configure-user-management}
         ...
         + [Configurare il bind LDAP password](/help/forms/using/admin-help/configure-ldap-bind-password.md)
         + [Configurare moduli AEM per eseguire la preacquisizione delle informazioni sul dominio](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md)
      ...
      + Backup e ripristino moduli AEM {#aem-forms-backup-recovery}
   ...
   + Riferimento sviluppatore {#developer-reference}
      ...
      + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
         ...
         + Richiamo di AEM Forms su JEE mediante le API {#invoking-aem-forms-jee-apis}
            + [Richiamare AEM Forms tramite richieste REST](/help/forms/developing/invoking-aem-forms-using-rest.md)
            + [Richiamo di AEM Forms mediante servizi Web](/help/forms/developing/invoking-aem-forms-using-web.md)
            + [Richiamo di AEM Forms tramite comunicazione remota](/help/forms/developing/invoking-aem-forms-using-remoting.md)
            + [Richiamo di AEM Forms mediante servizi Web](/help/forms/developing/invoking-human-centric-long-lived.md)
            + [Richiamo di AEM Forms utilizzando JavaAPI](/help/forms/developing/invoking-aem-forms-using-java.md)
            + [Creazione di applicazioni Flash Builder che eseguono l&#39;autenticazione SSO mediante token HTTP](/help/forms/developing/creating-flash-builder-applications-perform.md)
         + Esecuzione di operazioni di servizio tramite API {#performing-service-operations-using-apis}
            ...
            + [Assemblaggio di documenti di PDF non interattivi](/help/forms/developing/assembling-non-interactive-pdf-documents.md)
            ...
            + [Assemblaggio di Portfoli PDF](/help/forms/developing/assembling-pdf-portfolios.md)
            + [Calcolo dati modulo](/help/forms/developing/calculating-form-data.md)
            + [Creazione di applicazioni Web per il rendering di Forms](/help/forms/developing/creating-web-applications-renders-forms.md)
            + [Creazione di documenti PDF con i dati SubmittedXML](/help/forms/developing/creating-pdf-documents-submitted-xml.md)
            ...
            + [Rendering di HTML Forms con CustomToolbars](/help/forms/developing/rendering-html-forms-custom-toolbars.md)
            ...
            + [Crittografia e decrittografia dei documenti di PDF](/help/forms/developing/encrypting-decrypting-pdf-documents.md)
            ...
            + [Utilizzo dei documenti di PDF/A](/help/forms/developing/pdf-a-documents.md)
            + [Utilizzo delle utilità PDF](/help/forms/developing/pdf-utilities.md)
            + [Utilizzo dei servizi dell’XMP](/help/forms/developing/xmp-utilities.md)
   ...
   + Documentazione legacy {#legacy-documentation}
      ...
      + [Generazione e utilizzo degli hash nei PDF forms dinamici](/help/forms/developing/hashing-forms.md)
...
+ Content and Commerce {#commerce}
   ...
   + AEM Storefront {#storefront}
      ...
      + Sviluppo {#developing}
         + [Sviluppare con AEM](/help/commerce/cif/develop.md)
         ...
         + [Utilizzo dei selettori di cataloghi CIF](/help/commerce/cif/customizing/use-cif-pickers.md)
   ...
   + AEM CIF Classic {#classic}
      ...
      + Sviluppo {#developing}
         ...
         + [Sviluppare con SAP Commerce Cloud](/help/commerce/cif-classic/developing/sap-commerce-cloud.md)
+ Headless {#headless}
   ...
   + Percorso di authoring di contenuti headless AEM {#author}
...
+ Implementazione {#implementing}
   + Sviluppo {#developing}
      + Introduzione per sviluppatori {#introduction}
         ...
         + [Contribuire all’AEM](/help/sites-developing/contributing-to-cq.md)
      ...
      + Platform {#platform}
         ...
         + [Come accesso a livello di programmazione il AEM JCR](/help/sites-developing/access-jcr.md)
         + [Integrazione dei servizi con la console JMX](/help/sites-developing/jmx-integration.md)
         + [Sviluppo del Modifiche in serie](/help/sites-developing/dev-bulk-editor.md)
         + [Sviluppo di report](/help/sites-developing/dev-reports.md)
      + Componenti{#components}
         ...
         + [Configurazione di più editor sul posto](/help/sites-developing/multiple-inplace-editors.md)
      ...
      + Gestione delle esperienze headless {#headless}
         ...
         + Percorsi headless {#journeys}
            + Percorso per sviluppatori headless {#developer}
               ...
               + [Come modellare i contenuti come modelli di contenuto AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/model-your-content.html)
            ...
            + Percorso Architect di contenuti headless {#architect}
               + [Panoramica del Percorso Architect di contenuti headless AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/architect/overview.html)
      ...
      + Sviluppo AEM ibrido e SPA {#spas}
         ...
         + [Approfondimenti su SPA](/help/sites-developing/spa-deep-dives.md)
         ...
         + [Rendering lato server e SPA](/help/sites-developing/spa-ssr.md)
      ...
      + Best practice {#bestpractices}
         ...
         + [Linee guida per lo sviluppo dell&#39;AEM e best practice](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/introduction/dev-guidelines-bestpractices.html)
   ...
   + Distribuzione di {#deploying}
      + Introduzione alla piattaforma AEM {#introduction}
         ...
         + [Elementi di conservazione in AEM 6.5](/help/sites-deploying/storage-elements-in-aem-6.md)
      ...
      + Distribuzione di AEM {#deploying}
         ...
         + [Supporto RDBMS nell’AEM 6.5](/help/sites-deploying/rdbms-support-in-aem.md)
      ...
      + Configurazione di AEM {#configuring}
         ...
         + [Monitoraggio e manutenzione dell’istanza AEM](/help/sites-deploying/monitoring-and-maintaining.md)

...
+ Sites {#sites}
   + Authoring {#authoring}
      ...
      + Prestazioni pagina {#page-performance}
         + [Contenuto Insight](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/authoring/siteandpage/content-insights.html?lang=it)
   ...
   + Amministrazione {#administering}
      ...
      + Best practice {#bestpractices}
         ...
         + [Gestione delle richieste RGPD per AEM Foundation](https://experienceleague.adobe.com/docs/experience-manager-65/content/security/handling-gdpr-requests-for-aem-platform.html?lang=it)
      ...
      + Gestione dei contenuti {#contentmanagement}
         + [Gestore di pacchetti](/help/sites-administering/package-manager.md)
...
+ Moduli {#forms}
   ...
   + Installare e configurare AEM Forms {#install-aem-forms}
      ...
      + Installare AEM Forms su JEE {#jee-installation}
         ...
         + [Installazione e distribuzione di AEM Forms in JEE tramite JBoss Turnkey](https://www.adobe.com/go/learn_aemforms_installTurnkey_65_it)
         ...
         + [Installazione e distribuzione di Adobe Experience Manager Forms in JEE per JBoss](https://www.adobe.com/go/learn_aemforms_installJBoss_65_it)
         + [Installazione e distribuzione di Adobe Experience Manager Form in JEE per WebSphere](https://www.adobe.com/go/learn_aemforms_installWebSphere_65_it)
         + [Installazione e distribuzione di AEM Forms in JEE per WebLogic](https://www.adobe.com/go/learn_aemforms_installWebLogic_65_it)
   ...
   + Forms adattivo - Authoring avanzato {#adaptive-forms-advanced-authoring}
      ...
      + [Sincronizzazione di moduli adattivi con i modelli per moduli XFA](/help/forms/using/synchronizing-adaptive-forms-xfa.md)
   ...
   + Guida per gli amministratori di AEM Forms su JEE {#administrator-help}
      ...
      + Backup e ripristino AEM Forms {#aem-forms-backup-recovery}
   ...
   + Sviluppo {#developing}
      ...
      + Gestione delle esperienze headless {#headless}
         ...
         + Percorsi headless {#journeys}
            + Percorso per sviluppatori headless {#developer}
               ...
               + [Modellare il contenuto come modelli di contenuto AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/model-your-content.html?lang=it)
               + [Come accedere al contenuto tramite API di consegna AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/access-your-content.html?lang=it)
               + [Come aggiornare il contenuto tramite API di AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/update-your-content.html?lang=it)
               ...
               + [Come effettuare il Go Live con la tua applicazione headless](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/developer/go-live.html?lang=it)
            ...
            + Percorso di architettura dei contenuti headless {#architect}
               ...
               + [Scopri come creare modelli per frammenti di contenuto in AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/headless/architect/model-structure.html?lang=it)
      ...
      + Estensione di AEM {#extending-aem}
         ...
         + Estensione dell’interfaccia classica{#extending-classic-ui}
            ...
            + [Sviluppo di report](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/platform/dev-reports.html?lang=it)
      + Test {#testing}
         ...
         + [Verifica dell&#39;interfaccia utente](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/components/hobbes.html?lang=it)
      + Best practice {#bestpractices}

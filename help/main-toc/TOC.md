...
+ Sicurezza {#security}
   ...
   + [Autenticazione Adobe IMS e supporto Admin Console per AEM Managed Services](/help/sites-administering/ims-config-and-admin-console.md)
...
+ Sites {#sites}
   + Authoring {#authoring}
      + [Panoramica della Guida utente all’authoring](/help/sites-authoring/home.md)
      ...
      + Prestazioni pagina {#page-performance}
         + [Approfondimenti contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/authoring/siteandpage/content-insights.html)
   ...
   + Amministrazione {#administering}
      ...
      + Funzioni di Sites {#introduction}
         + [Amministrazione sito Web](/help/sites-administering/msm-and-translation.md)
      ...
      + Operazioni {#operations}
         ...
         + [Archivio dati raccolta oggetti inattivi](/help/sites-administering/data-store-garbage-collection.md)
      ...
      + Best practice {#bestpractices}
         ...
         + [Gestione delle richieste RGPD per la Fondazione AEM](https://experienceleague.adobe.com/docs/experience-manager-65/content/sites/administering/security/handling-gdpr-requests-for-aem-platform.html)
      ...
      + Gestione dei contenuti {#contentmanagement}
         ...
         + [Gestione dei contenuti per Screens](/help/sites-administering/content-management-screens.md)
         + [Accesso WebDAV](/help/sites-administering/webdav-access.md)
   + Authoring con interfaccia classica {#classic-ui}
      + [Panoramica della guida all’authoring dell’interfaccia classica](/help/sites-classic-ui-authoring/home.md)
...
+ Assets {#assets}
   + [[!DNL Assets] guida utente](/help/assets/home.md)
   ...
   + Usa Experience Manager Assets {#using}
      + [[!DNL Assets] esperienza della pagina iniziale](/help/assets/assets-home-page.md)
      ...
      + [Utilizzare [!DNL Adobe Stock] risorse in Assets](/help/assets/aem-assets-adobe-stock.md)
   ...
   + Estendi risorse {#extending}
      ...
      + [Installare e configurare [!DNL ImageMagick] per utilizzare [!DNL Assets]](/help/assets/best-practices-for-imagemagick.md)
      ...
      + [Supporto dei frammenti di contenuto in [!DNL Assets] API HTTP](/help/assets/assets-api-content-fragments.md)
   ...
   + Amministrare risorse {#administer}
      ...
      + [[!DNL Assets] guida all&#39;ottimizzazione delle prestazioni](/help/assets/performance-tuning-guidelines.md)
      + [[!DNL Assets] guida alla migrazione](/help/assets/assets-migration-guide.md)
      ...
      + [[!DNL Experience Manager] e [!DNL Creative Cloud] integrazione](/help/assets/aem-cc-integration-best-practices.md)
...
+ Forms {#forms}
   + [Guida Forms di AEM 6.5](/help/forms/home.md)
   ...
   + Installare e configurare AEM Forms {#install-aem-forms}
      ...
      + Installare AEM Forms su OSGi {#osgi-installation}
         + [Piattaforme supportate per i moduli AEM su OSGi](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/deploying/introduction/technical-requirements.html)
         ...
         + [Installare e configurare il servizio di Automated forms conversion](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html?lang=it)
   ...
   + Flussi di lavoro {#workflows}
      ...
      + [Azioni e funzionalità dei flussi di lavoro AEM basati su moduli sui flussi di lavoro OSGi e AEM Forms JEE](/help/forms/using/capabilities-osgi-jee-workflows.md)
   ...
   + AEM Forms Workspace {#use-aem-forms-workspace}
      ...
      + [Introduzione alla personalizzazione dell’area di lavoro dei moduli AEM](/help/forms/using/introduction-customizing-html-workspace.md)
      ...
      + [Minimizzazione dei file JavaScript](/help/forms/using/minification-javascript-files.md)
   ...
   + Moduli HTML5 {#html5-forms}
      ...
      + [Debug dei moduli di HTML5](/help/forms/using/debug.md)
      + [Supporto di script per moduli HTML5](/help/forms/using/scripting-support.md)
   ...
   + Lettere e corrispondenze {#letters-correspondences}
      ...
      + [Filigrana personalizzata nell’anteprima di Letter PDF](/help/forms/using/custom-watermark.md)
   ...
   + Riferimenti per sviluppatori {#developer-reference}
      ...
      + Programmazione con AEM Forms su JEE {#programming-aem-forms-jee}
         ...
         + Richiamare AEM Forms su JEE tramite API {#invoking-aem-forms-jee-apis}
            ...
            + [Creazione di applicazioni di Flash Builder che eseguono l&#39;autenticazione SSO tramite token HTTP](/help/forms/developing/creating-flash-builder-applications-perform.md)
...
+ Implementazione {#implementing}
   + Sviluppo {#developing}
      + [Panoramica sullo sviluppo della guida utente](/help/sites-developing/home.md)
      ...
      + Gestione delle esperienze headless {#headless}
         ...
         + Percorsi headless {#journeys}
            + Percorso per sviluppatori headless {#developer}
               + [Comprendere headless nell’AEM](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/overview.html)
               + [Informazioni sullo sviluppo headless di CMS](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/learn-about.html)
               + [Guida introduttiva ad AEM Headless as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/getting-started.html)
               + [Percorso della tua prima esperienza con AEM Headless](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/path-to-first-experience.html)
               + [Come modellare i contenuti come modelli di contenuto AEM](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/model-your-content.html)
               + [Come accedere al contenuto tramite API di consegna AEM](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/access-your-content.html)
               + [Come aggiornare il contenuto tramite API di AEM Assets](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/update-your-content.html)
               + [Come mettere tutto insieme](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/put-it-all-together.html)
               + [Come effettuare il Go Live con la tua applicazione headless](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/go-live.html)
               + [Facoltativo - Come creare applicazioni a pagina singola con AEM](https://experienceleague.adobe.com/docs/experience-manager-65/headless/developer/create-spa.html)
            + Percorso Architect di contenuti headless {#architect}
               + [Panoramica del Percorso Architect di contenuti AEM headless](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/overview.html)
               + [Modellazione dei contenuti per headless con AEM - Introduzione](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/introduction.html)
               + [Scopri le nozioni di base sulla modellazione dei contenuti per headless con AEM](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/basics.html)
               + [Scopri come creare modelli per frammenti di contenuto in AEM](https://experienceleague.adobe.com/docs/experience-manager-65/headless/architect/model-structure.html)
         ...
         + API di consegna{#delivery-api}
            ...
            + [API GraphQL per frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/graphql-api-content-fragments.html)
            + [Gestione degli endpoint di GraphQL](/help/sites-developing/headless/graphql-api/graphql-endpoint.md)
            + [Utilizzo dell’IDE GraphiQL](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/graphiql-ide.html)
            + [Query persistenti](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/persisted-queries.html)
            ...
            + [Autenticazione per query GraphQL AEM remote su frammenti di contenuto](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/graphql-authentication-content-fragments.html)
            + [API GraphQL per AEM con frammenti di contenuto - Contenuto di esempio e query](https://experienceleague.adobe.com/docs/experience-manager-65/content/implementing/developing/headless/delivery-api/content-fragments-graphql-samples.html)
      ...
      + Personalizzazione {#personlization}
         ...
         + [Riferimento API JavaScript di ContextHub](/help/sites-developing/contexthub-api.md)
   ...
   + Distribuzione {#deploying}
      + [Guida utente alla distribuzione](/help/sites-deploying/home.md)
      ...
      + Distribuzione dell’AEM {#deploying}
         ...
         + [Accesso alla raccolta di statistiche di utilizzo aggregate](/help/sites-deploying/opt-in-aggregated-usage-statistics.md)
